...
func (tIface *TasksClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TasksClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TasksClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
