...
func (sIface *SessionClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *SessionClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *SessionClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
