...
func (pIface *ProviderClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(pIface.interfaceName)
}

func (pIface *ProviderClientImpl) Definition() core.InterfaceDefinition {
    return pIface.interfaceDefinition
}

func (pIface *ProviderClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
