...
func (aIface *ActivationManagerClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *ActivationManagerClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *ActivationManagerClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
