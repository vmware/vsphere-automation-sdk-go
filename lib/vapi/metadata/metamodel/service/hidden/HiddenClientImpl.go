...
func (hIface *HiddenClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(hIface.interfaceName)
}

func (hIface *HiddenClientImpl) Definition() core.InterfaceDefinition {
    return hIface.interfaceDefinition
}

func (hIface *HiddenClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
