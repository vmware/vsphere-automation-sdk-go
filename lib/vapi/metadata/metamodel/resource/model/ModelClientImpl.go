...
func (mIface *ModelClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(mIface.interfaceName)
}

func (mIface *ModelClientImpl) Definition() core.InterfaceDefinition {
    return mIface.interfaceDefinition
}

func (mIface *ModelClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
