...
func (sIface *StructureClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *StructureClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *StructureClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
