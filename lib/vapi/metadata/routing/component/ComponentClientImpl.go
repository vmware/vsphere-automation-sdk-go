...
func (cIface *ComponentClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ComponentClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ComponentClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
