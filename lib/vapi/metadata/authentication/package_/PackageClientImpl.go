...
func (pIface *PackageClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(pIface.interfaceName)
}

func (pIface *PackageClientImpl) Definition() core.InterfaceDefinition {
    return pIface.interfaceDefinition
}

func (pIface *PackageClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
