...
type RelayProfilesClient interface {
	...
	//  Please use Policy API: PATCH /policy/api/v1/infra/dhcp-relay-configs/{dhcp-relay-config-id}
	//
	...
	//  Please use Policy API: DELETE /policy/api/v1/infra/dhcp-relay-configs/{dhcp-relay-config-id}
	//
	// Deprecated: This API element is deprecated.
	//
	...
	//  Please use Policy API: GET /policy/api/v1/infra/dhcp-relay-configs/{dhcp-relay-config-id}
	//
	// Deprecated: This API element is deprecated.
	//
	// @param relayProfileIdParam (required)
	...
	//  Please use Policy API: GET /policy/api/v1/infra/dhcp-relay-configs
	//
	// Deprecated: This API element is deprecated.
	//
	...
	//  Please use Policy API: PUT /policy/api/v1/infra/dhcp-relay-configs/{dhcp-relay-config-id}
	//
	// Deprecated: This API element is deprecated.
	//
	// @param relayProfileIdParam (required)
