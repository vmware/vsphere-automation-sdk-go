...
func ConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.SupportBundleConfigBindingType)
}
...
func configUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["support_bundle_config"] = vapiBindings_.NewReferenceType(nsxModel.SupportBundleConfigBindingType)
	fieldNameMap["support_bundle_config"] = "SupportBundleConfig"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func configUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["support_bundle_config"] = vapiBindings_.NewReferenceType(nsxModel.SupportBundleConfigBindingType)
	fieldNameMap["support_bundle_config"] = "SupportBundleConfig"
	paramsTypeMap["support_bundle_config"] = vapiBindings_.NewReferenceType(nsxModel.SupportBundleConfigBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
