...
func upgradeExecutepreupgradechecksInputType() vapiBindings_.StructType {
	...
	fields["run_only_implicit_pre_checks"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	fields["run_only_on_enabled_groups"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	...
	fieldNameMap["run_only_implicit_pre_checks"] = "RunOnlyImplicitPreChecks"
	fieldNameMap["run_only_on_enabled_groups"] = "RunOnlyOnEnabledGroups"
...
func upgradeExecutepreupgradechecksRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["run_only_implicit_pre_checks"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	paramsTypeMap["sort_by"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	paramsTypeMap["run_only_on_enabled_groups"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	paramsTypeMap["page_size"] = vapiBindings_.NewOptionalType(vapiBindings_.NewIntegerType())
	queryParams["cursor"] = "cursor"
	queryParams["component_type"] = "component_type"
	queryParams["sort_ascending"] = "sort_ascending"
	queryParams["included_fields"] = "included_fields"
	queryParams["run_only_implicit_pre_checks"] = "run_only_implicit_pre_checks"
	queryParams["sort_by"] = "sort_by"
	queryParams["run_only_on_enabled_groups"] = "run_only_on_enabled_groups"
...
func upgradeRollbackInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["component_type"] = vapiBindings_.NewStringType()
	fieldNameMap["component_type"] = "ComponentType"
...
func UpgradeRollbackOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func upgradeRollbackRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
