...
type ResultsClient interface {
	...
	// @param actionTypeParam TRACE - Tracing packet by reporting observations in datapath. PKTCAP - Dumping packet to PCAP file. COUNT - Counting packet on checkpoint. DATAPATH_STATS - Datapath statistics action. (optional)
