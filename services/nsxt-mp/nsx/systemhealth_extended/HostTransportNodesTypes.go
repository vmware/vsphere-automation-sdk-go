...
// Possible value for ``source`` of method HostTransportNodes#list.
const HostTransportNodes_LIST_SOURCE_REALTIME = "realtime"

// Possible value for ``source`` of method HostTransportNodes#list.
const HostTransportNodes_LIST_SOURCE_CACHED = "cached"
...
func hostTransportNodesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/systemhealth-extended/host-transport-nodes",
		"",
		resultHeaders,
		200,
		"",
