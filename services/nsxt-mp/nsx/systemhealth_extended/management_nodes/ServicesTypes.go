...
func ServicesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.UaServiceHealthMetricsBindingType)
}
...
func servicesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/systemhealth-extended/management-nodes/{nodeId}/services/nsxt-mp/{serviceName}",
		"",
		resultHeaders,
		200,
		"",
