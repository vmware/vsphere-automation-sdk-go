...
func NewHostTransportNodesClient(connector vapiProtocolClient_.Connector) *hostTransportNodesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.systemhealth_extended.host_transport_nodes")
...
func (hIface *hostTransportNodesClient) List(compactModeParam *bool, cursorParam *string, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string) (nsxModel.NodesMetricsList, error) {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.systemhealth_extended.host_transport_nodes", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodesMetricsList
