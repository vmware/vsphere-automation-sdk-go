...
type ScopeAssociationsClient interface {
	...
	// @param discoveredResourceExternalIdParam External id of the discovered resource for which association is being queried. (optional)
	// @param discoveredResourceTypeParam Type of the discovered resource for which association is being queried. (optional)
	// @param includedFieldsParam Note - this parameter currently only works when used with the search APIs /policy/api/v1/search/query and /policy/api/v1/search/dsl. It is ignored for other list APIs. (optional)
	// @param pageSizeParam Maximum number of results to return in this page (server may return fewer) (optional, default to 1000)
	// @param scopeIdParam Id of the scope the associations for which are being queried. (optional)
	// @param scopeTypeParam Type of the scope the associations for which are being queried. (optional)
