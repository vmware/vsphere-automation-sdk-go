...
// Data type definitions file for service: BaremetalServers.
...
func baremetalServersListInputType() vapiBindings_.StructType {
...
func BaremetalServersListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.BareMetalServerListResultBindingType)
}

func baremetalServersListRestMetadata() vapiProtocol_.OperationRestMetadata {
