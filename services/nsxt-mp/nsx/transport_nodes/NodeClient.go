...
type NodeClient interface {
	...
	Get(transportNodeIdParam string) (nsxModel.NodeProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Restart(transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Setcoredumpconfig(transportNodeIdParam string, coreDumpConfigParam nsxModel.CoreDumpConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Setsystemtime(transportNodeIdParam string, nodeTimeParam nsxModel.NodeTime) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Shutdown(transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(transportNodeIdParam string, nodePropertiesParam nsxModel.NodeProperties) (nsxModel.NodeProperties, error)
}
...
func NewNodeClient(connector vapiProtocolClient_.Connector) *nodeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node")
...
func (nIface *nodeClient) Get(transportNodeIdParam string) (nsxModel.NodeProperties, error) {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeProperties
...
func (nIface *nodeClient) Restart(transportNodeIdParam string) error {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "restart", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), nIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (nIface *nodeClient) Setcoredumpconfig(transportNodeIdParam string, coreDumpConfigParam nsxModel.CoreDumpConfig) error {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "setcoredumpconfig", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), nIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (nIface *nodeClient) Setsystemtime(transportNodeIdParam string, nodeTimeParam nsxModel.NodeTime) error {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "setsystemtime", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), nIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (nIface *nodeClient) Shutdown(transportNodeIdParam string) error {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "shutdown", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), nIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (nIface *nodeClient) Update(transportNodeIdParam string, nodePropertiesParam nsxModel.NodeProperties) (nsxModel.NodeProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeProperties
	if methodResult.IsSuccess() {
