...
type AuthPolicyClient interface {
	...
	Get(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetall(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetauthpolicies(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetpwdcomplexity(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(transportNodeIdParam string, authenticationPolicyPropertiesParam nsxModel.AuthenticationPolicyProperties) (nsxModel.AuthenticationPolicyProperties, error)
}
...
func NewAuthPolicyClient(connector vapiProtocolClient_.Connector) *authPolicyClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.aaa.auth_policy")
...
func (aIface *authPolicyClient) Get(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.aaa.auth_policy", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.AuthenticationPolicyProperties
...
func (aIface *authPolicyClient) Resetall(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.aaa.auth_policy", "resetall", inputDataValue, executionContext)
	var emptyOutput nsxModel.AuthenticationPolicyProperties
	if methodResult.IsSuccess() {
...
func (aIface *authPolicyClient) Resetauthpolicies(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.aaa.auth_policy", "resetauthpolicies", inputDataValue, executionContext)
	var emptyOutput nsxModel.AuthenticationPolicyProperties
	if methodResult.IsSuccess() {
...
func (aIface *authPolicyClient) Resetpwdcomplexity(transportNodeIdParam string) (nsxModel.AuthenticationPolicyProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.aaa.auth_policy", "resetpwdcomplexity", inputDataValue, executionContext)
	var emptyOutput nsxModel.AuthenticationPolicyProperties
	if methodResult.IsSuccess() {
...
func (aIface *authPolicyClient) Update(transportNodeIdParam string, authenticationPolicyPropertiesParam nsxModel.AuthenticationPolicyProperties) (nsxModel.AuthenticationPolicyProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.aaa.auth_policy", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.AuthenticationPolicyProperties
	if methodResult.IsSuccess() {
