...
type TasksClient interface {
	...
	Cancel(taskIdParam string, transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete(taskIdParam string, transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(taskIdParam string, transportNodeIdParam string, suppressRedirectParam *bool) (nsxModel.ApplianceManagementTaskProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(transportNodeIdParam string, fieldsParam *string, requestMethodParam *string, requestPathParam *string, requestUriParam *string, statusParam *string, userParam *string) (nsxModel.ApplianceManagementTaskListResult, error)
}
...
func NewTasksClient(connector vapiProtocolClient_.Connector) *tasksClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.tasks")
...
func (tIface *tasksClient) Cancel(taskIdParam string, transportNodeIdParam string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.tasks", "cancel", inputDataValue, executionContext)
...
func (tIface *tasksClient) Delete(taskIdParam string, transportNodeIdParam string) error {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.tasks", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), tIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (tIface *tasksClient) Get(taskIdParam string, transportNodeIdParam string, suppressRedirectParam *bool) (nsxModel.ApplianceManagementTaskProperties, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.tasks", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.ApplianceManagementTaskProperties
	if methodResult.IsSuccess() {
...
func (tIface *tasksClient) List(transportNodeIdParam string, fieldsParam *string, requestMethodParam *string, requestPathParam *string, requestUriParam *string, statusParam *string, userParam *string) (nsxModel.ApplianceManagementTaskListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.tasks", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.ApplianceManagementTaskListResult
	if methodResult.IsSuccess() {
