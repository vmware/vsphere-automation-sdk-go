...
func interfacesGetInputType() vapiBindings_.StructType {
	...
	fields["iface_uuid"] = vapiBindings_.NewStringType()
	fields["transport_node_id"] = vapiBindings_.NewStringType()
	fieldNameMap["iface_uuid"] = "IfaceUuid"
...
func InterfacesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.IfaceFlowInfoBindingType)
}
...
func interfacesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["iface_uuid"] = vapiBindings_.NewStringType()
	paramsTypeMap["transportNodeId"] = vapiBindings_.NewStringType()
	paramsTypeMap["ifaceUuid"] = vapiBindings_.NewStringType()
	pathParams["transport_node_id"] = "transportNodeId"
	pathParams["iface_uuid"] = "ifaceUuid"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-nodes/{transportNodeId}/node/flows/interfaces/{ifaceUuid}",
		"",
		resultHeaders,
		200,
		"",
