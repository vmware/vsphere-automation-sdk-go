...
func logicalRoutersListInputType() vapiBindings_.StructType {
	...
	fields["uuid"] = vapiBindings_.NewStringType()
...
func logicalRoutersListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["uuid"] = vapiBindings_.NewStringType()
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-nodes/{transportNodeId}/node/flows/logical-routers/{uuid}",
		"",
		resultHeaders,
		200,
		"",
