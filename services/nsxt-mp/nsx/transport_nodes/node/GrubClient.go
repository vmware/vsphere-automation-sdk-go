...
type GrubClient interface {
	...
	Get(transportNodeIdParam string) (nsxModel.NodeGrubProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(transportNodeIdParam string, nodeGrubPropertiesParam nsxModel.NodeGrubProperties) (nsxModel.NodeGrubProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update0(grubUsernameParam string, transportNodeIdParam string, nodeGrubUserPropertiesParam nsxModel.NodeGrubUserProperties) (nsxModel.NodeGrubUserProperties, error)
}
...
func NewGrubClient(connector vapiProtocolClient_.Connector) *grubClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.grub")
...
func (gIface *grubClient) Get(transportNodeIdParam string) (nsxModel.NodeGrubProperties, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.grub", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubProperties
...
func (gIface *grubClient) Update(transportNodeIdParam string, nodeGrubPropertiesParam nsxModel.NodeGrubProperties) (nsxModel.NodeGrubProperties, error) {
	typeConverter := gIface.connector.TypeConverter()
	executionContext := gIface.connector.NewExecutionContext()
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.grub", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubProperties
	if methodResult.IsSuccess() {
...
func (gIface *grubClient) Update0(grubUsernameParam string, transportNodeIdParam string, nodeGrubUserPropertiesParam nsxModel.NodeGrubUserProperties) (nsxModel.NodeGrubUserProperties, error) {
	typeConverter := gIface.connector.TypeConverter()
	executionContext := gIface.connector.NewExecutionContext()
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.grub", "update_0", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubUserProperties
	if methodResult.IsSuccess() {
