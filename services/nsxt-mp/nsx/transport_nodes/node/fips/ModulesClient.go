...
type ModulesClient interface {
	...
	Get(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get0(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get1(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get2(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error)
}
...
func NewModulesClient(connector vapiProtocolClient_.Connector) *modulesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.fips.modules")
...
func (mIface *modulesClient) Get(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.fips.modules", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeFIPsModuleProperties
...
func (mIface *modulesClient) Get0(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.fips.modules", "get_0", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeFIPsModuleProperties
	if methodResult.IsSuccess() {
...
func (mIface *modulesClient) Get1(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.fips.modules", "get_1", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeFIPsModuleProperties
	if methodResult.IsSuccess() {
...
func (mIface *modulesClient) Get2(transportNodeIdParam string) (nsxModel.NodeFIPsModuleProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.fips.modules", "get_2", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeFIPsModuleProperties
	if methodResult.IsSuccess() {
