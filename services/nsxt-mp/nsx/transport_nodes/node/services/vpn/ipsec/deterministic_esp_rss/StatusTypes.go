...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.EdgeIPSecDetermRSSValuesBindingType)
}
...
func statusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-nodes/{transportNodeId}/node/services/nsxt-mp/vpn/ipsec/deterministic-esp-rss/status",
		"",
		resultHeaders,
		200,
		"",
