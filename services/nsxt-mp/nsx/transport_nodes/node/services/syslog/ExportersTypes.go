...
func exportersCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"POST",
		"/api/v1/transport-nodes/{transportNodeId}/node/services/nsxt-mp/syslog/exporters",
		"application/json",
		resultHeaders,
		201,
		"",
...
func exportersDelete0RestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/api/v1/transport-nodes/{transportNodeId}/node/services/nsxt-mp/syslog/exporters/{exporterName}",
		"",
		resultHeaders,
		204,
		"",
...
func exportersDeleteallnonvcfopsmanagedexportersInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["transport_node_id"] = vapiBindings_.NewStringType()
	fieldNameMap["transport_node_id"] = "TransportNodeId"
...
func ExportersDeleteallnonvcfopsmanagedexportersOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func exportersDeleteallnonvcfopsmanagedexportersRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		dispatchHeaderParams,
		bodyFieldsMap,
		"action=delete_all_non_vcf_ops_managed_exporters",
		"",
		"POST",
		"/api/v1/transport-nodes/{transportNodeId}/node/services/nsxt-mp/syslog/exporters",
		"",
