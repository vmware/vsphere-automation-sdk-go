...
type ExportersClient interface {
	...
	Create(transportNodeIdParam string, nodeSyslogExporterPropertiesParam nsxModel.NodeSyslogExporterProperties) (nsxModel.NodeSyslogExporterProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete(transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete0(exporterNameParam string, transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Deleteallnonvcfopsmanagedexporters(transportNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(exporterNameParam string, transportNodeIdParam string) (nsxModel.NodeSyslogExporterProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(transportNodeIdParam string) (nsxModel.NodeSyslogExporterPropertiesListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Verify(transportNodeIdParam string) error
}
...
func NewExportersClient(connector vapiProtocolClient_.Connector) *exportersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.services.syslog.exporters")
...
func (eIface *exportersClient) Create(transportNodeIdParam string, nodeSyslogExporterPropertiesParam nsxModel.NodeSyslogExporterProperties) (nsxModel.NodeSyslogExporterProperties, error) {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "create", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeSyslogExporterProperties
...
func (eIface *exportersClient) Delete(transportNodeIdParam string) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *exportersClient) Delete0(exporterNameParam string, transportNodeIdParam string) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "delete_0", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *exportersClient) Deleteallnonvcfopsmanagedexporters(transportNodeIdParam string) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "deleteallnonvcfopsmanagedexporters", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *exportersClient) Get(exporterNameParam string, transportNodeIdParam string) (nsxModel.NodeSyslogExporterProperties, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeSyslogExporterProperties
	if methodResult.IsSuccess() {
...
func (eIface *exportersClient) List(transportNodeIdParam string) (nsxModel.NodeSyslogExporterPropertiesListResult, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeSyslogExporterPropertiesListResult
	if methodResult.IsSuccess() {
...
func (eIface *exportersClient) Verify(transportNodeIdParam string) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.syslog.exporters", "verify", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
