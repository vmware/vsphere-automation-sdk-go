...
func NewLiagentClient(connector vapiProtocolClient_.Connector) *liagentClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.services.liagent")
...
func (lIface *liagentClient) Get(transportNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.liagent", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (lIface *liagentClient) Restart(transportNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.liagent", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (lIface *liagentClient) Start(transportNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.liagent", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (lIface *liagentClient) Stop(transportNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services.liagent", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
