...
// Data type definitions file for service: Router.
...
func routerGetInputType() vapiBindings_.StructType {
...
func RouterGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.NodeServicePropertiesBindingType)
}

func routerGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/transport-nodes/{transportNodeId}/node/services/nsxt-mp/router",
		"",
		resultHeaders,
		200,
		"",
