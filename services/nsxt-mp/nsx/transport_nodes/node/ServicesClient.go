...
type ServicesClient interface {
	...
	List(transportNodeIdParam string) (nsxModel.NodeServicePropertiesListResult, error)
}
...
func NewServicesClient(connector vapiProtocolClient_.Connector) *servicesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.services")
...
func (sIface *servicesClient) List(transportNodeIdParam string) (nsxModel.NodeServicePropertiesListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.services", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServicePropertiesListResult
