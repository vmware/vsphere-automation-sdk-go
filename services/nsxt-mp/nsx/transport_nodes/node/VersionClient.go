...
type VersionClient interface {
	...
	Get(transportNodeIdParam string) (nsxModel.NodeVersion, error)
}
...
func NewVersionClient(connector vapiProtocolClient_.Connector) *versionClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.version")
...
func (vIface *versionClient) Get(transportNodeIdParam string) (nsxModel.NodeVersion, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.version", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeVersion
