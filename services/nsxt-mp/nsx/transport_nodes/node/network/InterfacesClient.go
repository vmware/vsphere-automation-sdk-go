...
type InterfacesClient interface {
	...
	Get(interfaceIdParam string, transportNodeIdParam string) (nsxModel.NodeNetworkInterfaceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(transportNodeIdParam string) (nsxModel.NodeNetworkInterfacePropertiesListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(interfaceIdParam string, transportNodeIdParam string, nodeNetworkInterfacePropertiesParam nsxModel.NodeNetworkInterfaceProperties) (nsxModel.NodeNetworkInterfaceProperties, error)
}
...
func NewInterfacesClient(connector vapiProtocolClient_.Connector) *interfacesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.network.interfaces")
...
func (iIface *interfacesClient) Get(interfaceIdParam string, transportNodeIdParam string) (nsxModel.NodeNetworkInterfaceProperties, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.network.interfaces", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfaceProperties
...
func (iIface *interfacesClient) List(transportNodeIdParam string) (nsxModel.NodeNetworkInterfacePropertiesListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.network.interfaces", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfacePropertiesListResult
	if methodResult.IsSuccess() {
...
func (iIface *interfacesClient) Update(interfaceIdParam string, transportNodeIdParam string, nodeNetworkInterfacePropertiesParam nsxModel.NodeNetworkInterfaceProperties) (nsxModel.NodeNetworkInterfaceProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.network.interfaces", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfaceProperties
	if methodResult.IsSuccess() {
