...
type StatsClient interface {
	...
	Get(interfaceIdParam string, transportNodeIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error)
}
...
func NewStatsClient(connector vapiProtocolClient_.Connector) *statsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.node.network.interfaces.stats")
...
func (sIface *statsClient) Get(interfaceIdParam string, transportNodeIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.transport_nodes.node.network.interfaces.stats", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeInterfaceStatisticsProperties
