...
type GlobalConfigClient interface {
	...
	// @return com.vmware.nsx.model.GlobalCdoModeConfig
	//
	...
	Get() (nsxModel.GlobalCdoModeConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(globalCdoModeConfigParam nsxModel.GlobalCdoModeConfig) (nsxModel.GlobalCdoModeConfig, error)
}
...
func NewGlobalConfigClient(connector vapiProtocolClient_.Connector) *globalConfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cdo_mode.global_config")
...
func (gIface *globalConfigClient) Get() (nsxModel.GlobalCdoModeConfig, error) {
	...
	if inputError != nil {
		var emptyOutput nsxModel.GlobalCdoModeConfig
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cdo_mode.global_config", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.GlobalCdoModeConfig
	if methodResult.IsSuccess() {
		...
		return output.(nsxModel.GlobalCdoModeConfig), nil
	} else {
...
func (gIface *globalConfigClient) Update(globalCdoModeConfigParam nsxModel.GlobalCdoModeConfig) (nsxModel.GlobalCdoModeConfig, error) {
	typeConverter := gIface.connector.TypeConverter()
	executionContext := gIface.connector.NewExecutionContext()
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cdo_mode.global_config", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.GlobalCdoModeConfig
	if methodResult.IsSuccess() {
