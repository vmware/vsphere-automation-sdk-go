...
type PlannedMaintenanceClient interface {
	...
	//
	// @param preUpgradeHealthCheckRequestParam (required)
	...
	Create(preUpgradeHealthCheckRequestParam nsxModel.PreUpgradeHealthCheckRequest) (nsxModel.PreUpgradeHostHealthCheckStatuses, error)
}
...
func NewPlannedMaintenanceClient(connector vapiProtocolClient_.Connector) *plannedMaintenanceClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.upgrade.pre_upgrade_checks.host.planned_maintenance")
...
func (pIface *plannedMaintenanceClient) Create(preUpgradeHealthCheckRequestParam nsxModel.PreUpgradeHealthCheckRequest) (nsxModel.PreUpgradeHostHealthCheckStatuses, error) {
	...
	sv.AddStructField("PreUpgradeHealthCheckRequest", preUpgradeHealthCheckRequestParam)
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.upgrade.pre_upgrade_checks.host.planned_maintenance", "create", inputDataValue, executionContext)
	var emptyOutput nsxModel.PreUpgradeHostHealthCheckStatuses
