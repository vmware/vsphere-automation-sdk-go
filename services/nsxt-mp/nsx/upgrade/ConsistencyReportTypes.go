...
// Data type definitions file for service: ConsistencyReport.
...
func consistencyReportListInputType() vapiBindings_.StructType {
...
func ConsistencyReportListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.ConsistencyCheckReportBindingType)
}

func consistencyReportListRestMetadata() vapiProtocol_.OperationRestMetadata {
