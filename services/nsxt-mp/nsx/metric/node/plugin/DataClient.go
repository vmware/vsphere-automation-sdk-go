...
type DataClient interface {
	...
	// @param pluginIdParam ID of SHA plugin (required)
	//
	...
	Delete(nodeIdParam string, pluginIdParam string) error
}
...
func NewDataClient(connector vapiProtocolClient_.Connector) *dataClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.metric.node.plugin.data")
...
func (dIface *dataClient) Delete(nodeIdParam string, pluginIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.metric.node.plugin.data", "delete", inputDataValue, executionContext)
