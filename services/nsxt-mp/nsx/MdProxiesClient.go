...
type MdProxiesClient interface {
	...
	//  Please use Policy API: PATCH /policy/api/v1/infra/metadata-proxies/{metadata-proxy-id}
	//
	...
	//  Please use Policy API: DELETE /policy/api/v1/infra/metadata-proxies/{metadata-proxy-id}
	//
	// Deprecated: This API element is deprecated.
	//
	...
	//  Please use Policy API: GET /policy/api/v1/infra/metadata-proxies/{metadata-proxy-id}
	//
	// Deprecated: This API element is deprecated.
	//
	// @param proxyIdParam (required)
	...
	//  Please use Policy API: GET /policy/api/v1/infra/metadata-proxies
	//
	// Deprecated: This API element is deprecated.
	//
	...
	//  Please use Policy API: PUT /policy/api/v1/infra/metadata-proxies/{metadata-proxy-id}
	//
	// Deprecated: This API element is deprecated.
	//
	// @param proxyIdParam (required)
