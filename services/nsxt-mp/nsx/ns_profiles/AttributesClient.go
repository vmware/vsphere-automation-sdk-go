...
type AttributesClient interface {
	...
	//
	// @param attributeSourceParam (optional)
	// @param attributeTypeParam It fetches attributes and subattributes for the given attribute type supported in the system which can be used for NSProfile creation. (optional)
