...
// Data type definitions file for service: ConfigureVidbOidcEndpoint.
...
func configureVidbOidcEndpointCreateInputType() vapiBindings_.StructType {
...
func ConfigureVidbOidcEndpointCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsxModel.VidbOidcEndpointCreateResponseBindingType)
}

func configureVidbOidcEndpointCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
