...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.monitor.node.status")
...
func (sIface *statusClient) Delete(nodeIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.monitor.node.status", "delete", inputDataValue, executionContext)
