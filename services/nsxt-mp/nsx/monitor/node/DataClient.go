...
func NewDataClient(connector vapiProtocolClient_.Connector) *dataClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.monitor.node.data")
...
func (dIface *dataClient) Delete(nodeIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.monitor.node.data", "delete", inputDataValue, executionContext)
