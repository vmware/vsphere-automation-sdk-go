...
type ManagementPlaneClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(clusterNodeIdParam string) (nsxModel.ManagementPlaneProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, managementPlanePropertiesParam nsxModel.ManagementPlaneProperties) (nsxModel.ManagementPlaneProperties, error)
}
...
func NewManagementPlaneClient(connector vapiProtocolClient_.Connector) *managementPlaneClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.management_plane")
...
func (mIface *managementPlaneClient) Delete(clusterNodeIdParam string) error {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.management_plane", "delete", inputDataValue, executionContext)
...
func (mIface *managementPlaneClient) Get(clusterNodeIdParam string) (nsxModel.ManagementPlaneProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.management_plane", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.ManagementPlaneProperties
	if methodResult.IsSuccess() {
...
func (mIface *managementPlaneClient) Update(clusterNodeIdParam string, managementPlanePropertiesParam nsxModel.ManagementPlaneProperties) (nsxModel.ManagementPlaneProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.management_plane", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.ManagementPlaneProperties
	if methodResult.IsSuccess() {
