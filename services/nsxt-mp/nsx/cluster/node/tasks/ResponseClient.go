...
type ResponseClient interface {
	...
	Get(taskIdParam string, clusterNodeIdParam string) error
}
...
func NewResponseClient(connector vapiProtocolClient_.Connector) *responseClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.tasks.response")
...
func (rIface *responseClient) Get(taskIdParam string, clusterNodeIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.tasks.response", "get", inputDataValue, executionContext)
