...
type NtpClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodeNtpServiceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodeNtpServicePropertiesParam nsxModel.NodeNtpServiceProperties) (nsxModel.NodeNtpServiceProperties, error)
}
...
func NewNtpClient(connector vapiProtocolClient_.Connector) *ntpClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.ntp")
...
func (nIface *ntpClient) Get(clusterNodeIdParam string) (nsxModel.NodeNtpServiceProperties, error) {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ntp", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNtpServiceProperties
...
func (nIface *ntpClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ntp", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *ntpClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ntp", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *ntpClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ntp", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *ntpClient) Update(clusterNodeIdParam string, nodeNtpServicePropertiesParam nsxModel.NodeNtpServiceProperties) (nsxModel.NodeNtpServiceProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ntp", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNtpServiceProperties
	if methodResult.IsSuccess() {
