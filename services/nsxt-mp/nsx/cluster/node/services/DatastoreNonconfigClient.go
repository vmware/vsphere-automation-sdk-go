...
func NewDatastore_nonconfigClient(connector vapiProtocolClient_.Connector) *datastore_nonconfigClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.datastore_nonconfig")
...
func (dIface *datastore_nonconfigClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.datastore_nonconfig", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (dIface *datastore_nonconfigClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.datastore_nonconfig", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (dIface *datastore_nonconfigClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.datastore_nonconfig", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (dIface *datastore_nonconfigClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.datastore_nonconfig", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
