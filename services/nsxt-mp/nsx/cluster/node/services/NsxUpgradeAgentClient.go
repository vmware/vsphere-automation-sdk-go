...
func NewNsxUpgradeAgentClient(connector vapiProtocolClient_.Connector) *nsxUpgradeAgentClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.nsx_upgrade_agent")
...
func (nIface *nsxUpgradeAgentClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.nsx_upgrade_agent", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (nIface *nsxUpgradeAgentClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.nsx_upgrade_agent", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *nsxUpgradeAgentClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.nsx_upgrade_agent", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *nsxUpgradeAgentClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.nsx_upgrade_agent", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
