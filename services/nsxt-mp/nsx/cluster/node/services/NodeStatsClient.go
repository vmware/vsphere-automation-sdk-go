...
func NewNodeStatsClient(connector vapiProtocolClient_.Connector) *nodeStatsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.node_stats")
...
func (nIface *nodeStatsClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.node_stats", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (nIface *nodeStatsClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.node_stats", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *nodeStatsClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.node_stats", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (nIface *nodeStatsClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.node_stats", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
