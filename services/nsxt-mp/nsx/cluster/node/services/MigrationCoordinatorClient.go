...
func NewMigrationCoordinatorClient(connector vapiProtocolClient_.Connector) *migrationCoordinatorClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.migration_coordinator")
...
func (mIface *migrationCoordinatorClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.migration_coordinator", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (mIface *migrationCoordinatorClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.migration_coordinator", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (mIface *migrationCoordinatorClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.migration_coordinator", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (mIface *migrationCoordinatorClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.migration_coordinator", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
