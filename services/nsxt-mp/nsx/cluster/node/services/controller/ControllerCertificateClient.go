...
type ControllerCertificateClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.CertificateKeyPair, error)
}
...
func NewControllerCertificateClient(connector vapiProtocolClient_.Connector) *controllerCertificateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.controller.controller_certificate")
...
func (cIface *controllerCertificateClient) Get(clusterNodeIdParam string) (nsxModel.CertificateKeyPair, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.controller.controller_certificate", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.CertificateKeyPair
