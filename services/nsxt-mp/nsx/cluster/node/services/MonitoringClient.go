...
type MonitoringClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodeMonitoringServiceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetmonitoringlogginglevels(clusterNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodeMonitoringServicePropertiesParam nsxModel.NodeMonitoringServiceProperties) (nsxModel.NodeMonitoringServiceProperties, error)
}
...
func NewMonitoringClient(connector vapiProtocolClient_.Connector) *monitoringClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.monitoring")
...
func (mIface *monitoringClient) Get(clusterNodeIdParam string) (nsxModel.NodeMonitoringServiceProperties, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeMonitoringServiceProperties
...
func (mIface *monitoringClient) Resetmonitoringlogginglevels(clusterNodeIdParam string) error {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "resetmonitoringlogginglevels", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), mIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (mIface *monitoringClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (mIface *monitoringClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (mIface *monitoringClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (mIface *monitoringClient) Update(clusterNodeIdParam string, nodeMonitoringServicePropertiesParam nsxModel.NodeMonitoringServiceProperties) (nsxModel.NodeMonitoringServiceProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.monitoring", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeMonitoringServiceProperties
	if methodResult.IsSuccess() {
