...
func NewApplianceproxyClient(connector vapiProtocolClient_.Connector) *applianceproxyClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.applianceproxy")
...
func (aIface *applianceproxyClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.applianceproxy", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (aIface *applianceproxyClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.applianceproxy", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (aIface *applianceproxyClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.applianceproxy", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (aIface *applianceproxyClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.applianceproxy", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
