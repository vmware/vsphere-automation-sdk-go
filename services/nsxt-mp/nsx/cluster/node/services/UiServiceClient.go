...
func NewUiServiceClient(connector vapiProtocolClient_.Connector) *uiServiceClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.ui_service")
...
func (uIface *uiServiceClient) Get(clusterNodeIdParam string) (nsxModel.NodeServiceProperties, error) {
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ui_service", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceProperties
...
func (uIface *uiServiceClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ui_service", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (uIface *uiServiceClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ui_service", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (uIface *uiServiceClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.ui_service", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
