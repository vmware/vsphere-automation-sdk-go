...
type PolicyClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodePolicyServiceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetmanagerlogginglevels(clusterNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodePolicyServicePropertiesParam nsxModel.NodePolicyServiceProperties) (nsxModel.NodePolicyServiceProperties, error)
}
...
func NewPolicyClient(connector vapiProtocolClient_.Connector) *policyClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.policy")
...
func (pIface *policyClient) Get(clusterNodeIdParam string) (nsxModel.NodePolicyServiceProperties, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodePolicyServiceProperties
...
func (pIface *policyClient) Resetmanagerlogginglevels(clusterNodeIdParam string) error {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "resetmanagerlogginglevels", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), pIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (pIface *policyClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (pIface *policyClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (pIface *policyClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (pIface *policyClient) Update(clusterNodeIdParam string, nodePolicyServicePropertiesParam nsxModel.NodePolicyServiceProperties) (nsxModel.NodePolicyServiceProperties, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.policy", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodePolicyServiceProperties
	if methodResult.IsSuccess() {
