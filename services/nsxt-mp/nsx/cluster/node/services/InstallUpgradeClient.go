...
type InstallUpgradeClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodeInstallUpgradeServiceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodeInstallUpgradeServicePropertiesParam nsxModel.NodeInstallUpgradeServiceProperties) (nsxModel.NodeInstallUpgradeServiceProperties, error)
}
...
func NewInstallUpgradeClient(connector vapiProtocolClient_.Connector) *installUpgradeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.install_upgrade")
...
func (iIface *installUpgradeClient) Get(clusterNodeIdParam string) (nsxModel.NodeInstallUpgradeServiceProperties, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.install_upgrade", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeInstallUpgradeServiceProperties
...
func (iIface *installUpgradeClient) Restart(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.install_upgrade", "restart", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (iIface *installUpgradeClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.install_upgrade", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (iIface *installUpgradeClient) Stop(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.install_upgrade", "stop", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (iIface *installUpgradeClient) Update(clusterNodeIdParam string, nodeInstallUpgradeServicePropertiesParam nsxModel.NodeInstallUpgradeServiceProperties) (nsxModel.NodeInstallUpgradeServiceProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.install_upgrade", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeInstallUpgradeServiceProperties
	if methodResult.IsSuccess() {
