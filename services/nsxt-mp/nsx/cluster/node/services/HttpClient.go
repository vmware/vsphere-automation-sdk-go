...
type HttpClient interface {
	...
	Applycertificate(clusterNodeIdParam string, certificateIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(clusterNodeIdParam string) (nsxModel.NodeHttpServiceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Stop(clusterNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodeHttpServicePropertiesParam nsxModel.NodeHttpServiceProperties) (nsxModel.NodeHttpServiceProperties, error)
}
...
func NewHttpClient(connector vapiProtocolClient_.Connector) *httpClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services.http")
...
func (hIface *httpClient) Applycertificate(clusterNodeIdParam string, certificateIdParam string) error {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "applycertificate", inputDataValue, executionContext)
...
func (hIface *httpClient) Get(clusterNodeIdParam string) (nsxModel.NodeHttpServiceProperties, error) {
	typeConverter := hIface.connector.TypeConverter()
	executionContext := hIface.connector.NewExecutionContext()
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeHttpServiceProperties
	if methodResult.IsSuccess() {
...
func (hIface *httpClient) Restart(clusterNodeIdParam string) error {
	typeConverter := hIface.connector.TypeConverter()
	executionContext := hIface.connector.NewExecutionContext()
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "restart", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), hIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (hIface *httpClient) Start(clusterNodeIdParam string) (nsxModel.NodeServiceStatusProperties, error) {
	typeConverter := hIface.connector.TypeConverter()
	executionContext := hIface.connector.NewExecutionContext()
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "start", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServiceStatusProperties
	if methodResult.IsSuccess() {
...
func (hIface *httpClient) Stop(clusterNodeIdParam string) error {
	typeConverter := hIface.connector.TypeConverter()
	executionContext := hIface.connector.NewExecutionContext()
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "stop", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), hIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (hIface *httpClient) Update(clusterNodeIdParam string, nodeHttpServicePropertiesParam nsxModel.NodeHttpServiceProperties) (nsxModel.NodeHttpServiceProperties, error) {
	typeConverter := hIface.connector.TypeConverter()
	executionContext := hIface.connector.NewExecutionContext()
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services.http", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeHttpServiceProperties
	if methodResult.IsSuccess() {
