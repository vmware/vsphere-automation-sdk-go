...
type FileStoreClient interface {
	...
	Copyfromremotefile(fileNameParam string, clusterNodeIdParam string, copyFromRemoteFilePropertiesParam nsxModel.CopyFromRemoteFileProperties) (nsxModel.FileProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Createremotedirectory(clusterNodeIdParam string, createRemoteDirectoryPropertiesParam nsxModel.CreateRemoteDirectoryProperties) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Deleteremotedirectory(clusterNodeIdParam string, deleteRemoteDirectoryPropertiesParam nsxModel.DeleteRemoteDirectoryProperties) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(fileNameParam string, clusterNodeIdParam string) (nsxModel.FileProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Retrievematchinghostkeyalgorithm(clusterNodeIdParam string, retrieveMatchingHostKeyAlgorithmPropertiesParam nsxModel.RetrieveMatchingHostKeyAlgorithmProperties) (nsxModel.RetrieveMatchingHostKeyAlgorithmProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Retrievesshfingerprint(clusterNodeIdParam string, sshFingerprintPropertiesParam nsxModel.SshFingerprintProperties) (nsxModel.SshFingerprintProperties, error)
}
...
func NewFileStoreClient(connector vapiProtocolClient_.Connector) *fileStoreClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.file_store")
...
func (fIface *fileStoreClient) Copyfromremotefile(fileNameParam string, clusterNodeIdParam string, copyFromRemoteFilePropertiesParam nsxModel.CopyFromRemoteFileProperties) (nsxModel.FileProperties, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "copyfromremotefile", inputDataValue, executionContext)
	var emptyOutput nsxModel.FileProperties
...
func (fIface *fileStoreClient) Copytoremotefile(fileNameParam string, clusterNodeIdParam string, copyToRemoteFilePropertiesParam nsxModel.CopyToRemoteFileProperties) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "copytoremotefile", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *fileStoreClient) Createremotedirectory(clusterNodeIdParam string, createRemoteDirectoryPropertiesParam nsxModel.CreateRemoteDirectoryProperties) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "createremotedirectory", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *fileStoreClient) Delete(fileNameParam string, clusterNodeIdParam string) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *fileStoreClient) Deleteremotedirectory(clusterNodeIdParam string, deleteRemoteDirectoryPropertiesParam nsxModel.DeleteRemoteDirectoryProperties) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "deleteremotedirectory", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *fileStoreClient) Get(fileNameParam string, clusterNodeIdParam string) (nsxModel.FileProperties, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.FileProperties
	if methodResult.IsSuccess() {
...
func (fIface *fileStoreClient) List(clusterNodeIdParam string) (nsxModel.FilePropertiesListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.FilePropertiesListResult
	if methodResult.IsSuccess() {
...
func (fIface *fileStoreClient) Retrievematchinghostkeyalgorithm(clusterNodeIdParam string, retrieveMatchingHostKeyAlgorithmPropertiesParam nsxModel.RetrieveMatchingHostKeyAlgorithmProperties) (nsxModel.RetrieveMatchingHostKeyAlgorithmProperties, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "retrievematchinghostkeyalgorithm", inputDataValue, executionContext)
	var emptyOutput nsxModel.RetrieveMatchingHostKeyAlgorithmProperties
	if methodResult.IsSuccess() {
...
func (fIface *fileStoreClient) Retrievesshfingerprint(clusterNodeIdParam string, sshFingerprintPropertiesParam nsxModel.SshFingerprintProperties) (nsxModel.SshFingerprintProperties, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.file_store", "retrievesshfingerprint", inputDataValue, executionContext)
	var emptyOutput nsxModel.SshFingerprintProperties
	if methodResult.IsSuccess() {
