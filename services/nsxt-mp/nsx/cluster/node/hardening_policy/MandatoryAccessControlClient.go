...
type MandatoryAccessControlClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.MandatoryAccessControlProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, mandatoryAccessControlPropertiesParam nsxModel.MandatoryAccessControlProperties) (nsxModel.MandatoryAccessControlProperties, error)
}
...
func NewMandatoryAccessControlClient(connector vapiProtocolClient_.Connector) *mandatoryAccessControlClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.hardening_policy.mandatory_access_control")
...
func (mIface *mandatoryAccessControlClient) Get(clusterNodeIdParam string) (nsxModel.MandatoryAccessControlProperties, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.hardening_policy.mandatory_access_control", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.MandatoryAccessControlProperties
...
func (mIface *mandatoryAccessControlClient) Update(clusterNodeIdParam string, mandatoryAccessControlPropertiesParam nsxModel.MandatoryAccessControlProperties) (nsxModel.MandatoryAccessControlProperties, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.hardening_policy.mandatory_access_control", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.MandatoryAccessControlProperties
	if methodResult.IsSuccess() {
