...
type StatsClient interface {
	...
	Get(interfaceIdParam string, clusterNodeIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error)
}
...
func NewStatsClient(connector vapiProtocolClient_.Connector) *statsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.network.interfaces.stats")
...
func (sIface *statsClient) Get(interfaceIdParam string, clusterNodeIdParam string) (nsxModel.NodeInterfaceStatisticsProperties, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.interfaces.stats", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeInterfaceStatisticsProperties
