...
type InterfacesClient interface {
	...
	Get(interfaceIdParam string, clusterNodeIdParam string) (nsxModel.NodeNetworkInterfaceProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(clusterNodeIdParam string) (nsxModel.NodeNetworkInterfacePropertiesListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(interfaceIdParam string, clusterNodeIdParam string, nodeNetworkInterfacePropertiesParam nsxModel.NodeNetworkInterfaceProperties) (nsxModel.NodeNetworkInterfaceProperties, error)
}
...
func NewInterfacesClient(connector vapiProtocolClient_.Connector) *interfacesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.network.interfaces")
...
func (iIface *interfacesClient) Get(interfaceIdParam string, clusterNodeIdParam string) (nsxModel.NodeNetworkInterfaceProperties, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.interfaces", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfaceProperties
...
func (iIface *interfacesClient) List(clusterNodeIdParam string) (nsxModel.NodeNetworkInterfacePropertiesListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.interfaces", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfacePropertiesListResult
	if methodResult.IsSuccess() {
...
func (iIface *interfacesClient) Update(interfaceIdParam string, clusterNodeIdParam string, nodeNetworkInterfacePropertiesParam nsxModel.NodeNetworkInterfaceProperties) (nsxModel.NodeNetworkInterfaceProperties, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.interfaces", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeNetworkInterfaceProperties
	if methodResult.IsSuccess() {
