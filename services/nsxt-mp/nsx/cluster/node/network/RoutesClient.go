...
type RoutesClient interface {
	...
	Create(clusterNodeIdParam string, nodeRoutePropertiesParam nsxModel.NodeRouteProperties) (nsxModel.NodeRouteProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete(routeIdParam string, clusterNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(routeIdParam string, clusterNodeIdParam string) (nsxModel.NodeRouteProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(clusterNodeIdParam string) (nsxModel.NodeRoutePropertiesListResult, error)
}
...
func NewRoutesClient(connector vapiProtocolClient_.Connector) *routesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.network.routes")
...
func (rIface *routesClient) Create(clusterNodeIdParam string, nodeRoutePropertiesParam nsxModel.NodeRouteProperties) (nsxModel.NodeRouteProperties, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.routes", "create", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeRouteProperties
...
func (rIface *routesClient) Delete(routeIdParam string, clusterNodeIdParam string) error {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.routes", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *routesClient) Get(routeIdParam string, clusterNodeIdParam string) (nsxModel.NodeRouteProperties, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.routes", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeRouteProperties
	if methodResult.IsSuccess() {
...
func (rIface *routesClient) List(clusterNodeIdParam string) (nsxModel.NodeRoutePropertiesListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.network.routes", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeRoutePropertiesListResult
	if methodResult.IsSuccess() {
