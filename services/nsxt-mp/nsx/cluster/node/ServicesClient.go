...
type ServicesClient interface {
	...
	List(clusterNodeIdParam string) (nsxModel.NodeServicePropertiesListResult, error)
}
...
func NewServicesClient(connector vapiProtocolClient_.Connector) *servicesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.services")
...
func (sIface *servicesClient) List(clusterNodeIdParam string) (nsxModel.NodeServicePropertiesListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.services", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeServicePropertiesListResult
