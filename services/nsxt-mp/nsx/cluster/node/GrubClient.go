...
type GrubClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodeGrubProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(clusterNodeIdParam string, nodeGrubPropertiesParam nsxModel.NodeGrubProperties) (nsxModel.NodeGrubProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update0(grubUsernameParam string, clusterNodeIdParam string, nodeGrubUserPropertiesParam nsxModel.NodeGrubUserProperties) (nsxModel.NodeGrubUserProperties, error)
}
...
func NewGrubClient(connector vapiProtocolClient_.Connector) *grubClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.grub")
...
func (gIface *grubClient) Get(clusterNodeIdParam string) (nsxModel.NodeGrubProperties, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.grub", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubProperties
...
func (gIface *grubClient) Update(clusterNodeIdParam string, nodeGrubPropertiesParam nsxModel.NodeGrubProperties) (nsxModel.NodeGrubProperties, error) {
	typeConverter := gIface.connector.TypeConverter()
	executionContext := gIface.connector.NewExecutionContext()
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.grub", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubProperties
	if methodResult.IsSuccess() {
...
func (gIface *grubClient) Update0(grubUsernameParam string, clusterNodeIdParam string, nodeGrubUserPropertiesParam nsxModel.NodeGrubUserProperties) (nsxModel.NodeGrubUserProperties, error) {
	typeConverter := gIface.connector.TypeConverter()
	executionContext := gIface.connector.NewExecutionContext()
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.grub", "update_0", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeGrubUserProperties
	if methodResult.IsSuccess() {
