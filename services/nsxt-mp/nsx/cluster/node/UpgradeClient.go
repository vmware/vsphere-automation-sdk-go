...
type UpgradeClient interface {
	...
	// @param bundleNameParam Provide a bundle name (optional)
	// @param upgradeTaskIdParam Provide a task id (optional)
	...
	Get(clusterNodeIdParam string, bundleNameParam *string, upgradeTaskIdParam *string) (nsxModel.UpgradeTaskProperties, error)
}
...
func NewUpgradeClient(connector vapiProtocolClient_.Connector) *upgradeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.upgrade")
...
func (uIface *upgradeClient) Get(clusterNodeIdParam string, bundleNameParam *string, upgradeTaskIdParam *string) (nsxModel.UpgradeTaskProperties, error) {
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.upgrade", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.UpgradeTaskProperties
