...
type VersionClient interface {
	...
	Get(clusterNodeIdParam string) (nsxModel.NodeVersion, error)
}
...
func NewVersionClient(connector vapiProtocolClient_.Connector) *versionClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.version")
...
func (vIface *versionClient) Get(clusterNodeIdParam string) (nsxModel.NodeVersion, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.version", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeVersion
