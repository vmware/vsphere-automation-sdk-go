...
type UsersClient interface {
	...
	Activate(useridParam string, clusterNodeIdParam string, nodeUserPasswordPropertyParam nsxModel.NodeUserPasswordProperty) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Createaudituser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Createserviceuser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Createuser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Deactivate(useridParam string, clusterNodeIdParam string) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Delete(useridParam string, clusterNodeIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(useridParam string, clusterNodeIdParam string) (nsxModel.NodeUserProperties, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(clusterNodeIdParam string, filterParam *string, internalParam *bool) (nsxModel.NodeUserPropertiesListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetownpassword(clusterNodeIdParam string, resetNodeUserOwnPasswordPropertiesParam nsxModel.ResetNodeUserOwnPasswordProperties) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Resetpassword(useridParam string, clusterNodeIdParam string, nodeUserPasswordPropertyParam nsxModel.NodeUserPasswordProperty) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(useridParam string, clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error)
}
...
func NewUsersClient(connector vapiProtocolClient_.Connector) *usersClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx.cluster.node.users")
...
func (uIface *usersClient) Activate(useridParam string, clusterNodeIdParam string, nodeUserPasswordPropertyParam nsxModel.NodeUserPasswordProperty) (nsxModel.NodeUserProperties, error) {
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "activate", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
...
func (uIface *usersClient) Createaudituser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "createaudituser", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) Createserviceuser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "createserviceuser", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) Createuser(clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "createuser", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) Deactivate(useridParam string, clusterNodeIdParam string) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "deactivate", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) Delete(useridParam string, clusterNodeIdParam string) error {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), uIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (uIface *usersClient) Get(useridParam string, clusterNodeIdParam string) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "get", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) List(clusterNodeIdParam string, filterParam *string, internalParam *bool) (nsxModel.NodeUserPropertiesListResult, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "list", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserPropertiesListResult
	if methodResult.IsSuccess() {
...
func (uIface *usersClient) Resetownpassword(clusterNodeIdParam string, resetNodeUserOwnPasswordPropertiesParam nsxModel.ResetNodeUserOwnPasswordProperties) error {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "resetownpassword", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), uIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (uIface *usersClient) Resetpassword(useridParam string, clusterNodeIdParam string, nodeUserPasswordPropertyParam nsxModel.NodeUserPasswordProperty) error {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "resetpassword", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), uIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (uIface *usersClient) Update(useridParam string, clusterNodeIdParam string, nodeUserPropertiesParam nsxModel.NodeUserProperties) (nsxModel.NodeUserProperties, error) {
	typeConverter := uIface.connector.TypeConverter()
	executionContext := uIface.connector.NewExecutionContext()
	...
	methodResult := uIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.node.users", "update", inputDataValue, executionContext)
	var emptyOutput nsxModel.NodeUserProperties
	if methodResult.IsSuccess() {
