...
type LocalEndpointsClient interface {
	...
	// @param ipsecVpnServiceIdParam All the local endpoints configured with the specified VPN Service id will be included in the result. (optional)
	// @param logicalRouterIdParam All the local endpoints belonging to the specified logical router id will be included in the result. (optional)
