...
// Data type definitions file for service: SystemAdministrationConfigurationFabricNodesDiscoveredNodes.
...
// Possible value for ``hasParent`` of method SystemAdministrationConfigurationFabricNodesDiscoveredNodes#listDiscoveredNodes.
const SystemAdministrationConfigurationFabricNodesDiscoveredNodes_LIST_DISCOVERED_NODES_HAS_PARENT_TRUE = "true"

// Possible value for ``hasParent`` of method SystemAdministrationConfigurationFabricNodesDiscoveredNodes#listDiscoveredNodes.
const SystemAdministrationConfigurationFabricNodesDiscoveredNodes_LIST_DISCOVERED_NODES_HAS_PARENT_FALSE = "false"

func systemAdministrationConfigurationFabricNodesDiscoveredNodesCreateTransportNodeForDiscoveredNodeCreateTransportNodeInputType() bindings.StructType {
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesCreateTransportNodeForDiscoveredNodeCreateTransportNodeOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TransportNodeBindingType)
}

func systemAdministrationConfigurationFabricNodesDiscoveredNodesCreateTransportNodeForDiscoveredNodeCreateTransportNodeRestMetadata() protocol.OperationRestMetadata {
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesHostPrepDiscoveredNodeHostprepInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["node_ext_id"] = bindings.NewStringType()
	fieldNameMap["node_ext_id"] = "NodeExtId"
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesHostPrepDiscoveredNodeHostprepOutputType() bindings.BindingType {
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesHostPrepDiscoveredNodeHostprepRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesListDiscoveredNodesInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesListDiscoveredNodesOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DiscoveredNodeListResultBindingType)
}

func systemAdministrationConfigurationFabricNodesDiscoveredNodesListDiscoveredNodesRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesReadDiscoveredNodeInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["node_ext_id"] = bindings.NewStringType()
	fieldNameMap["node_ext_id"] = "NodeExtId"
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesReadDiscoveredNodeOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DiscoveredNodeBindingType)
}

func systemAdministrationConfigurationFabricNodesDiscoveredNodesReadDiscoveredNodeRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesReapplyTNProfileOnDiscoveredNodeReapplyClusterConfigInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["node_ext_id"] = bindings.NewStringType()
	fieldNameMap["node_ext_id"] = "NodeExtId"
...
func systemAdministrationConfigurationFabricNodesDiscoveredNodesReapplyTNProfileOnDiscoveredNodeReapplyClusterConfigOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TransportNodeBindingType)
}

func systemAdministrationConfigurationFabricNodesDiscoveredNodesReapplyTNProfileOnDiscoveredNodeReapplyClusterConfigRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
