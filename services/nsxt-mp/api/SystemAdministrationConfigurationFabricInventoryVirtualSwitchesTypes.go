...
// Data type definitions file for service: SystemAdministrationConfigurationFabricInventoryVirtualSwitches.
...
func systemAdministrationConfigurationFabricInventoryVirtualSwitchesListVirtualSwitchesInputType() bindings.StructType {
...
func systemAdministrationConfigurationFabricInventoryVirtualSwitchesListVirtualSwitchesOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.VirtualSwitchListResultBindingType)
}

func systemAdministrationConfigurationFabricInventoryVirtualSwitchesListVirtualSwitchesRestMetadata() protocol.OperationRestMetadata {
