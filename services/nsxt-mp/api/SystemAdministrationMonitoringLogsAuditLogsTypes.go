...
// Data type definitions file for service: SystemAdministrationMonitoringLogsAuditLogs.
...
func systemAdministrationMonitoringLogsAuditLogsCollectAuditLogsInputType() bindings.StructType {
...
func systemAdministrationMonitoringLogsAuditLogsCollectAuditLogsOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.AuditLogListResultBindingType)
}

func systemAdministrationMonitoringLogsAuditLogsCollectAuditLogsRestMetadata() protocol.OperationRestMetadata {
