...
type LibraryItemClient interface {
    ...
    // * The resource ``HostSystem`` referenced by the property LibraryItemDeploymentTarget#hostId requires ``System.Read``.
    // * The resource ``Network`` referenced by the map value of property LibraryItemResourcePoolDeploymentSpec#networkMappings requires ``System.Read``.
    // * The resource ``StorageProfile`` referenced by the property LibraryItemResourcePoolDeploymentSpec#storageProfileId requires ``System.Read``.
    // * The resource ``Datastore`` referenced by the property LibraryItemResourcePoolDeploymentSpec#defaultDatastoreId requires ``System.Read``.
    // * The resource ``ResourcePool`` referenced by the property LibraryItemDeploymentTarget#resourcePoolId requires ``VApp.Import``.
    // * The resource ``Folder`` referenced by the property LibraryItemDeploymentTarget#folderId requires ``VApp.Import``.
    ...
    // * Method execution requires ``System.Read``.
    // * The resource ``com.vmware.content.library.Item`` referenced by the parameter ``ovf_library_item_id`` requires ``System.Read``.
    // * The resource ``ResourcePool`` referenced by the property LibraryItemDeploymentTarget#resourcePoolId requires ``System.Read``.
    // * The resource ``HostSystem`` referenced by the property LibraryItemDeploymentTarget#hostId requires ``System.Read``.
    // * The resource ``Folder`` referenced by the property LibraryItemDeploymentTarget#folderId requires ``System.Read``.
    ...
    //
    // * Method execution requires ``System.Read``.
    // * The resource ``null`` or ``null`` referenced by the property LibraryItemDeployableIdentity#id requires ``VApp.Export``.
    // * The resource ``com.vmware.content.Library`` referenced by the property LibraryItemCreateTarget#libraryId requires ``ContentLibrary.AddLibraryItem``.
    // * The resource ``com.vmware.content.library.Item`` referenced by the property LibraryItemCreateTarget#libraryItemId requires ``System.Read``.
