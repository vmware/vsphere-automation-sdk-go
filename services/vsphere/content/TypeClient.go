...
type TypeClient interface {
    ...
    // Returns a array of TypeInfo instances which describe the type support plugins in this Content Library.
    // @return The array of TypeInfo instances which describe the type support plugins in this Content Library.
