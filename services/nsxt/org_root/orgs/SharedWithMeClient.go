...
type SharedWithMeClient interface {
	...
	List(orgIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, resourceTypeParam *string, sortAscendingParam *bool, sortByParam *string) (model.SharedResourceListResult, error)
}
...
func NewSharedWithMeClient(connector client.Connector) *sharedWithMeClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.org_root.orgs.shared_with_me")
...
func (sIface *sharedWithMeClient) List(orgIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, resourceTypeParam *string, sortAscendingParam *bool, sortByParam *string) (model.SharedResourceListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.shared_with_me", "list", inputDataValue, executionContext)
	var emptyOutput model.SharedResourceListResult
