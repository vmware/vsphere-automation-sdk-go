...
func bindingsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/flood-protection-profiles/{floodProtectionProfileId}/bindings",
		"",
		resultHeaders,
		200,
		"",
