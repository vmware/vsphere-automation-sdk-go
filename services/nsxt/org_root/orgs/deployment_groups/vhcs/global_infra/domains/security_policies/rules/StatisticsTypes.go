...
func statisticsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/domains/{domainId}/security-policies/{securityPolicyId}/rules/{ruleId}/statistics",
		"",
		resultHeaders,
		200,
		"",
