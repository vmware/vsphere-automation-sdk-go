...
func ipAddressExpressionsCreateRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"ip_address_list",
		"POST",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/domains/{domainId}/groups/{groupId}/ip-address-expressions/{expressionId}",
		"",
		resultHeaders,
		204,
		"",
