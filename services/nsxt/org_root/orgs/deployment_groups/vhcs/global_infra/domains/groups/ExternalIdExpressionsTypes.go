...
func externalIdExpressionsCreateRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"group_member_list",
		"POST",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/domains/{domainId}/groups/{groupId}/external-id-expressions/{expressionId}",
		"",
		resultHeaders,
		204,
		"",
