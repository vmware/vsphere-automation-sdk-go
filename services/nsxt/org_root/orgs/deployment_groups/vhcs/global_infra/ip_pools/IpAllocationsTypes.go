...
func ipAllocationsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/ip-pools/{ipPoolId}/ip-allocations/{ipAllocationId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipAllocationsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/ip-pools/{ipPoolId}/ip-allocations",
		"",
		resultHeaders,
		200,
		"",
