...
func segmentQosProfileBindingMapsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/segments/{segmentId}/segment-qos-profile-binding-maps/{segmentQosProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func segmentQosProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/segments/{segmentId}/segment-qos-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
