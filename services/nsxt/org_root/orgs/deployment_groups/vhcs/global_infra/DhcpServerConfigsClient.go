...
type DhcpServerConfigsClient interface {
	...
	Delete(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string) (model.DhcpServerConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DhcpServerConfigListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam model.DhcpServerConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam model.DhcpServerConfig) (model.DhcpServerConfig, error)
}
...
func NewDhcpServerConfigsClient(connector client.Connector) *dhcpServerConfigsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs")
...
func (dIface *dhcpServerConfigsClient) Delete(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs", "delete", inputDataValue, executionContext)
...
func (dIface *dhcpServerConfigsClient) Get(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string) (model.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs", "get", inputDataValue, executionContext)
	var emptyOutput model.DhcpServerConfig
	if methodResult.IsSuccess() {
...
func (dIface *dhcpServerConfigsClient) List(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DhcpServerConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs", "list", inputDataValue, executionContext)
	var emptyOutput model.DhcpServerConfigListResult
	if methodResult.IsSuccess() {
...
func (dIface *dhcpServerConfigsClient) Patch(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam model.DhcpServerConfig) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dhcpServerConfigsClient) Update(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, dhcpServerConfigIdParam string, dhcpServerConfigParam model.DhcpServerConfig) (model.DhcpServerConfig, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.global_infra.dhcp_server_configs", "update", inputDataValue, executionContext)
	var emptyOutput model.DhcpServerConfig
	if methodResult.IsSuccess() {
