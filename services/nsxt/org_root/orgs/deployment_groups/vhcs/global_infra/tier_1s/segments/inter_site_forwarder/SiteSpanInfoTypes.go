...
func siteSpanInfoGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/tier-1s/{tier1Id}/segments/{segmentId}/inter-site-forwarder/site-span-info",
		"",
		resultHeaders,
		200,
		"",
