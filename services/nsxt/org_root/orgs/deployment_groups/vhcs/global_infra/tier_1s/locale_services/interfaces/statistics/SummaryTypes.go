...
func summaryGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/interfaces/{interfaceId}/statistics/summary",
		"",
		resultHeaders,
		200,
		"",
