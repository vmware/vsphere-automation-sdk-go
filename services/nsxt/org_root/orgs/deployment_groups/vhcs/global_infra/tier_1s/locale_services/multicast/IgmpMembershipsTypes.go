...
func igmpMembershipsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/global-infra/tier-1s/{tier1Id}/locale-services/{localeServicesId}/multicast/igmp-memberships",
		"",
		resultHeaders,
		200,
		"",
