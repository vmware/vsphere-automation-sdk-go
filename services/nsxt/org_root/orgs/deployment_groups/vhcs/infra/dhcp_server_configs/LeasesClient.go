...
func NewLeasesClient(connector client.Connector) *leasesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.infra.dhcp_server_configs.leases")
...
func (lIface *leasesClient) List(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, configIdParam string, connectivityPathParam string, addressParam *string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, segmentPathParam *string, sortAscendingParam *bool, sortByParam *string, sourceParam *string) (model.DhcpLeasesResult, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.infra.dhcp_server_configs.leases", "list", inputDataValue, executionContext)
	var emptyOutput model.DhcpLeasesResult
