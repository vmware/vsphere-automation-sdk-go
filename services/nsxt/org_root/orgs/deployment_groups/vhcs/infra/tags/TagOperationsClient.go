...
func NewTagOperationsClient(connector client.Connector) *tagOperationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.infra.tags.tag_operations")
...
func (tIface *tagOperationsClient) Get(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, operationIdParam string) (model.TagBulkOperation, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.infra.tags.tag_operations", "get", inputDataValue, executionContext)
	var emptyOutput model.TagBulkOperation
...
func (tIface *tagOperationsClient) Update(orgIdParam string, deploymentGroupIdParam string, vhcIdParam string, operationIdParam string, tagBulkOperationParam model.TagBulkOperation) (model.TagBulkOperation, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.org_root.orgs.deployment_groups.vhcs.infra.tags.tag_operations", "update", inputDataValue, executionContext)
	var emptyOutput model.TagBulkOperation
	if methodResult.IsSuccess() {
