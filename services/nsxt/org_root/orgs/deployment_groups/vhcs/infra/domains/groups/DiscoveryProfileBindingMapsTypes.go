...
func discoveryProfileBindingMapsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/infra/domains/{domainId}/groups/{groupId}/discovery-profile-binding-maps/{discoveryProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func discoveryProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/infra/domains/{domainId}/groups/{groupId}/discovery-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
