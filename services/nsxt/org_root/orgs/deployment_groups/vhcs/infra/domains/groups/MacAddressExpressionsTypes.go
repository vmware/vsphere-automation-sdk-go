...
func macAddressExpressionsCreateRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"m_AC_address_list",
		"POST",
		"/policy/api/v1/org-root/orgs/{orgId}/deployment-groups/{deploymentGroupId}/vhcs/{vhcId}/infra/domains/{domainId}/groups/{groupId}/mac-address-expressions/{expressionId}",
		"",
		resultHeaders,
		204,
		"",
