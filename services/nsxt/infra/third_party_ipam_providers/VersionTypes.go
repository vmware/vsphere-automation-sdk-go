...
func VersionGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IpamThirdPartyProviderVersionBindingType)
}
...
func versionGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/third-party-ipam-providers/{providerInstanceId}/version",
		"",
		resultHeaders,
		200,
		"",
