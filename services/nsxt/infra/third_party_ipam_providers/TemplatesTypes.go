...
// Data type definitions file for service: Templates.
...
func templatesListInputType() vapiBindings_.StructType {
	...
	fields["template_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
...
func TemplatesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.SubnetTemplateListResultBindingType)
}

func templatesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["template_id"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/third-party-ipam-providers/{providerInstanceId}/templates",
		"",
		resultHeaders,
		200,
		"",
