...
// Data type definitions file for service: DnsViews.
...
func dnsViewsListInputType() vapiBindings_.StructType {
...
func DnsViewsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ViewInfoListResultBindingType)
}

func dnsViewsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/third-party-ipam-providers/{providerInstanceId}/dns-views",
		"",
		resultHeaders,
		200,
		"",
