...
func NewDataCollectionStatusClient(connector client.Connector) *dataCollectionStatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.intelligence.data_collection_status")
...
func (dIface *dataCollectionStatusClient) Get(siteIdParam string) (model.IntelligenceDataCollectionStatus, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.intelligence.data_collection_status", "get", inputDataValue, executionContext)
	var emptyOutput model.IntelligenceDataCollectionStatus
