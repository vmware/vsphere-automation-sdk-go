...
// Data type definitions file for service: Evacuate.
...
func evacuateCreateInputType() vapiBindings_.StructType {
...
func EvacuateCreateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func evacuateCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/virtual-network-appliance-clusters/{virtualNetworkApplianceClusterId}/virtual-network-appliances/{virtualNetworkApplianceId}/action/evacuate",
		"",
		resultHeaders,
		204,
		"",
