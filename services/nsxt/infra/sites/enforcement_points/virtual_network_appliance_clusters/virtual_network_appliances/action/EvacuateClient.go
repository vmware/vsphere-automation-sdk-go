...
func NewEvacuateClient(connector vapiProtocolClient_.Connector) *evacuateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.virtual_network_appliance_clusters.virtual_network_appliances.action.evacuate")
...
func (eIface *evacuateClient) Create(siteIdParam string, enforcementpointIdParam string, virtualNetworkApplianceClusterIdParam string, virtualNetworkApplianceIdParam string) error {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.virtual_network_appliance_clusters.virtual_network_appliances.action.evacuate", "create", inputDataValue, executionContext)
