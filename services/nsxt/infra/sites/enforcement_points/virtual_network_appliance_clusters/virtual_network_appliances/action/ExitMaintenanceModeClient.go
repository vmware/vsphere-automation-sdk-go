...
func NewExitMaintenanceModeClient(connector vapiProtocolClient_.Connector) *exitMaintenanceModeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.virtual_network_appliance_clusters.virtual_network_appliances.action.exit_maintenance_mode")
...
func (eIface *exitMaintenanceModeClient) Create(siteIdParam string, enforcementpointIdParam string, virtualNetworkApplianceClusterIdParam string, virtualNetworkApplianceIdParam string) error {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.virtual_network_appliance_clusters.virtual_network_appliances.action.exit_maintenance_mode", "create", inputDataValue, executionContext)
