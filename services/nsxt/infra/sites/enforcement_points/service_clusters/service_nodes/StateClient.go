...
type StateClient interface {
	...
	// The return value will contain all the properties defined in nsx_policyModel.PolicyServiceNodeState.
	//
...
func (sIface *stateClient) Get(siteIdParam string, enforcementpointIdParam string, serviceClusterIdParam string, serviceNodeIdParam string) (*vapiData_.StructValue, error) {
