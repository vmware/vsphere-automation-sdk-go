...
func NewExitMaintenanceModeClient(connector vapiProtocolClient_.Connector) *exitMaintenanceModeClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.service_clusters.service_nodes.action.exit_maintenance_mode")
...
func (eIface *exitMaintenanceModeClient) Create(siteIdParam string, enforcementpointIdParam string, serviceClusterIdParam string, serviceNodeIdParam string) error {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.service_clusters.service_nodes.action.exit_maintenance_mode", "create", inputDataValue, executionContext)
