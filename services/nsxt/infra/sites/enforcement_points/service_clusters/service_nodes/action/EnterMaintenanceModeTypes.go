...
func enterMaintenanceModeCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/service-clusters/{serviceClusterId}/service-nodes/{serviceNodeId}/action/enter-maintenance-mode",
		"",
		resultHeaders,
		204,
		"",
