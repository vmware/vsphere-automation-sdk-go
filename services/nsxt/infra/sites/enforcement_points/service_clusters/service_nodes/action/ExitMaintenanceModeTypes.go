...
func exitMaintenanceModeCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/service-clusters/{serviceClusterId}/service-nodes/{serviceNodeId}/action/exit-maintenance-mode",
		"",
		resultHeaders,
		204,
		"",
