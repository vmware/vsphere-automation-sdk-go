...
func advertisedRoutesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/edge-nodes/{policyEdgeNodeId}/remote-tep-connectivity/bgp/neighbors/{neighborId}/advertised-routes",
		"",
		resultHeaders,
		200,
		"",
