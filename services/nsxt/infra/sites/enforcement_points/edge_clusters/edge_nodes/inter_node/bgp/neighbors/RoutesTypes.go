...
func routesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/edge-nodes/{policyEdgeNodeId}/inter-node/bgp/neighbors/{neighborId}/routes",
		"",
		resultHeaders,
		200,
		"",
