...
func interfacesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/edge-transport-nodes/{nodeId}/lldp/interfaces/{interfaceName}",
		"",
		resultHeaders,
		200,
		"",
...
func interfacesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/edge-transport-nodes/{nodeId}/lldp/interfaces",
		"",
		resultHeaders,
		200,
		"",
