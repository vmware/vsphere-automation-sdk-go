...
type InterfacesClient interface {
	...
	// @param nodeIdParam ID of Edge Transport Node (required)
...
func NewInterfacesClient(connector vapiProtocolClient_.Connector) *interfacesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.edge_transport_nodes.lldp.interfaces")
...
func (iIface *interfacesClient) Get(siteIdParam string, enforcementPointIdParam string, nodeIdParam string, interfaceNameParam string) (nsx_policyModel.InterfaceNeighborProperties, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.edge_transport_nodes.lldp.interfaces", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.InterfaceNeighborProperties
...
func (iIface *interfacesClient) List(siteIdParam string, enforcementPointIdParam string, nodeIdParam string) (nsx_policyModel.InterfaceNeighborPropertyListResult, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.edge_transport_nodes.lldp.interfaces", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.InterfaceNeighborPropertyListResult
	if methodResult.IsSuccess() {
