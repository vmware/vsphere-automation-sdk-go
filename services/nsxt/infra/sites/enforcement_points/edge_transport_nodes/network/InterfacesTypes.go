...
func InterfacesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.NodeInterfacePropertiesListResultBindingType)
}
...
func interfacesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-transport-nodes/{edgeTransportNodeId}/network/interfaces",
		"",
		resultHeaders,
		200,
		"",
