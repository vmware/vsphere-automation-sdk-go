...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.edge_transport_nodes.network.interfaces.statistics")
...
func (sIface *statisticsClient) Get(siteIdParam string, enforcementpointIdParam string, edgeTransportNodeIdParam string, interfaceIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.NodeInterfaceStatisticsProperties, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.NodeInterfaceStatisticsProperties
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.edge_transport_nodes.network.interfaces.statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.NodeInterfaceStatisticsProperties
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.NodeInterfaceStatisticsProperties), nil
	} else {
