...
func StatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.NodeInterfaceStatisticsPropertiesBindingType)
}
...
func statisticsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-transport-nodes/{edgeTransportNodeId}/network/interfaces/{interfaceId}/statistics",
		"",
		resultHeaders,
		200,
		"",
