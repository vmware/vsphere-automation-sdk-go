...
func tunnelsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/edge-transport-nodes/{nodeId}/tunnels/{tunnelName}",
		"",
		resultHeaders,
		200,
		"",
...
func tunnelsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/edge-transport-nodes/{nodeId}/tunnels",
		"",
		resultHeaders,
		200,
		"",
