...
func NewDefaultDepolymentStateClient(connector client.Connector) *DefaultDepolymentStateClient {
	interfaceName := "com.vmware.nsx_policy.infra.sites.depolyment_state"
...
func (dIface *DefaultDepolymentStateClient) Get(siteIdParam string) (model.SiteDeploymentState, error) {
