...
type StateClient interface {
	...
	// @return com.vmware.nsx_policy.model.RouteControllerState
	//
	...
	Get(routeControllerIdParam string, sourceParam *string) (nsx_policyModel.RouteControllerState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.route_controllers.state")
...
func (sIface *stateClient) Get(routeControllerIdParam string, sourceParam *string) (nsx_policyModel.RouteControllerState, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.RouteControllerState
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.route_controllers.state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RouteControllerState
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.RouteControllerState), nil
	} else {
