...
func communityListsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/community-lists/{communityListId}",
		"",
		resultHeaders,
		204,
		"",
...
func communityListsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/community-lists",
		"",
		resultHeaders,
		200,
		"",
