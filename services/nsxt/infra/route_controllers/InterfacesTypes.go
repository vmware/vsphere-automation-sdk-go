...
func interfacesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/interfaces/{interfaceId}",
		"",
		resultHeaders,
		204,
		"",
...
func InterfacesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerInterfaceBindingType)
}
...
func InterfacesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerInterfaceListResultBindingType)
}
...
func interfacesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/interfaces",
		"",
		resultHeaders,
		200,
		"",
...
func interfacesPatchInputType() vapiBindings_.StructType {
	...
	fields["router_controller_id"] = vapiBindings_.NewStringType()
	fields["interface_id"] = vapiBindings_.NewStringType()
	fields["route_controller_interface"] = vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerInterfaceBindingType)
	fieldNameMap["router_controller_id"] = "RouterControllerId"
	fieldNameMap["interface_id"] = "InterfaceId"
	fieldNameMap["route_controller_interface"] = "RouteControllerInterface"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func interfacesPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["route_controller_interface"] = "RouteControllerInterface"
	paramsTypeMap["interface_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["route_controller_interface"] = vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerInterfaceBindingType)
	paramsTypeMap["router_controller_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["routerControllerId"] = vapiBindings_.NewStringType()
	paramsTypeMap["interfaceId"] = vapiBindings_.NewStringType()
	pathParams["interface_id"] = "interfaceId"
