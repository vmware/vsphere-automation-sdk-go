...
// Possible value for ``routeSource`` of method RoutingTable#get.
const RoutingTable_GET_ROUTE_SOURCE_BGP = "BGP"

func routingTableGetInputType() vapiBindings_.StructType {
...
func RoutingTableGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerRoutingTableListResultBindingType)
}

func routingTableGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/route-controllers/{routeControllerId}/routing-table",
		"",
		resultHeaders,
		200,
		"",
