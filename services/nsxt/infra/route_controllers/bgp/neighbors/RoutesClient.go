...
type RoutesClient interface {
	...
	// Returns routes learned by BGP neighbor from all virtual network appliance nodes on which this neighbor is currently enabled.
	//
...
func NewRoutesClient(connector vapiProtocolClient_.Connector) *routesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.route_controllers.bgp.neighbors.routes")
...
func (rIface *routesClient) List(routeControllerIdParam string, neighborIdParam string, countParam *int64, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, neighborAddressParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RouteControllerBgpNeighborRoutesListResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.route_controllers.bgp.neighbors.routes", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RouteControllerBgpNeighborRoutesListResult
