...
func (sIface *statusClient) List(routeControllerIdParam string, bgpNeighborTypeParam *string, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, statsTypeParam *string, transportNodeIdParam *string, virtualNetworkAppliancePathParam *string) (nsx_policyModel.RouteControllerBgpNeighborsStatusListResult, error) {
