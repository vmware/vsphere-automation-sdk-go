...
func routeMapsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/route-maps/{routeMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func RouteMapsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerRouteMapBindingType)
}
...
func RouteMapsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerRouteMapListResultBindingType)
}
...
func routeMapsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/route-controllers/{routerControllerId}/route-maps",
		"",
		resultHeaders,
		200,
		"",
...
func routeMapsPatchInputType() vapiBindings_.StructType {
	...
	fields["router_controller_id"] = vapiBindings_.NewStringType()
	fields["route_map_id"] = vapiBindings_.NewStringType()
	fields["route_controller_route_map"] = vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerRouteMapBindingType)
	fieldNameMap["router_controller_id"] = "RouterControllerId"
	fieldNameMap["route_map_id"] = "RouteMapId"
	fieldNameMap["route_controller_route_map"] = "RouteControllerRouteMap"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func routeMapsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["route_map_id"] = "RouteMapId"
	fieldNameMap["route_controller_route_map"] = "RouteControllerRouteMap"
	paramsTypeMap["route_controller_route_map"] = vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerRouteMapBindingType)
	paramsTypeMap["router_controller_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["route_map_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["routerControllerId"] = vapiBindings_.NewStringType()
	paramsTypeMap["routeMapId"] = vapiBindings_.NewStringType()
