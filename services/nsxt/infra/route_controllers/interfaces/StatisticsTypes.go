...
func StatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.RouteControllerInterfaceStatisticsBindingType)
}
...
func statisticsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/route-controllers/{routeControllerId}/interfaces/{interfaceId}/statistics",
		"",
		resultHeaders,
		200,
		"",
