...
type StatisticsClient interface {
	...
	Get(routeControllerIdParam string, interfaceIdParam string, bgpNeighborTypeParam *string, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, statsTypeParam *string, transportNodeIdParam *string, virtualNetworkAppliancePathParam *string) (nsx_policyModel.RouteControllerInterfaceStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.route_controllers.interfaces.statistics")
...
func (sIface *statisticsClient) Get(routeControllerIdParam string, interfaceIdParam string, bgpNeighborTypeParam *string, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, statsTypeParam *string, transportNodeIdParam *string, virtualNetworkAppliancePathParam *string) (nsx_policyModel.RouteControllerInterfaceStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.route_controllers.interfaces.statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RouteControllerInterfaceStatistics
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.RouteControllerInterfaceStatistics), nil
	} else {
