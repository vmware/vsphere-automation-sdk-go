...
type AllocationStateClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cidrParam *string, includeWorkloadDetailsParam *bool) (nsx_policyModel.IpAddressBlockAllocationStateList, error)
}
...
func (aIface *allocationStateClient) List(cidrParam *string, includeWorkloadDetailsParam *bool) (nsx_policyModel.IpAddressBlockAllocationStateList, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
