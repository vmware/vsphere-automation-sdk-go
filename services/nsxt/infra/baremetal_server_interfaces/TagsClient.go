...
type TagsClient interface {
	...
	Create(bareMetalServerInterfaceTagListParam nsx_policyModel.BareMetalServerInterfaceTagList) (nsx_policyModel.BareMetalServerInterfaceTagList, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.baremetal_server_interfaces.tags")
...
func (tIface *tagsClient) Create(bareMetalServerInterfaceTagListParam nsx_policyModel.BareMetalServerInterfaceTagList) (nsx_policyModel.BareMetalServerInterfaceTagList, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.baremetal_server_interfaces.tags", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.BareMetalServerInterfaceTagList
