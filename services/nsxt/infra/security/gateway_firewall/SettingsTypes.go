...
func SettingsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.GfwFirewallConfigurationBindingType)
}
...
func settingsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/security/gateway-firewall/settings",
		"",
		resultHeaders,
		200,
		"",
...
func settingsPatchInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["gfw_firewall_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.GfwFirewallConfigurationBindingType)
	fieldNameMap["gfw_firewall_configuration"] = "GfwFirewallConfiguration"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func settingsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fields["gfw_firewall_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.GfwFirewallConfigurationBindingType)
	fieldNameMap["gfw_firewall_configuration"] = "GfwFirewallConfiguration"
	paramsTypeMap["gfw_firewall_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.GfwFirewallConfigurationBindingType)
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		fields,
