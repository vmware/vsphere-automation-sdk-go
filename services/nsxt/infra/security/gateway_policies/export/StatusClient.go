...
type StatusClient interface {
	...
	Get(categoryParam *string, draftPathParam *string, scopePathParam *string) (nsx_policyModel.FirewallExportTask, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.security.gateway_policies.export.status")
...
func (sIface *statusClient) Get(categoryParam *string, draftPathParam *string, scopePathParam *string) (nsx_policyModel.FirewallExportTask, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.security.gateway_policies.export.status", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FirewallExportTask
