...
func NewAggregatedClient(connector vapiProtocolClient_.Connector) *aggregatedClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.security.gateway_policies.drafts.aggregated")
...
func (aIface *aggregatedClient) Get(draftIdParam string) (nsx_policyModel.Infra, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.security.gateway_policies.drafts.aggregated", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Infra
...
func (aIface *aggregatedClient) Get0(draftIdParam string, dependentTypeParam string, cursorParam *string, pageSizeParam *int64) (nsx_policyModel.DependentAggregatedList, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.security.gateway_policies.drafts.aggregated", "get_0", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DependentAggregatedList
	if methodResult.IsSuccess() {
