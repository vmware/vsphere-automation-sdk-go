...
const ClusterConfigs_LIST_FEATURE_TYPE_DFW = "HYPERVISOR_DFW"
...
func ClusterConfigsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ClusterHypervisorSecurityConfigurationBindingType)
}
...
func clusterConfigsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/settings/hypervisor-security/cluster-configs/{clusterExternalId}",
		"",
		resultHeaders,
		200,
		"",
...
func ClusterConfigsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ClusterHypervisorSecurityConfigurationListResultBindingType)
}
...
func clusterConfigsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/settings/hypervisor-security/cluster-configs",
		"",
		resultHeaders,
		200,
		"",
...
func clusterConfigsPatchInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["cluster_external_id"] = vapiBindings_.NewStringType()
	fields["cluster_hypervisor_security_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.ClusterHypervisorSecurityConfigurationBindingType)
	fieldNameMap["cluster_external_id"] = "ClusterExternalId"
	fieldNameMap["cluster_hypervisor_security_configuration"] = "ClusterHypervisorSecurityConfiguration"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func clusterConfigsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["cluster_hypervisor_security_configuration"] = "ClusterHypervisorSecurityConfiguration"
	paramsTypeMap["cluster_external_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["cluster_hypervisor_security_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.ClusterHypervisorSecurityConfigurationBindingType)
	paramsTypeMap["clusterExternalId"] = vapiBindings_.NewStringType()
	pathParams["cluster_external_id"] = "clusterExternalId"
	resultHeaders := map[string]string{}
	errorHeaders := map[string]map[string]string{}
	return vapiProtocol_.NewOperationRestMetadata(
		...
		bodyFieldsMap,
		"",
		"cluster_hypervisor_security_configuration",
		"PATCH",
		"/policy/api/v1/infra/settings/hypervisor-security/cluster-configs/{clusterExternalId}",
		"application/json",
		resultHeaders,
