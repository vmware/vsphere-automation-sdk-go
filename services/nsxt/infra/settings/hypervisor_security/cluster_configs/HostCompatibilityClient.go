...
type HostCompatibilityClient interface {
	...
	List(clusterExternalIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, statusParam *string) (nsx_policyModel.HostCompatibilityInfoListResult, error)
}
...
func (hIface *hostCompatibilityClient) List(clusterExternalIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, statusParam *string) (nsx_policyModel.HostCompatibilityInfoListResult, error) {
