...
type SignaturesClient interface {
	...
	Get(versionIdParam string, sigIdParam string) (nsx_policyModel.IdsSignature, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(versionIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsSignatureListResult, error)
}
...
func (sIface *signaturesClient) Get(versionIdParam string, sigIdParam string) (nsx_policyModel.IdsSignature, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.settings.firewall.security.intrusion_services.signature_versions.signatures", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsSignature
...
func (sIface *signaturesClient) List(versionIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsSignatureListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
