...
type FeatureExcludeListClient interface {
	...
	// Get list of members that are excluded from specific security features for security policies. This API provides fine-grained exclusion control, allowing you to exclude members from specific features like DISTRIBUTED_TLS_L7 or DISTRIBUTED_TLS_IDPS without excluding them from all Distributed Firewall security policies. This is different from /infra/settings/firewall/security/exclude-list which excludes members from all Distributed Firewall features.
	...
	// Patch the security feature exclude list to exclude specific members from particular security features for security polices. This API provides fine-grained exclusion control, allowing you to exclude members from specific features like DISTRIBUTED_TLS_L7 or DISTRIBUTED_TLS_IDPS without excluding them from all Distributed Firewall security policies. This is different from /infra/settings/firewall/security/exclude-list which excludes members from all Distributed Firewall features.
	//
	...
	// Update the security feature exclude list to exclude specific members from particular security features for security polices. This API provides fine-grained exclusion control, allowing you to exclude members from specific features like DISTRIBUTED_TLS_L7 or DISTRIBUTED_TLS_IDPS without excluding them from all Distributed Firewall security policies. This is different from /infra/settings/firewall/security/exclude-list which excludes members from all Distributed Firewall features.
	//
	// @param securityFeatureExcludeListParam (required)
	// @return com.vmware.nsx_policy.model.SecurityFeatureExcludeList
	//
