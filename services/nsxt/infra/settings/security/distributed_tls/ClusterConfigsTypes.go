...
func ClusterConfigsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DistributedTlsClusterConfigurationBindingType)
}
...
func clusterConfigsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/settings/security/distributed-tls/cluster-configs/{clusterExternalId}",
		"",
		resultHeaders,
		200,
		"",
...
func ClusterConfigsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DistributedTlsClusterConfigurationListResultBindingType)
}
...
func clusterConfigsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/settings/security/distributed-tls/cluster-configs",
		"",
		resultHeaders,
		200,
		"",
...
func clusterConfigsPatchInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["cluster_external_id"] = vapiBindings_.NewStringType()
	fields["distributed_tls_cluster_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.DistributedTlsClusterConfigurationBindingType)
	fieldNameMap["cluster_external_id"] = "ClusterExternalId"
	fieldNameMap["distributed_tls_cluster_configuration"] = "DistributedTlsClusterConfiguration"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func clusterConfigsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["cluster_external_id"] = "ClusterExternalId"
	fieldNameMap["distributed_tls_cluster_configuration"] = "DistributedTlsClusterConfiguration"
	paramsTypeMap["distributed_tls_cluster_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.DistributedTlsClusterConfigurationBindingType)
	paramsTypeMap["cluster_external_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["clusterExternalId"] = vapiBindings_.NewStringType()
	pathParams["cluster_external_id"] = "clusterExternalId"
	resultHeaders := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		bodyFieldsMap,
		"",
		"distributed_tls_cluster_configuration",
		"PATCH",
		"/policy/api/v1/infra/settings/security/distributed-tls/cluster-configs/{clusterExternalId}",
		"application/json",
		resultHeaders,
