...
type ClusterConfigsClient interface {
	...
	// @param featureTypeParam Feature for which security is to be to be enabled/disabled. For example: DFW Use any one of this to enable/disable it. (optional)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, enabledParam *bool, featureTypeParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ClusterSecurityConfigurationListResult, error)
