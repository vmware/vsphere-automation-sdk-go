...
type ClusterConfigsClient interface {
	...
	// @param featureTypeParam Feature for which security is to be to be enabled/disabled. DFW INFRA_SECURITY_DFW DTLS Use any one of this to enable/disable it. (optional)
