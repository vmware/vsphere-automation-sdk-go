...
type TagsClient interface {
	...
	Get(categoryIdParam string, tagIdParam string) (nsx_policyModel.TagDetails, error)

	// Returns a paginated list of all the existing tags for a given category/scope.
	//
	// @param categoryIdParam (required)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(categoryIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TagListResult, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.categories.tags")
...
func (tIface *tagsClient) Get(categoryIdParam string, tagIdParam string) (nsx_policyModel.TagDetails, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.categories.tags", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TagDetails
...
func (tIface *tagsClient) List(categoryIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TagListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.categories.tags", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TagListResult
	if methodResult.IsSuccess() {
