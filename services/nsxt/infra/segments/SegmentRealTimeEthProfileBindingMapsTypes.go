...
func segmentRealTimeEthProfileBindingMapsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/segments/{segmentId}/segment-real-time-eth-profile-binding-maps/{segmentRealTimeEthProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func segmentRealTimeEthProfileBindingMapsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/segments/{segmentId}/segment-real-time-eth-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
