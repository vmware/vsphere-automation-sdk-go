...
// Data type definitions file for service: DnsResolverStatus.
...
func dnsResolverStatusGetInputType() vapiBindings_.StructType {
...
func dnsResolverStatusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-0s/{tier0Id}/firewall/dns-resolver-status",
		"",
		resultHeaders,
		200,
		"",
