...
type StatisticsClient interface {
	...
	List(tier0IdParam string, natIdParam string, natRuleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.PolicyNatRuleStatisticsListResult, error)
}
...
func (sIface *statisticsClient) List(tier0IdParam string, natIdParam string, natRuleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.PolicyNatRuleStatisticsListResult, error) {
