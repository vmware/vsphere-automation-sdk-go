...
type FqdnsClient interface {
	...
	// Get TLS inspection FQDN state for tier0
	//
	...
	Get(tier0IdParam string, fqdnIdParam string) (nsx_policyModel.TlsStateObject, error)

	// TLS inspection execution state fqdn details for the tier0
	//
	// @param tier0IdParam (required)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(tier0IdParam string, cursorParam *string, failedDomainsParam *bool, fqdnParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsStateObjectListResult, error)
}
...
func NewFqdnsClient(connector vapiProtocolClient_.Connector) *fqdnsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.tls_inspection_state.fqdns")
...
func (fIface *fqdnsClient) Get(tier0IdParam string, fqdnIdParam string) (nsx_policyModel.TlsStateObject, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.tls_inspection_state.fqdns", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsStateObject
...
func (fIface *fqdnsClient) List(tier0IdParam string, cursorParam *string, failedDomainsParam *bool, fqdnParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsStateObjectListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.tls_inspection_state.fqdns", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsStateObjectListResult
	if methodResult.IsSuccess() {
