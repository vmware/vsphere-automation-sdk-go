...
type TlsInspectionStateClient interface {
	...
	// TLS inspection execution state details for the tier0
	//
...
func NewTlsInspectionStateClient(connector vapiProtocolClient_.Connector) *tlsInspectionStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.tls_inspection_state")
...
func (tIface *tlsInspectionStateClient) List(tier0IdParam string, cursorParam *string, failedDomainsParam *bool, fqdnParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsStateObjectListResult, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.tls_inspection_state", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsStateObjectListResult
