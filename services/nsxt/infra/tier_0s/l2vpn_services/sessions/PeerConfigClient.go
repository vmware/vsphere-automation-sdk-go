...
type PeerConfigClient interface {
	...
	Get(tier0IdParam string, serviceIdParam string, sessionIdParam string, backwardCompatibleParam *bool, enforcementPointPathParam *string) (nsx_policyModel.AggregateL2VPNSessionPeerConfig, error)
}
...
func (pIface *peerConfigClient) Get(tier0IdParam string, serviceIdParam string, sessionIdParam string, backwardCompatibleParam *bool, enforcementPointPathParam *string) (nsx_policyModel.AggregateL2VPNSessionPeerConfig, error) {
