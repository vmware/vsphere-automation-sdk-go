...
type DatabaseClient interface {
	...
	// @param areaIdParam OSPF area identifier either in decimal or dotted format. (optional)
	// @param cursorParam Opaque cursor to be used for getting next page of records (supplied by current result page) (optional)
	// @param edgePathParam Policy path of edge to retrieve neighbors. (optional)
