...
func ipfixCollectorProfilesPatchInputType() vapiBindings_.StructType {
	...
	fieldNameMap := make(map[string]string)
	fields["ipfix_collector_profile_id"] = vapiBindings_.NewStringType()
	fields["i_PFIX_flow_collector_profile"] = vapiBindings_.NewReferenceType(nsx_policyModel.IPFIXFlowCollectorProfileBindingType)
	fields["override"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	fieldNameMap["ipfix_collector_profile_id"] = "IpfixCollectorProfileId"
	fieldNameMap["i_PFIX_flow_collector_profile"] = "IPFIXFlowCollectorProfile"
	fieldNameMap["override"] = "Override"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func ipfixCollectorProfilesPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["i_PFIX_flow_collector_profile"] = "IPFIXFlowCollectorProfile"
	fieldNameMap["override"] = "Override"
	paramsTypeMap["i_PFIX_flow_collector_profile"] = vapiBindings_.NewReferenceType(nsx_policyModel.IPFIXFlowCollectorProfileBindingType)
	paramsTypeMap["ipfix_collector_profile_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["override"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	paramsTypeMap["ipfixCollectorProfileId"] = vapiBindings_.NewStringType()
	pathParams["ipfix_collector_profile_id"] = "ipfixCollectorProfileId"
