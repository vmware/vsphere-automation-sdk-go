...
type ReallocateClient interface {
	...
	Create(gatewayReallocationRequestParametersParam nsx_policyModel.GatewayReallocationRequestParameters) error
}
...
func NewReallocateClient(connector vapiProtocolClient_.Connector) *reallocateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.gateways.action.reallocate")
...
func (rIface *reallocateClient) Create(gatewayReallocationRequestParametersParam nsx_policyModel.GatewayReallocationRequestParameters) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.gateways.action.reallocate", "create", inputDataValue, executionContext)
