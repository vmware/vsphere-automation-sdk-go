...
type VirtualMachinesClient interface {
	...
	// @param dslParam It's human readable and context-based query language for retreiving information from search indices. For example: Find router where ip is 10.10.1.10 (optional)
