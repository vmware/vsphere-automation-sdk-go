...
type TagsClient interface {
	...
	Create(virtualMachineIdParam string, virtualMachineTagsUpdateParam nsx_policyModel.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error
}
