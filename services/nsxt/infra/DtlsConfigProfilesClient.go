...
type DtlsConfigProfilesClient interface {
	...
	Delete(dtlsConfigProfileIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(dtlsConfigProfileIdParam string) (nsx_policyModel.DtlsConfigProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DtlsConfigProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(dtlsConfigProfileIdParam string, dtlsConfigProfileParam nsx_policyModel.DtlsConfigProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(dtlsConfigProfileIdParam string, dtlsConfigProfileParam nsx_policyModel.DtlsConfigProfile) (nsx_policyModel.DtlsConfigProfile, error)
}
...
func NewDtlsConfigProfilesClient(connector vapiProtocolClient_.Connector) *dtlsConfigProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.dtls_config_profiles")
...
func (dIface *dtlsConfigProfilesClient) Delete(dtlsConfigProfileIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.dtls_config_profiles", "delete", inputDataValue, executionContext)
...
func (dIface *dtlsConfigProfilesClient) Get(dtlsConfigProfileIdParam string) (nsx_policyModel.DtlsConfigProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.dtls_config_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DtlsConfigProfile
	if methodResult.IsSuccess() {
...
func (dIface *dtlsConfigProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DtlsConfigProfileListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.dtls_config_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DtlsConfigProfileListResult
	if methodResult.IsSuccess() {
...
func (dIface *dtlsConfigProfilesClient) Patch(dtlsConfigProfileIdParam string, dtlsConfigProfileParam nsx_policyModel.DtlsConfigProfile) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.dtls_config_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dtlsConfigProfilesClient) Update(dtlsConfigProfileIdParam string, dtlsConfigProfileParam nsx_policyModel.DtlsConfigProfile) (nsx_policyModel.DtlsConfigProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.dtls_config_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DtlsConfigProfile
	if methodResult.IsSuccess() {
