...
type SecurityStrategiesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SecurityStrategyListResult, error)
}
...
func NewSecurityStrategiesClient(connector vapiProtocolClient_.Connector) *securityStrategiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.security_strategies")
...
func (sIface *securityStrategiesClient) Get(securityStrategyIdParam string) (nsx_policyModel.SecurityStrategy, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.security_strategies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityStrategy
...
func (sIface *securityStrategiesClient) List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SecurityStrategyListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.security_strategies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityStrategyListResult
	if methodResult.IsSuccess() {
