...
type RulesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(domainIdParam string, bridgeFirewallPolicyIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RuleListResult, error)
...
func NewRulesClient(connector vapiProtocolClient_.Connector) *rulesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.bridge_policies.rules")
...
func (rIface *rulesClient) Create(domainIdParam string, bridgeFirewallPolicyIdParam string, ruleIdParam string, ruleParam nsx_policyModel.Rule) (nsx_policyModel.Rule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Rule
...
func (rIface *rulesClient) Delete(domainIdParam string, bridgeFirewallPolicyIdParam string, ruleIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *rulesClient) Get(domainIdParam string, bridgeFirewallPolicyIdParam string, ruleIdParam string) (nsx_policyModel.Rule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Rule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) List(domainIdParam string, bridgeFirewallPolicyIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RuleListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RuleListResult
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Patch(domainIdParam string, bridgeFirewallPolicyIdParam string, ruleIdParam string, ruleParam nsx_policyModel.Rule) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *rulesClient) Update(domainIdParam string, bridgeFirewallPolicyIdParam string, ruleIdParam string, ruleParam nsx_policyModel.Rule) (nsx_policyModel.Rule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_policies.rules", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Rule
	if methodResult.IsSuccess() {
