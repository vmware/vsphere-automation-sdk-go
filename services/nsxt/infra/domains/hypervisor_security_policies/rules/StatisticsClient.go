...
type StatisticsClient interface {
	...
	// Get statistics for a hypervisor security rule.
	//
	...
	List(domainIdParam string, hypervisorSecurityPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.RuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.hypervisor_security_policies.rules.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, hypervisorSecurityPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.RuleStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.hypervisor_security_policies.rules.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RuleStatisticsListResult
