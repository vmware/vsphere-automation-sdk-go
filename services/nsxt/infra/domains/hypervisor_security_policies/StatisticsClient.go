...
type StatisticsClient interface {
	...
	// Get statistics for a hypervisor security policy.
	//
	...
	List(domainIdParam string, hypervisorSecurityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.hypervisor_security_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, hypervisorSecurityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.hypervisor_security_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityPolicyStatisticsListResult
