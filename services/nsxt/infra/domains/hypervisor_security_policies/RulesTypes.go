...
func rulesDeleteInputType() vapiBindings_.StructType {
	...
	fields["hypervisor_security_policy_id"] = vapiBindings_.NewStringType()
	fields["rule_id"] = vapiBindings_.NewStringType()
	fieldNameMap["domain_id"] = "DomainId"
	fieldNameMap["hypervisor_security_policy_id"] = "HypervisorSecurityPolicyId"
...
func rulesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["hypervisor_security_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["domainId"] = vapiBindings_.NewStringType()
	paramsTypeMap["hypervisorSecurityPolicyId"] = vapiBindings_.NewStringType()
	paramsTypeMap["ruleId"] = vapiBindings_.NewStringType()
	pathParams["hypervisor_security_policy_id"] = "hypervisorSecurityPolicyId"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/domains/{domainId}/hypervisor-security-policies/{hypervisorSecurityPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		204,
		"",
...
func RulesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.HypervisorSecurityRuleBindingType)
}
...
func rulesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/hypervisor-security-policies/{hypervisorSecurityPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
...
func rulesPatchInputType() vapiBindings_.StructType {
	...
	fields["hypervisor_security_policy_id"] = vapiBindings_.NewStringType()
	fields["rule_id"] = vapiBindings_.NewStringType()
	fields["hypervisor_security_rule"] = vapiBindings_.NewReferenceType(nsx_policyModel.HypervisorSecurityRuleBindingType)
	fieldNameMap["domain_id"] = "DomainId"
	fieldNameMap["hypervisor_security_policy_id"] = "HypervisorSecurityPolicyId"
	fieldNameMap["rule_id"] = "RuleId"
	fieldNameMap["hypervisor_security_rule"] = "HypervisorSecurityRule"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func rulesPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["domain_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["rule_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["hypervisor_security_rule"] = vapiBindings_.NewReferenceType(nsx_policyModel.HypervisorSecurityRuleBindingType)
	paramsTypeMap["hypervisor_security_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["domainId"] = vapiBindings_.NewStringType()
	paramsTypeMap["hypervisorSecurityPolicyId"] = vapiBindings_.NewStringType()
	paramsTypeMap["ruleId"] = vapiBindings_.NewStringType()
