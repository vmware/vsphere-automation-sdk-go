...
func NewVpcsClient(connector vapiProtocolClient_.Connector) *vpcsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.groups.members.vpcs")
...
func (vIface *vpcsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyGroupMembersListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.groups.members.vpcs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyGroupMembersListResult
