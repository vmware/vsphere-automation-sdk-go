...
func NewBmsiClient(connector vapiProtocolClient_.Connector) *bmsiClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.groups.members.bmsi")
...
func (bIface *bmsiClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.BareMetalServerInterfaceListResult, error) {
	...
	methodResult := bIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.groups.members.bmsi", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.BareMetalServerInterfaceListResult
