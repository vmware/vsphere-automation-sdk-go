...
func rulesDeleteInputType() vapiBindings_.StructType {
	...
	fields["infra_security_policy_id"] = vapiBindings_.NewStringType()
	fields["rule_id"] = vapiBindings_.NewStringType()
	fieldNameMap["domain_id"] = "DomainId"
	fieldNameMap["infra_security_policy_id"] = "InfraSecurityPolicyId"
...
func rulesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["infra_security_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["domainId"] = vapiBindings_.NewStringType()
	paramsTypeMap["infraSecurityPolicyId"] = vapiBindings_.NewStringType()
	paramsTypeMap["ruleId"] = vapiBindings_.NewStringType()
	pathParams["infra_security_policy_id"] = "infraSecurityPolicyId"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/domains/{domainId}/infra-security-policies/{infraSecurityPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		204,
		"",
...
func RulesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.InfraSecurityRuleBindingType)
}
...
func rulesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/infra-security-policies/{infraSecurityPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
...
func rulesPatchInputType() vapiBindings_.StructType {
	...
	fields["infra_security_policy_id"] = vapiBindings_.NewStringType()
	fields["rule_id"] = vapiBindings_.NewStringType()
	fields["infra_security_rule"] = vapiBindings_.NewReferenceType(nsx_policyModel.InfraSecurityRuleBindingType)
	fieldNameMap["domain_id"] = "DomainId"
	fieldNameMap["infra_security_policy_id"] = "InfraSecurityPolicyId"
	fieldNameMap["rule_id"] = "RuleId"
	fieldNameMap["infra_security_rule"] = "InfraSecurityRule"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func rulesPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["rule_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["infra_security_policy_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["infra_security_rule"] = vapiBindings_.NewReferenceType(nsx_policyModel.InfraSecurityRuleBindingType)
	paramsTypeMap["domainId"] = vapiBindings_.NewStringType()
	paramsTypeMap["infraSecurityPolicyId"] = vapiBindings_.NewStringType()
	paramsTypeMap["ruleId"] = vapiBindings_.NewStringType()
	pathParams["infra_security_policy_id"] = "infraSecurityPolicyId"
