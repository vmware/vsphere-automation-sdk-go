...
type PolicyProjectProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyProjectProfileListResult, error)
...
func NewPolicyProjectProfilesClient(connector vapiProtocolClient_.Connector) *policyProjectProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.policy_project_profiles")
...
func (pIface *policyProjectProfilesClient) Delete(policyProjectProfileIdParam string) error {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.policy_project_profiles", "delete", inputDataValue, executionContext)
...
func (pIface *policyProjectProfilesClient) Get(policyProjectProfileIdParam string) (nsx_policyModel.PolicyProjectProfile, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.policy_project_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyProjectProfile
	if methodResult.IsSuccess() {
...
func (pIface *policyProjectProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyProjectProfileListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.policy_project_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyProjectProfileListResult
	if methodResult.IsSuccess() {
...
func (pIface *policyProjectProfilesClient) Patch(policyProjectProfileIdParam string, policyProjectProfileParam nsx_policyModel.PolicyProjectProfile) error {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.policy_project_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), pIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (pIface *policyProjectProfilesClient) Update(policyProjectProfileIdParam string, policyProjectProfileParam nsx_policyModel.PolicyProjectProfile) (nsx_policyModel.PolicyProjectProfile, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.policy_project_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyProjectProfile
	if methodResult.IsSuccess() {
