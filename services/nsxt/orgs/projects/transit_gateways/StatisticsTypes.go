...
// Possible value for ``componentType`` of method Statistics#get.
const Statistics_GET_COMPONENT_TYPE_ROUTES = "DR_ROUTES"

// Possible value for ``routeSource`` of method Statistics#get.
const Statistics_GET_ROUTE_SOURCE_BGP = "BGP"

// Possible value for ``routeSource`` of method Statistics#get.
const Statistics_GET_ROUTE_SOURCE_STATIC = "STATIC"

// Possible value for ``routeSource`` of method Statistics#get.
const Statistics_GET_ROUTE_SOURCE_CONNECTED = "CONNECTED"

// Possible value for ``routeSource`` of method Statistics#get.
const Statistics_GET_ROUTE_SOURCE_OSPF = "OSPF"
