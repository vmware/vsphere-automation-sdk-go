...
func SecurityConfigGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewaySecurityFeaturesBindingType)
}
...
func securityConfigGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/security-config",
		"",
		resultHeaders,
		200,
		"",
...
func securityConfigPatchInputType() vapiBindings_.StructType {
	...
	fields["project_id"] = vapiBindings_.NewStringType()
	fields["transit_gateway_id"] = vapiBindings_.NewStringType()
	fields["transit_gateway_security_features"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewaySecurityFeaturesBindingType)
	fieldNameMap["org_id"] = "OrgId"
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["transit_gateway_id"] = "TransitGatewayId"
	fieldNameMap["transit_gateway_security_features"] = "TransitGatewaySecurityFeatures"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func securityConfigPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["project_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["transit_gateway_security_features"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewaySecurityFeaturesBindingType)
	paramsTypeMap["orgId"] = vapiBindings_.NewStringType()
	paramsTypeMap["projectId"] = vapiBindings_.NewStringType()
	paramsTypeMap["transitGatewayId"] = vapiBindings_.NewStringType()
	pathParams["transit_gateway_id"] = "transitGatewayId"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		bodyFieldsMap,
		"",
		"transit_gateway_security_features",
		"PATCH",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/security-config",
		"application/json",
		resultHeaders,
