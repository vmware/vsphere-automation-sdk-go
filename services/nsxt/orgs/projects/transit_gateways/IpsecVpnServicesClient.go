...
type IpsecVpnServicesClient interface {
	...
	// Delete IPSec VPN service under Transit Gateway.
	//
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnServiceListResult, error)

	// Create or patch IPSec VPN service under Transit Gateway.
	//
	// @param orgIdParam (required)
	// @param projectIdParam (required)
	// @param transitGatewayIdParam (required)
...
func NewIpsecVpnServicesClient(connector vapiProtocolClient_.Connector) *ipsecVpnServicesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services")
...
func (iIface *ipsecVpnServicesClient) Delete(orgIdParam string, projectIdParam string, transitGatewayIdParam string, ipsecVpnServiceIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnServicesClient) Get(orgIdParam string, projectIdParam string, transitGatewayIdParam string, ipsecVpnServiceIdParam string) (nsx_policyModel.IPSecVpnService, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnService
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnServicesClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IPSecVpnServiceListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnServiceListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnServicesClient) Patch(orgIdParam string, projectIdParam string, transitGatewayIdParam string, ipsecVpnServiceIdParam string, ipSecVpnServiceParam nsx_policyModel.IPSecVpnService) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnServicesClient) Update(orgIdParam string, projectIdParam string, transitGatewayIdParam string, ipsecVpnServiceIdParam string, ipSecVpnServiceParam nsx_policyModel.IPSecVpnService) (nsx_policyModel.IPSecVpnService, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IPSecVpnService
	if methodResult.IsSuccess() {
