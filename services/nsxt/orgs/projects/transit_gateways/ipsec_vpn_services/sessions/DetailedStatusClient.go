...
type DetailedStatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, transitGatewayIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateIPSecVpnSessionStatus, error)
}
...
func NewDetailedStatusClient(connector vapiProtocolClient_.Connector) *detailedStatusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services.sessions.detailed_status")
...
func (dIface *detailedStatusClient) Get(orgIdParam string, projectIdParam string, transitGatewayIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateIPSecVpnSessionStatus, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.ipsec_vpn_services.sessions.detailed_status", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AggregateIPSecVpnSessionStatus
