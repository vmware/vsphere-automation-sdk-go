...
func BgpGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayBgpRoutingConfigBindingType)
}
...
func bgpGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/routing/bgp",
		"",
		resultHeaders,
		200,
		"",
...
func bgpPatchInputType() vapiBindings_.StructType {
	...
	fields["project_id"] = vapiBindings_.NewStringType()
	fields["transit_gateway_id"] = vapiBindings_.NewStringType()
	fields["transit_gateway_bgp_routing_config"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayBgpRoutingConfigBindingType)
	fieldNameMap["org_id"] = "OrgId"
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["transit_gateway_id"] = "TransitGatewayId"
	fieldNameMap["transit_gateway_bgp_routing_config"] = "TransitGatewayBgpRoutingConfig"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func bgpPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["transit_gateway_bgp_routing_config"] = "TransitGatewayBgpRoutingConfig"
	paramsTypeMap["transit_gateway_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["transit_gateway_bgp_routing_config"] = vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayBgpRoutingConfigBindingType)
	paramsTypeMap["project_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["orgId"] = vapiBindings_.NewStringType()
	paramsTypeMap["projectId"] = vapiBindings_.NewStringType()
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		bodyFieldsMap,
		"",
		"transit_gateway_bgp_routing_config",
		"PATCH",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/routing/bgp",
		"application/json",
		resultHeaders,
