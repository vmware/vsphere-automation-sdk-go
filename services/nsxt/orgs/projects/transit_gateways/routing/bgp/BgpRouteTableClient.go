...
type BgpRouteTableClient interface {
	...
	// Returns the BGP routing table entries from the specified edge node for the given transit gateway. Edge_path must be specified to identify the target edge node.
	//
	...
	List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, edgePathParam string, cursorParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.BgpRIBListResult, error)
}
...
func NewBgpRouteTableClient(connector vapiProtocolClient_.Connector) *bgpRouteTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.bgp_route_table")
...
func (bIface *bgpRouteTableClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, edgePathParam string, cursorParam *string, includedFieldsParam *string, networkPrefixParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.BgpRIBListResult, error) {
	...
	methodResult := bIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.bgp_route_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.BgpRIBListResult
