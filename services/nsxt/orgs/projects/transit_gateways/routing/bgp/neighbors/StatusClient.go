...
type StatusClient interface {
	...
	// Returns the status of all the BGP neighbors for the given transit gateway.
	//
	...
	// @return com.vmware.nsx_policy.model.TransitGatewayBgpNeighborsStatusListResult
	//
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.neighbors.status")
...
func (sIface *statusClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, bgpNeighborTypeParam *string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_policyModel.TransitGatewayBgpNeighborsStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.TransitGatewayBgpNeighborsStatusListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.neighbors.status", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TransitGatewayBgpNeighborsStatusListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.TransitGatewayBgpNeighborsStatusListResult), nil
	} else {
