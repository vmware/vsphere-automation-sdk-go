...
// Possible value for ``bgpNeighborType`` of method Status#list.
const Status_LIST_BGP_NEIGHBOR_TYPE_INTER_EDGE_NODE = "INTER_EDGE_NODE"
...
func StatusListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayBgpNeighborsStatusListResultBindingType)
}
...
func statusListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/routing/bgp/neighbors/status",
		"",
		resultHeaders,
		200,
		"",
