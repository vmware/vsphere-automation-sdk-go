...
type RoutesClient interface {
	...
	// Returns routes learned by the BGP neighbor from all edge nodes on which this neighbor is currently enabled.
	//
...
func NewRoutesClient(connector vapiProtocolClient_.Connector) *routesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.neighbors.routes")
...
func (rIface *routesClient) List(orgIdParam string, projectIdParam string, transitGatewayIdParam string, neighborIdParam string, countParam *int64, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, neighborAddressParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.BgpNeighborRoutesListResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.transit_gateways.routing.bgp.neighbors.routes", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.BgpNeighborRoutesListResult
