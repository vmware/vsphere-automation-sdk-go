...
func InterfacesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.TransitGatewayAttachmentInterfaceStateListResultBindingType)
}
...
func interfacesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/transit-gateways/{transitGatewayId}/attachments/{attachmentId}/state/interfaces",
		"",
		resultHeaders,
		200,
		"",
