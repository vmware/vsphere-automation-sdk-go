...
type SecurityStrategiesClient interface {
	...
	// Get security strategy with the specified identifier. Security Strategies gets created under the default project and are auto shared with all other projects. Security profiles will consume these security strategies. Currently this API will return only the system generated security strategies under the default project.
	//
	...
	// Paginated list of SecurityStrategies. The security strategies are pre-created at the system initialization. It gets created under the default project and are auto shared with all the projects to be consumed in security profile.
	//
	// @param orgIdParam (required)
	// @param projectIdParam (required)
