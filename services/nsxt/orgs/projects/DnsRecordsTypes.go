...
// Data type definitions file for service: DnsRecords.
...
func dnsRecordsDeleteInputType() vapiBindings_.StructType {
...
func DnsRecordsDeleteOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func dnsRecordsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["dnsRecordId"] = vapiBindings_.NewStringType()
	pathParams["dns_record_id"] = "dnsRecordId"
...
func dnsRecordsGetInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
...
func dnsRecordsListInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
...
func dnsRecordsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["zone_path"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	queryParams["zone_path"] = "zone_path"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/dns-records",
		"",
		resultHeaders,
		200,
		"",
...
func dnsRecordsPatchInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
...
func DnsRecordsPatchOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func dnsRecordsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
...
func dnsRecordsUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
