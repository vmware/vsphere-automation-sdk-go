...
type DistributedTlsConfigProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string) (nsx_policyModel.DistributedTlsConfigProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DistributedTlsConfigProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string, distributedTlsConfigProfileParam nsx_policyModel.DistributedTlsConfigProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string, distributedTlsConfigProfileParam nsx_policyModel.DistributedTlsConfigProfile) (nsx_policyModel.DistributedTlsConfigProfile, error)
}
...
func NewDistributedTlsConfigProfilesClient(connector vapiProtocolClient_.Connector) *distributedTlsConfigProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles")
...
func (dIface *distributedTlsConfigProfilesClient) Delete(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles", "delete", inputDataValue, executionContext)
...
func (dIface *distributedTlsConfigProfilesClient) Get(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string) (nsx_policyModel.DistributedTlsConfigProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsConfigProfile
	if methodResult.IsSuccess() {
...
func (dIface *distributedTlsConfigProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DistributedTlsConfigProfileListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsConfigProfileListResult
	if methodResult.IsSuccess() {
...
func (dIface *distributedTlsConfigProfilesClient) Patch(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string, distributedTlsConfigProfileParam nsx_policyModel.DistributedTlsConfigProfile) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *distributedTlsConfigProfilesClient) Update(orgIdParam string, projectIdParam string, distributedTlsConfigProfileIdParam string, distributedTlsConfigProfileParam nsx_policyModel.DistributedTlsConfigProfile) (nsx_policyModel.DistributedTlsConfigProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_config_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsConfigProfile
	if methodResult.IsSuccess() {
