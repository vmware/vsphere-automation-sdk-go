...
func tlsInspectionActionProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tls-inspection-action-profiles/{actionProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func tlsInspectionActionProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tls-inspection-action-profiles",
		"",
		resultHeaders,
		200,
		"",
