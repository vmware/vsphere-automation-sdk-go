...
func (eIface *effectiveResourcesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, filterByParam *string, filterTextParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error) {
