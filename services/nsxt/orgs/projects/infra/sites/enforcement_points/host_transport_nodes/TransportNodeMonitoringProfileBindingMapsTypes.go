...
func transportNodeMonitoringProfileBindingMapsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/host-transport-nodes/{hostTransportNodeId}/transport-node-monitoring-profile-binding-maps/{bindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func transportNodeMonitoringProfileBindingMapsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/host-transport-nodes/{hostTransportNodeId}/transport-node-monitoring-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
