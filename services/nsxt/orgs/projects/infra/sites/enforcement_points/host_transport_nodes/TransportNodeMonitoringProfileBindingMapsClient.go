...
type TransportNodeMonitoringProfileBindingMapsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string) (nsx_policyModel.TransportNodeMonitoringProfileBindingMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TransportNodeMonitoringProfileBindingMapListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string, transportNodeMonitoringProfileBindingMapParam nsx_policyModel.TransportNodeMonitoringProfileBindingMap) error
...
func NewTransportNodeMonitoringProfileBindingMapsClient(connector vapiProtocolClient_.Connector) *transportNodeMonitoringProfileBindingMapsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps")
...
func (tIface *transportNodeMonitoringProfileBindingMapsClient) Delete(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps", "delete", inputDataValue, executionContext)
...
func (tIface *transportNodeMonitoringProfileBindingMapsClient) Get(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string) (nsx_policyModel.TransportNodeMonitoringProfileBindingMap, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TransportNodeMonitoringProfileBindingMap
	if methodResult.IsSuccess() {
...
func (tIface *transportNodeMonitoringProfileBindingMapsClient) List(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TransportNodeMonitoringProfileBindingMapListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TransportNodeMonitoringProfileBindingMapListResult
	if methodResult.IsSuccess() {
...
func (tIface *transportNodeMonitoringProfileBindingMapsClient) Patch(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string, transportNodeMonitoringProfileBindingMapParam nsx_policyModel.TransportNodeMonitoringProfileBindingMap) error {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), tIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (tIface *transportNodeMonitoringProfileBindingMapsClient) Update(orgIdParam string, projectIdParam string, siteIdParam string, enforcementPointIdParam string, hostTransportNodeIdParam string, bindingMapIdParam string, transportNodeMonitoringProfileBindingMapParam nsx_policyModel.TransportNodeMonitoringProfileBindingMap) (nsx_policyModel.TransportNodeMonitoringProfileBindingMap, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.sites.enforcement_points.host_transport_nodes.transport_node_monitoring_profile_binding_maps", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TransportNodeMonitoringProfileBindingMap
	if methodResult.IsSuccess() {
