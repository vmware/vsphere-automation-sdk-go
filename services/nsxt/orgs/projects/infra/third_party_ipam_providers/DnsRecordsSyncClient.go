...
type DnsRecordsSyncClient interface {
	...
	Create(orgIdParam string, projectIdParam string, providerInstanceIdParam string) (nsx_policyModel.ThirdPartySyncStatusForDns, error)
}
...
func NewDnsRecordsSyncClient(connector vapiProtocolClient_.Connector) *dnsRecordsSyncClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.third_party_ipam_providers.dns_records_sync")
...
func (dIface *dnsRecordsSyncClient) Create(orgIdParam string, projectIdParam string, providerInstanceIdParam string) (nsx_policyModel.ThirdPartySyncStatusForDns, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.third_party_ipam_providers.dns_records_sync", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.ThirdPartySyncStatusForDns
