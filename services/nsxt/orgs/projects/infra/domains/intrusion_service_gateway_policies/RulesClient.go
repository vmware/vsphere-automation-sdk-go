...
type RulesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsRuleListResult, error)
...
func NewRulesClient(connector vapiProtocolClient_.Connector) *rulesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules")
...
func (rIface *rulesClient) Delete(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, ruleIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "delete", inputDataValue, executionContext)
...
func (rIface *rulesClient) Get(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, ruleIdParam string) (nsx_policyModel.IdsRule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) List(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsRuleListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
	executionContext := rIface.connector.NewExecutionContext()
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsRuleListResult
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Patch(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam nsx_policyModel.IdsRule) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *rulesClient) Revise(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam nsx_policyModel.IdsRule, anchorPathParam *string, operationParam *string) (nsx_policyModel.IdsRule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "revise", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Update(orgIdParam string, projectIdParam string, domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam nsx_policyModel.IdsRule) (nsx_policyModel.IdsRule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.intrusion_service_gateway_policies.rules", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsRule
	if methodResult.IsSuccess() {
