...
func intrusionServiceGatewayPoliciesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/intrusion-service-gateway-policies/{policyId}",
		"",
		resultHeaders,
		204,
		"",
...
func intrusionServiceGatewayPoliciesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/intrusion-service-gateway-policies",
		"",
		resultHeaders,
		200,
		"",
