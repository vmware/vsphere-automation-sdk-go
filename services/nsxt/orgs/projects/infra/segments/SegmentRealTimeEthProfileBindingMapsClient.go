...
func (sIface *segmentRealTimeEthProfileBindingMapsClient) Delete(orgIdParam string, projectIdParam string, segmentIdParam string, segmentRealTimeEthProfileBindingMapIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_real_time_eth_profile_binding_maps", "delete", inputDataValue, executionContext)
...
func (sIface *segmentRealTimeEthProfileBindingMapsClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, segmentRealTimeEthProfileBindingMapIdParam string) (nsx_policyModel.SegmentRealTimeEthProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_real_time_eth_profile_binding_maps", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentRealTimeEthProfileBindingMap
	if methodResult.IsSuccess() {
...
func (sIface *segmentRealTimeEthProfileBindingMapsClient) List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.SegmentRealTimeEthProfileBindingMapListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_real_time_eth_profile_binding_maps", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentRealTimeEthProfileBindingMapListResult
	if methodResult.IsSuccess() {
...
func (sIface *segmentRealTimeEthProfileBindingMapsClient) Patch(orgIdParam string, projectIdParam string, segmentIdParam string, segmentRealTimeEthProfileBindingMapIdParam string, segmentRealTimeEthProfileBindingMapParam nsx_policyModel.SegmentRealTimeEthProfileBindingMap) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_real_time_eth_profile_binding_maps", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *segmentRealTimeEthProfileBindingMapsClient) Update(orgIdParam string, projectIdParam string, segmentIdParam string, segmentRealTimeEthProfileBindingMapIdParam string, segmentRealTimeEthProfileBindingMapParam nsx_policyModel.SegmentRealTimeEthProfileBindingMap) (nsx_policyModel.SegmentRealTimeEthProfileBindingMap, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.segment_real_time_eth_profile_binding_maps", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SegmentRealTimeEthProfileBindingMap
	if methodResult.IsSuccess() {
