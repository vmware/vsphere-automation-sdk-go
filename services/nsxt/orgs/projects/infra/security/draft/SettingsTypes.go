...
func SettingsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.SecurityDraftConfigurationBindingType)
}
...
func settingsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/security/draft/settings",
		"",
		resultHeaders,
		200,
		"",
...
func settingsPatchInputType() vapiBindings_.StructType {
	...
	fields["org_id"] = vapiBindings_.NewStringType()
	fields["project_id"] = vapiBindings_.NewStringType()
	fields["security_draft_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.SecurityDraftConfigurationBindingType)
	fieldNameMap["org_id"] = "OrgId"
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["security_draft_configuration"] = "SecurityDraftConfiguration"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func settingsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["security_draft_configuration"] = "SecurityDraftConfiguration"
	paramsTypeMap["security_draft_configuration"] = vapiBindings_.NewReferenceType(nsx_policyModel.SecurityDraftConfigurationBindingType)
	paramsTypeMap["project_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["orgId"] = vapiBindings_.NewStringType()
	paramsTypeMap["projectId"] = vapiBindings_.NewStringType()
