...
type ExportClient interface {
	...
	Create(orgIdParam string, projectIdParam string, gatewayFirewallExportRequestParam nsx_policyModel.GatewayFirewallExportRequest) (nsx_policyModel.FirewallExportTask, error)
}
...
func NewExportClient(connector vapiProtocolClient_.Connector) *exportClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.export")
...
func (eIface *exportClient) Create(orgIdParam string, projectIdParam string, gatewayFirewallExportRequestParam nsx_policyModel.GatewayFirewallExportRequest) (nsx_policyModel.FirewallExportTask, error) {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.export", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FirewallExportTask
