...
func aggregatedGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/security/gateway-policies/drafts/{draftId}/aggregated",
		"",
		resultHeaders,
		200,
		"",
...
func aggregatedGet0RestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/security/gateway-policies/drafts/{draftId}/aggregated/{dependentType}",
		"",
		resultHeaders,
		200,
		"",
