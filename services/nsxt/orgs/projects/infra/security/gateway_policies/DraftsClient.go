...
type DraftsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, draftIdParam string) (nsx_policyModel.PolicyGatewayDraft, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, draftTypeParam *string, gatewayPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyGatewayDraftListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, draftIdParam string, policyGatewayDraftParam nsx_policyModel.PolicyGatewayDraft) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, draftIdParam string, policyGatewayDraftParam nsx_policyModel.PolicyGatewayDraft) (nsx_policyModel.PolicyGatewayDraft, error)
}
...
func NewDraftsClient(connector vapiProtocolClient_.Connector) *draftsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts")
...
func (dIface *draftsClient) Delete(orgIdParam string, projectIdParam string, draftIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts", "delete", inputDataValue, executionContext)
...
func (dIface *draftsClient) Get(orgIdParam string, projectIdParam string, draftIdParam string) (nsx_policyModel.PolicyGatewayDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyGatewayDraft
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, draftTypeParam *string, gatewayPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyGatewayDraftListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyGatewayDraftListResult
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) Patch(orgIdParam string, projectIdParam string, draftIdParam string, policyGatewayDraftParam nsx_policyModel.PolicyGatewayDraft) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *draftsClient) Update(orgIdParam string, projectIdParam string, draftIdParam string, policyGatewayDraftParam nsx_policyModel.PolicyGatewayDraft) (nsx_policyModel.PolicyGatewayDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.drafts", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyGatewayDraft
	if methodResult.IsSuccess() {
