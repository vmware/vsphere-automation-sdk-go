...
// Possible value for ``category`` of method Cancel#create.
const Cancel_CREATE_CATEGORY_SHARED = "SHARED"

// Possible value for ``category`` of method Cancel#create.
const Cancel_CREATE_CATEGORY_ALL_LOCAL = "ALL_LOCAL"

// Possible value for ``category`` of method Cancel#create.
const Cancel_CREATE_CATEGORY_LOCAL = "LOCAL"
...
func cancelCreateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/security/gateway-policies/export/cancel",
		"",
		resultHeaders,
		201,
		"",
