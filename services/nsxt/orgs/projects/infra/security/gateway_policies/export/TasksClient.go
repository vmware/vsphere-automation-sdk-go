...
type TasksClient interface {
	...
	Create(orgIdParam string, projectIdParam string, gatewayFirewallExportTaskFilterParam nsx_policyModel.GatewayFirewallExportTaskFilter, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.FirewallExportListResult, error)
}
...
func NewTasksClient(connector vapiProtocolClient_.Connector) *tasksClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.export.tasks")
...
func (tIface *tasksClient) Create(orgIdParam string, projectIdParam string, gatewayFirewallExportTaskFilterParam nsx_policyModel.GatewayFirewallExportTaskFilter, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.FirewallExportListResult, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.security.gateway_policies.export.tasks", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FirewallExportListResult
