...
// Possible value for ``category`` of method Status#get.
const Status_GET_CATEGORY_SHARED = "SHARED"

// Possible value for ``category`` of method Status#get.
const Status_GET_CATEGORY_ALL_LOCAL = "ALL_LOCAL"

// Possible value for ``category`` of method Status#get.
const Status_GET_CATEGORY_LOCAL = "LOCAL"
...
func statusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/security/gateway-policies/export/status",
		"",
		resultHeaders,
		200,
		"",
