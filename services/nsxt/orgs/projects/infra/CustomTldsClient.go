...
type CustomTldsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, idParam string, forceParam *bool, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, idParam string) (nsx_policyModel.PolicyCustomTld, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, hasUnsupportedAppIdsParam *bool, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCustomTldListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, idParam string, policyCustomTldParam nsx_policyModel.PolicyCustomTld, forceParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, idParam string, policyCustomTldParam nsx_policyModel.PolicyCustomTld, forceParam *bool) (nsx_policyModel.PolicyCustomTld, error)
}
...
func NewCustomTldsClient(connector vapiProtocolClient_.Connector) *customTldsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds")
...
func (cIface *customTldsClient) Delete(orgIdParam string, projectIdParam string, idParam string, forceParam *bool, overrideParam *bool) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds", "delete", inputDataValue, executionContext)
...
func (cIface *customTldsClient) Get(orgIdParam string, projectIdParam string, idParam string) (nsx_policyModel.PolicyCustomTld, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyCustomTld
	if methodResult.IsSuccess() {
...
func (cIface *customTldsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, hasUnsupportedAppIdsParam *bool, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCustomTldListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyCustomTldListResult
	if methodResult.IsSuccess() {
...
func (cIface *customTldsClient) Patch(orgIdParam string, projectIdParam string, idParam string, policyCustomTldParam nsx_policyModel.PolicyCustomTld, forceParam *bool) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *customTldsClient) Update(orgIdParam string, projectIdParam string, idParam string, policyCustomTldParam nsx_policyModel.PolicyCustomTld, forceParam *bool) (nsx_policyModel.PolicyCustomTld, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.custom_tlds", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyCustomTld
	if methodResult.IsSuccess() {
