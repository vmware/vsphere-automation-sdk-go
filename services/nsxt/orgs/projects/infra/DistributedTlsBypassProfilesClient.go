...
type DistributedTlsBypassProfilesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string) (nsx_policyModel.DistributedTlsBypassProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DistributedTlsBypassProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string, distributedTlsBypassProfileParam nsx_policyModel.DistributedTlsBypassProfile) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string, distributedTlsBypassProfileParam nsx_policyModel.DistributedTlsBypassProfile) (nsx_policyModel.DistributedTlsBypassProfile, error)
}
...
func NewDistributedTlsBypassProfilesClient(connector vapiProtocolClient_.Connector) *distributedTlsBypassProfilesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles")
...
func (dIface *distributedTlsBypassProfilesClient) Delete(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles", "delete", inputDataValue, executionContext)
...
func (dIface *distributedTlsBypassProfilesClient) Get(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string) (nsx_policyModel.DistributedTlsBypassProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsBypassProfile
	if methodResult.IsSuccess() {
...
func (dIface *distributedTlsBypassProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DistributedTlsBypassProfileListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsBypassProfileListResult
	if methodResult.IsSuccess() {
...
func (dIface *distributedTlsBypassProfilesClient) Patch(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string, distributedTlsBypassProfileParam nsx_policyModel.DistributedTlsBypassProfile) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *distributedTlsBypassProfilesClient) Update(orgIdParam string, projectIdParam string, distributedTlsBypassProfileIdParam string, distributedTlsBypassProfileParam nsx_policyModel.DistributedTlsBypassProfile) (nsx_policyModel.DistributedTlsBypassProfile, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.distributed_tls_bypass_profiles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DistributedTlsBypassProfile
	if methodResult.IsSuccess() {
