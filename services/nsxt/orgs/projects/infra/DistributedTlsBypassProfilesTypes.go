...
func distributedTlsBypassProfilesDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/distributed-tls-bypass-profiles/{distributedTlsBypassProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func distributedTlsBypassProfilesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/distributed-tls-bypass-profiles",
		"",
		resultHeaders,
		200,
		"",
