...
type SecurityConfigClient interface {
	...
	// @param featureParam Feature to be activated/deactivated. GFW - Gateway Firewall IDFW - Identity Firewall IDPS - Intrusion Detection System TLS - Transport Layer Security Inspection MALWAREPREVENTION - Malware Prevention GFW_MULTICAST - Multicast on GFW GEOIP_MONITORING - Geo IP Monitoring Use any one of this to enable/disable it. (optional)
