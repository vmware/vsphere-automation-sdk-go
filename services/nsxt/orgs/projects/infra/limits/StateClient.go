...
type StateClient interface {
	...
	List(orgIdParam string, projectIdParam string) (nsx_policyModel.LimitStateListResult, error)
}
...
func (sIface *stateClient) List(orgIdParam string, projectIdParam string) (nsx_policyModel.LimitStateListResult, error) {
