...
type LivetracesClient interface {
	...
	// @param actionParam Action required to be performed on intent (optional)
	...
	Create(orgIdParam string, projectIdParam string, livetraceIdParam string, actionParam *string) (nsx_policyModel.LiveTraceConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string) (nsx_policyModel.LiveTraceConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LiveTraceConfigListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, livetraceIdParam string, liveTraceConfigParam nsx_policyModel.LiveTraceConfig) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, livetraceIdParam string, liveTraceConfigParam nsx_policyModel.LiveTraceConfig) (nsx_policyModel.LiveTraceConfig, error)
}
...
func NewLivetracesClient(connector vapiProtocolClient_.Connector) *livetracesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces")
...
func (lIface *livetracesClient) Create(orgIdParam string, projectIdParam string, livetraceIdParam string, actionParam *string) (nsx_policyModel.LiveTraceConfig, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.livetraces", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LiveTraceConfig
...
func (lIface *livetracesClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string) (nsx_policyModel.LiveTraceConfig, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *livetracesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LiveTraceConfigListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *livetracesClient) Patch(orgIdParam string, projectIdParam string, livetraceIdParam string, liveTraceConfigParam nsx_policyModel.LiveTraceConfig) error {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
...
func (lIface *livetracesClient) Update(orgIdParam string, projectIdParam string, livetraceIdParam string, liveTraceConfigParam nsx_policyModel.LiveTraceConfig) (nsx_policyModel.LiveTraceConfig, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
