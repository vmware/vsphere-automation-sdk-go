...
type CabundlesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, cabundleIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, cabundleIdParam string) (nsx_policyModel.CaBundle, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, fmtParam *string, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.CaBundleListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, cabundleIdParam string, caBundleParam nsx_policyModel.CaBundle) (nsx_policyModel.CaBundle, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, cabundleIdParam string, caBundleParam nsx_policyModel.CaBundle) (nsx_policyModel.CaBundle, error)
}
...
func NewCabundlesClient(connector vapiProtocolClient_.Connector) *cabundlesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.cabundles")
...
func (cIface *cabundlesClient) Delete(orgIdParam string, projectIdParam string, cabundleIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.cabundles", "delete", inputDataValue, executionContext)
...
func (cIface *cabundlesClient) Get(orgIdParam string, projectIdParam string, cabundleIdParam string) (nsx_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.cabundles", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CaBundle
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, detailsParam *bool, fmtParam *string, includedFieldsParam *string, nodeIdParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (nsx_policyModel.CaBundleListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.cabundles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CaBundleListResult
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) Patch(orgIdParam string, projectIdParam string, cabundleIdParam string, caBundleParam nsx_policyModel.CaBundle) (nsx_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.cabundles", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CaBundle
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) Update(orgIdParam string, projectIdParam string, cabundleIdParam string, caBundleParam nsx_policyModel.CaBundle) (nsx_policyModel.CaBundle, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.cabundles", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CaBundle
	if methodResult.IsSuccess() {
