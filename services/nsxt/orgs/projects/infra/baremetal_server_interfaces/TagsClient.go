...
type TagsClient interface {
	...
	// @param bareMetalServerInterfaceTagListParam (required)
	// @return com.vmware.nsx_policy.model.BareMetalServerInterfaceTagList
	//
	...
	Create(orgIdParam string, projectIdParam string, bareMetalServerInterfaceTagListParam nsx_policyModel.BareMetalServerInterfaceTagList) (nsx_policyModel.BareMetalServerInterfaceTagList, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.baremetal_server_interfaces.tags")
...
func (tIface *tagsClient) Create(orgIdParam string, projectIdParam string, bareMetalServerInterfaceTagListParam nsx_policyModel.BareMetalServerInterfaceTagList) (nsx_policyModel.BareMetalServerInterfaceTagList, error) {
	...
	sv.AddStructField("BareMetalServerInterfaceTagList", bareMetalServerInterfaceTagListParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_policyModel.BareMetalServerInterfaceTagList
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.baremetal_server_interfaces.tags", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.BareMetalServerInterfaceTagList
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.BareMetalServerInterfaceTagList), nil
	} else {
