...
func NewBlockedEventsClient(connector vapiProtocolClient_.Connector) *blockedEventsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.geo_ip.blocked_events")
...
func (bIface *blockedEventsClient) Get(orgIdParam string, projectIdParam string, cursorParam *string, destinationCountryCodeParam *string, destinationIpAddressParam *string, directionParam *string, includeAllProjectsParam *bool, pageSizeParam *int64, ruleIdParam *string, sourceCountryCodeParam *string, sourceIpAddressParam *string) (nsx_policyModel.GeoIpBlockedEventsList, error) {
	...
	methodResult := bIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.geo_ip.blocked_events", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.GeoIpBlockedEventsList
