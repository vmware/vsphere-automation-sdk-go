...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.LiveTraceStatus, error)
}
...
func NewStatusClient(connector vapiProtocolClient_.Connector) *statusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.LiveTraceStatus, error) {
