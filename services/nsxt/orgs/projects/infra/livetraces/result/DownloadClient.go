...
type DownloadClient interface {
	...
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string, actionParam *string) (nsx_policyModel.LiveTraceResult, error)
}
...
func NewDownloadClient(connector vapiProtocolClient_.Connector) *downloadClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.result.download")
...
func (dIface *downloadClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string, actionParam *string) (nsx_policyModel.LiveTraceResult, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.livetraces.result.download", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LiveTraceResult
