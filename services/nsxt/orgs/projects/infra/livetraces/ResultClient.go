...
type ResultClient interface {
	...
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.LiveTraceResult, error)
}
...
func NewResultClient(connector vapiProtocolClient_.Connector) *resultClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.result")
...
func (rIface *resultClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (nsx_policyModel.LiveTraceResult, error) {
