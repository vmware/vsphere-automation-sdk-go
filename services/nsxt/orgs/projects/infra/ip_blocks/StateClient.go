...
type StateClient interface {
	...
	// @return com.vmware.nsx_policy.model.IpAddressBlockState
	//
	...
	Get(orgIdParam string, projectIdParam string, intentPathParam string) (nsx_policyModel.IpAddressBlockState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.state")
...
func (sIface *stateClient) Get(orgIdParam string, projectIdParam string, intentPathParam string) (nsx_policyModel.IpAddressBlockState, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.IpAddressBlockState
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockState
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.IpAddressBlockState), nil
	} else {
