...
type AllocationStateClient interface {
	...
	Get(orgIdParam string, projectIdParam string, ipBlockIdParam string, cidrParam *string, includeWorkloadDetailsParam *bool) (nsx_policyModel.IpAddressBlockAllocationState, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cidrParam *string, cursorParam *string, includeWorkloadDetailsParam *bool, includedFieldsParam *string, ipAddressBlockPathParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IpAddressBlockAllocationStateList, error)
}
...
func NewAllocationStateClient(connector vapiProtocolClient_.Connector) *allocationStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.allocation_state")
...
func (aIface *allocationStateClient) Get(orgIdParam string, projectIdParam string, ipBlockIdParam string, cidrParam *string, includeWorkloadDetailsParam *bool) (nsx_policyModel.IpAddressBlockAllocationState, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.allocation_state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockAllocationState
...
func (aIface *allocationStateClient) List(orgIdParam string, projectIdParam string, cidrParam *string, cursorParam *string, includeWorkloadDetailsParam *bool, includedFieldsParam *string, ipAddressBlockPathParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IpAddressBlockAllocationStateList, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ip_blocks.allocation_state", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockAllocationStateList
	if methodResult.IsSuccess() {
