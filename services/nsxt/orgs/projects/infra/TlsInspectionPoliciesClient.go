...
type TlsInspectionPoliciesClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, policyIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, policyIdParam string) (nsx_policyModel.TlsPolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsPolicyListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, policyIdParam string, tlsPolicyParam nsx_policyModel.TlsPolicy) (nsx_policyModel.TlsPolicy, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, policyIdParam string, tlsPolicyParam nsx_policyModel.TlsPolicy) (nsx_policyModel.TlsPolicy, error)
}
...
func NewTlsInspectionPoliciesClient(connector vapiProtocolClient_.Connector) *tlsInspectionPoliciesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies")
...
func (tIface *tlsInspectionPoliciesClient) Delete(orgIdParam string, projectIdParam string, policyIdParam string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies", "delete", inputDataValue, executionContext)
...
func (tIface *tlsInspectionPoliciesClient) Get(orgIdParam string, projectIdParam string, policyIdParam string) (nsx_policyModel.TlsPolicy, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsPolicy
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsPolicyListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsPolicyListResult
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) Patch(orgIdParam string, projectIdParam string, policyIdParam string, tlsPolicyParam nsx_policyModel.TlsPolicy) (nsx_policyModel.TlsPolicy, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsPolicy
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) Update(orgIdParam string, projectIdParam string, policyIdParam string, tlsPolicyParam nsx_policyModel.TlsPolicy) (nsx_policyModel.TlsPolicy, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tls_inspection_policies", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsPolicy
	if methodResult.IsSuccess() {
