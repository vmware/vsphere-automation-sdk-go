...
func NewAffectedEntitiesClient(connector vapiProtocolClient_.Connector) *affectedEntitiesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.affected_entities")
...
func (aIface *affectedEntitiesClient) Create(orgIdParam string, projectIdParam string, policyIdsAffectedEntitiesRequestParam nsx_policyModel.PolicyIdsAffectedEntitiesRequest, contextParam *string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyIdsAffectedEntityListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.affected_entities", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyIdsAffectedEntityListResult
