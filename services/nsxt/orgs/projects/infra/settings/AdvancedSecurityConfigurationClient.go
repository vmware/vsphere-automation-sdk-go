...
type AdvancedSecurityConfigurationClient interface {
	...
	Get(orgIdParam string, projectIdParam string) (nsx_policyModel.AtpSettings, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, atpSettingsParam nsx_policyModel.AtpSettings) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, atpSettingsParam nsx_policyModel.AtpSettings) (nsx_policyModel.AtpSettings, error)
}
...
func NewAdvancedSecurityConfigurationClient(connector vapiProtocolClient_.Connector) *advancedSecurityConfigurationClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.advanced_security_configuration")
...
func (aIface *advancedSecurityConfigurationClient) Get(orgIdParam string, projectIdParam string) (nsx_policyModel.AtpSettings, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.advanced_security_configuration", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AtpSettings
...
func (aIface *advancedSecurityConfigurationClient) Patch(orgIdParam string, projectIdParam string, atpSettingsParam nsx_policyModel.AtpSettings) error {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.advanced_security_configuration", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *advancedSecurityConfigurationClient) Update(orgIdParam string, projectIdParam string, atpSettingsParam nsx_policyModel.AtpSettings) (nsx_policyModel.AtpSettings, error) {
	typeConverter := aIface.connector.TypeConverter()
	executionContext := aIface.connector.NewExecutionContext()
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.advanced_security_configuration", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AtpSettings
	if methodResult.IsSuccess() {
