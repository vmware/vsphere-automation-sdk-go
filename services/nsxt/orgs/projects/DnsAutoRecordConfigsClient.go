...
type DnsAutoRecordConfigsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DnsAutoRecordConfigListResult, error)

	// Patch a DnsAutoRecordConfig. Only provided fields are updated. The ip_block_path, a_record_zone_path, and ptr_record_zone_path fields are immutable and cannot be changed after creation.
	//
	// @param orgIdParam (required)
	// @param projectIdParam (required)
	// @param configIdParam (required)
...
func (dIface *dnsAutoRecordConfigsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DnsAutoRecordConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
