...
type StateClient interface {
	...
	// @return com.vmware.nsx_policy.model.LimitStateListResultForVpcs
	//
	...
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LimitStateListResultForVpcs, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.limits.state")
...
func (sIface *stateClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LimitStateListResultForVpcs, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.LimitStateListResultForVpcs
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.limits.state", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LimitStateListResultForVpcs
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.LimitStateListResultForVpcs), nil
	} else {
