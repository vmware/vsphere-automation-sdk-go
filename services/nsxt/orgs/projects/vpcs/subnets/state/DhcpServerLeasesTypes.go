...
// Data type definitions file for service: DhcpServerLeases.
...
func dhcpServerLeasesListInputType() vapiBindings_.StructType {
...
func DhcpServerLeasesListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DhcpLeasesResultBindingType)
}

func dhcpServerLeasesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/subnets/{subnetId}/state/dhcp-server-leases",
		"",
		resultHeaders,
		200,
		"",
