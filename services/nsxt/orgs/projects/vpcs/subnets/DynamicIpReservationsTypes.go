...
// Data type definitions file for service: DynamicIpReservations.
...
func dynamicIpReservationsDeleteInputType() vapiBindings_.StructType {
...
func DynamicIpReservationsDeleteOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewVoidType()
}

func dynamicIpReservationsDeleteRestMetadata() vapiProtocol_.OperationRestMetadata {
...
func DynamicIpReservationsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DynamicIpAddressReservationBindingType)
}

func dynamicIpReservationsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
...
func DynamicIpReservationsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DynamicIpAddressReservationListResultBindingType)
}

func dynamicIpReservationsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/subnets/{subnetId}/dynamic-ip-reservations",
		"",
		resultHeaders,
		200,
		"",
...
func dynamicIpReservationsPatchInputType() vapiBindings_.StructType {
	...
	fields["subnet_id"] = vapiBindings_.NewStringType()
	fields["dynamic_ip_reservation_id"] = vapiBindings_.NewStringType()
	fields["dynamic_ip_address_reservation"] = vapiBindings_.NewReferenceType(nsx_policyModel.DynamicIpAddressReservationBindingType)
	fieldNameMap["org_id"] = "OrgId"
	fieldNameMap["project_id"] = "ProjectId"
	fieldNameMap["vpc_id"] = "VpcId"
	fieldNameMap["subnet_id"] = "SubnetId"
	fieldNameMap["dynamic_ip_reservation_id"] = "DynamicIpReservationId"
	fieldNameMap["dynamic_ip_address_reservation"] = "DynamicIpAddressReservation"
	var validators = []vapiBindings_.Validator{}
	return vapiBindings_.NewStructType("operation-input", fields, reflect.TypeOf(vapiData_.StructValue{}), fieldNameMap, validators)
}
...
func dynamicIpReservationsPatchRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["subnet_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["dynamic_ip_address_reservation"] = vapiBindings_.NewReferenceType(nsx_policyModel.DynamicIpAddressReservationBindingType)
	paramsTypeMap["orgId"] = vapiBindings_.NewStringType()
	paramsTypeMap["projectId"] = vapiBindings_.NewStringType()
	paramsTypeMap["vpcId"] = vapiBindings_.NewStringType()
	paramsTypeMap["subnetId"] = vapiBindings_.NewStringType()
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		bodyFieldsMap,
		"",
		"dynamic_ip_address_reservation",
		"PATCH",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/subnets/{subnetId}/dynamic-ip-reservations/{dynamicIpReservationId}",
		"application/json",
		resultHeaders,
...
func DynamicIpReservationsUpdateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.DynamicIpAddressReservationBindingType)
}

func dynamicIpReservationsUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	fields := map[string]vapiBindings_.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]vapiBindings_.BindingType{}
	pathParams := map[string]string{}
