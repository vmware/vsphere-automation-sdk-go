...
// Possible value for ``bgpNeighborType`` of method State#get.
const State_GET_BGP_NEIGHBOR_TYPE_INTER_EDGE_NODE = "INTER_EDGE_NODE"
...
func StateGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.VpcSubnetConfigurationStateBindingType)
}
...
func stateGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/subnets/{subnetId}/state",
		"",
		resultHeaders,
		200,
		"",
