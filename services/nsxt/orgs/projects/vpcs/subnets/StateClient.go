...
type StateClient interface {
	...
	// @return com.vmware.nsx_policy.model.VpcSubnetConfigurationState
	//
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bgpNeighborTypeParam *string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_policyModel.VpcSubnetConfigurationState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.state")
...
func (sIface *stateClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bgpNeighborTypeParam *string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, statsTypeParam *string, transportNodeIdParam *string) (nsx_policyModel.VpcSubnetConfigurationState, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.VpcSubnetConfigurationState
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.VpcSubnetConfigurationState
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.VpcSubnetConfigurationState), nil
	} else {
