...
type TagsClient interface {
	...
	// Returns response of a particular Tag under VPC including it's Type and Origin.
	//
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string, tagIdParam string) (nsx_policyModel.TagDetails, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TagListResult, error)
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.categories.tags")
...
func (tIface *tagsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string, tagIdParam string) (nsx_policyModel.TagDetails, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.categories.tags", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TagDetails
...
func (tIface *tagsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TagListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.categories.tags", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TagListResult
	if methodResult.IsSuccess() {
