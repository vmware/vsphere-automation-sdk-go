...
type MemberTypesClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string) (nsx_policyModel.GroupMemberTypeListResult, error)
}
...
func NewMemberTypesClient(connector vapiProtocolClient_.Connector) *memberTypesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.groups.member_types")
...
func (mIface *memberTypesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string) (nsx_policyModel.GroupMemberTypeListResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.groups.member_types", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.GroupMemberTypeListResult
