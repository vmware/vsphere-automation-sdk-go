...
func FailedQueriesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.VpcDnsFailedQueriesBindingType)
}
...
func failedQueriesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/dns-forwarder/failed-queries",
		"",
		resultHeaders,
		200,
		"",
