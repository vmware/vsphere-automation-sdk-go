...
type CategoriesClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string) (nsx_policyModel.TagCategory, error)

	// Returns a paginated list of all the existing categories for VPC.
	//
	// @param orgIdParam The organization ID (required)
	// @param projectIdParam The project ID (required)
	// @param vpcIdParam (required)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.CategoryListResult, error)
}
...
func NewCategoriesClient(connector vapiProtocolClient_.Connector) *categoriesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.categories")
...
func (cIface *categoriesClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, categoryIdParam string) (nsx_policyModel.TagCategory, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.categories", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TagCategory
...
func (cIface *categoriesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.CategoryListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.categories", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.CategoryListResult
	if methodResult.IsSuccess() {
