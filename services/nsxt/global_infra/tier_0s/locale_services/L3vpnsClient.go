...
func NewL3vpnsClient(connector client.Connector) *l3vpnsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns")
...
func (lIface *l3vpnsClient) Delete(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "delete", inputDataValue, executionContext)
...
func (lIface *l3vpnsClient) Get(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string) (model.L3Vpn, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "get", inputDataValue, executionContext)
	var emptyOutput model.L3Vpn
	if methodResult.IsSuccess() {
...
func (lIface *l3vpnsClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, l3vpnSessionParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.L3VpnListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "list", inputDataValue, executionContext)
	var emptyOutput model.L3VpnListResult
	if methodResult.IsSuccess() {
...
func (lIface *l3vpnsClient) Patch(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string, l3VpnParam model.L3Vpn) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *l3vpnsClient) Showsensitivedata(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string) (model.L3Vpn, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "showsensitivedata", inputDataValue, executionContext)
	var emptyOutput model.L3Vpn
	if methodResult.IsSuccess() {
...
func (lIface *l3vpnsClient) Update(tier0IdParam string, localeServiceIdParam string, l3vpnIdParam string, l3VpnParam model.L3Vpn) (model.L3Vpn, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l3vpns", "update", inputDataValue, executionContext)
	var emptyOutput model.L3Vpn
	if methodResult.IsSuccess() {
