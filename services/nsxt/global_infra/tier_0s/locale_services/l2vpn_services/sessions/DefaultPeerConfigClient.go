...
func NewDefaultPeerConfigClient(connector client.Connector) *DefaultPeerConfigClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_services.sessions.peer_config"
...
func (pIface *DefaultPeerConfigClient) Get(tier0IdParam string, localeServiceIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string) (model.AggregateL2VPNSessionPeerConfig, error) {
