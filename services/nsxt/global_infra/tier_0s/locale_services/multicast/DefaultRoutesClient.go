...
func NewDefaultRoutesClient(connector client.Connector) *DefaultRoutesClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_0s.locale_services.multicast.routes"
...
func (rIface *DefaultRoutesClient) Get(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyMulticastRoutes, error) {
...
func (rIface *DefaultRoutesClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.get method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.get method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.get method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRoutesClient.get method's errors.NotFound error - %s",
