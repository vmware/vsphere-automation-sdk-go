...
func NewOspfClient(connector client.Connector) *ospfClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.ospf")
...
func (oIface *ospfClient) Get(tier0IdParam string, localeServiceIdParam string) (model.OspfRoutingConfig, error) {
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.ospf", "get", inputDataValue, executionContext)
	var emptyOutput model.OspfRoutingConfig
...
func (oIface *ospfClient) Patch(tier0IdParam string, localeServiceIdParam string, ospfRoutingConfigParam model.OspfRoutingConfig) (model.OspfRoutingConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	oIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.ospf", "patch", inputDataValue, executionContext)
	var emptyOutput model.OspfRoutingConfig
	if methodResult.IsSuccess() {
...
func (oIface *ospfClient) Update(tier0IdParam string, localeServiceIdParam string, ospfRoutingConfigParam model.OspfRoutingConfig) (model.OspfRoutingConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	oIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.ospf", "update", inputDataValue, executionContext)
	var emptyOutput model.OspfRoutingConfig
	if methodResult.IsSuccess() {
