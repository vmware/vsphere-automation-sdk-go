...
func (bIface *bgpSummaryClient) Get(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyEdgeClusterInterSiteBgpSummary, error) {
	...
	methodResult := bIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.inter_site.bgp_summary", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyEdgeClusterInterSiteBgpSummary
