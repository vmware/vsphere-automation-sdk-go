...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns.statistics"
...
func (sIface *DefaultStatisticsClient) Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, enforcementPointPathParam *string) (model.AggregateL2VpnStatistics, error) {
