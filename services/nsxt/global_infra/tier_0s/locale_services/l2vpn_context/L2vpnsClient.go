...
func NewL2vpnsClient(connector client.Connector) *l2vpnsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns")
...
func (lIface *l2vpnsClient) Delete(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns", "delete", inputDataValue, executionContext)
...
func (lIface *l2vpnsClient) Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string) (model.L2Vpn, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns", "get", inputDataValue, executionContext)
	var emptyOutput model.L2Vpn
	if methodResult.IsSuccess() {
...
func (lIface *l2vpnsClient) List(tier0IdParam string, localeServiceIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.L2VpnListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns", "list", inputDataValue, executionContext)
	var emptyOutput model.L2VpnListResult
	if methodResult.IsSuccess() {
...
func (lIface *l2vpnsClient) Patch(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, l2VpnParam model.L2Vpn) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *l2vpnsClient) Update(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, l2VpnParam model.L2Vpn) (model.L2Vpn, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_0s.locale_services.l2vpn_context.l2vpns", "update", inputDataValue, executionContext)
	var emptyOutput model.L2Vpn
	if methodResult.IsSuccess() {
