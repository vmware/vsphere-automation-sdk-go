...
func localEndpointsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/tier-0s/{tier0Id}/ipsec-vpn-services/{serviceId}/local-endpoints/{localEndpointId}",
		"",
		resultHeaders,
		204,
		"",
...
func localEndpointsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-0s/{tier0Id}/ipsec-vpn-services/{serviceId}/local-endpoints",
		"",
		resultHeaders,
		200,
		"",
