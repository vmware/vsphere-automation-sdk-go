...
func NewRulesClient(connector client.Connector) *rulesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules")
...
func (rIface *rulesClient) Delete(policyIdParam string, ruleIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules", "delete", inputDataValue, executionContext)
...
func (rIface *rulesClient) Get(policyIdParam string, ruleIdParam string) (model.TlsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules", "get", inputDataValue, executionContext)
	var emptyOutput model.TlsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) List(policyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.TlsRuleListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules", "list", inputDataValue, executionContext)
	var emptyOutput model.TlsRuleListResult
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Patch(policyIdParam string, ruleIdParam string, tlsRuleParam model.TlsRule) (model.TlsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules", "patch", inputDataValue, executionContext)
	var emptyOutput model.TlsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Update(policyIdParam string, ruleIdParam string, tlsRuleParam model.TlsRule) (model.TlsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies.rules", "update", inputDataValue, executionContext)
	var emptyOutput model.TlsRule
	if methodResult.IsSuccess() {
