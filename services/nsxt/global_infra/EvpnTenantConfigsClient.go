...
func NewEvpnTenantConfigsClient(connector client.Connector) *evpnTenantConfigsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.evpn_tenant_configs")
...
func (eIface *evpnTenantConfigsClient) Delete(configIdParam string) error {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.evpn_tenant_configs", "delete", inputDataValue, executionContext)
...
func (eIface *evpnTenantConfigsClient) Get(configIdParam string) (model.EvpnTenantConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.evpn_tenant_configs", "get", inputDataValue, executionContext)
	var emptyOutput model.EvpnTenantConfig
	if methodResult.IsSuccess() {
...
func (eIface *evpnTenantConfigsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.EvpnTenantConfigListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.evpn_tenant_configs", "list", inputDataValue, executionContext)
	var emptyOutput model.EvpnTenantConfigListResult
	if methodResult.IsSuccess() {
...
func (eIface *evpnTenantConfigsClient) Patch(configIdParam string, evpnTenantConfigParam model.EvpnTenantConfig) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.evpn_tenant_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *evpnTenantConfigsClient) Update(configIdParam string, evpnTenantConfigParam model.EvpnTenantConfig) (model.EvpnTenantConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.evpn_tenant_configs", "update", inputDataValue, executionContext)
	var emptyOutput model.EvpnTenantConfig
	if methodResult.IsSuccess() {
