...
func NewDefaultRulesClient(connector client.Connector) *DefaultRulesClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.domains.forwarding_policies.rules"
...
func (rIface *DefaultRulesClient) Delete(domainIdParam string, forwardingPolicyIdParam string, ruleIdParam string) error {
...
func (rIface *DefaultRulesClient) Get(domainIdParam string, forwardingPolicyIdParam string, ruleIdParam string) (model.ForwardingRule, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) List(domainIdParam string, forwardingPolicyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ForwardingRuleListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Patch(domainIdParam string, forwardingPolicyIdParam string, ruleIdParam string, forwardingRuleParam model.ForwardingRule) error {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Update(domainIdParam string, forwardingPolicyIdParam string, ruleIdParam string, forwardingRuleParam model.ForwardingRule) (model.ForwardingRule, error) {
	typeConverter := rIface.connector.TypeConverter()
