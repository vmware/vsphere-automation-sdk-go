...
func NewContainerClusterSpanClient(connector client.Connector) *containerClusterSpanClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span")
...
func (cIface *containerClusterSpanClient) Delete(domainIdParam string, securityPolicyIdParam string, antreaCluster1Param string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span", "delete", inputDataValue, executionContext)
...
func (cIface *containerClusterSpanClient) Get(domainIdParam string, securityPolicyIdParam string, antreaCluster1Param string) (model.SecurityPolicyContainerCluster, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span", "get", inputDataValue, executionContext)
	var emptyOutput model.SecurityPolicyContainerCluster
	if methodResult.IsSuccess() {
...
func (cIface *containerClusterSpanClient) List(doainIdParam string, securityPolicyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SecurityPolicyContainerClusterListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span", "list", inputDataValue, executionContext)
	var emptyOutput model.SecurityPolicyContainerClusterListResult
	if methodResult.IsSuccess() {
...
func (cIface *containerClusterSpanClient) Patch(domainIdParam string, securityPolicyIdParam string, containerClusterIdParam string, securityPolicyContainerClusterParam model.SecurityPolicyContainerCluster) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *containerClusterSpanClient) Update(domainIdParam string, securityPolicyIdParam string, containerClusterIdParam string, securityPolicyContainerClusterParam model.SecurityPolicyContainerCluster) (model.SecurityPolicyContainerCluster, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.domains.security_policies.container_cluster_span", "update", inputDataValue, executionContext)
	var emptyOutput model.SecurityPolicyContainerCluster
	if methodResult.IsSuccess() {
