...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.rules.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, idsPolicyIdParam string, ruleIdParam string, enforcementPointPathParam *string) (model.IdsRuleStatisticsListResult, error) {
