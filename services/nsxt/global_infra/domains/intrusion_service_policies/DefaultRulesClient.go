...
func NewDefaultRulesClient(connector client.Connector) *DefaultRulesClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.rules"
...
func (rIface *DefaultRulesClient) Delete(domainIdParam string, policyIdParam string, ruleIdParam string) error {
...
func (rIface *DefaultRulesClient) Get(domainIdParam string, policyIdParam string, ruleIdParam string) (model.IdsRule, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) List(domainIdParam string, policyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdsRuleListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Patch(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule) error {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Revise(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule, anchorPathParam *string, operationParam *string) (model.IdsRule, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Update(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule) (model.IdsRule, error) {
	typeConverter := rIface.connector.TypeConverter()
