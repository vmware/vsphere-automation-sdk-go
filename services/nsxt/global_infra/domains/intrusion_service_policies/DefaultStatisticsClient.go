...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.domains.intrusion_service_policies.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, idsPolicyIdParam string, enforcementPointPathParam *string) (model.IdsSecurityPolicyStatisticsListResult, error) {
