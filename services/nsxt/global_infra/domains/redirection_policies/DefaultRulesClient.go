...
func NewDefaultRulesClient(connector client.Connector) *DefaultRulesClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.domains.redirection_policies.rules"
...
func (rIface *DefaultRulesClient) Delete(domainIdParam string, redirectionPolicyIdParam string, ruleIdParam string) error {
...
func (rIface *DefaultRulesClient) Get(domainIdParam string, redirectionPolicyIdParam string, ruleIdParam string) (model.RedirectionRule, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) List(domainIdParam string, redirectionPolicyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RedirectionRuleListResult, error) {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Patch(domainIdParam string, redirectionPolicyIdParam string, ruleIdParam string, redirectionRuleParam model.RedirectionRule) error {
	typeConverter := rIface.connector.TypeConverter()
...
func (rIface *DefaultRulesClient) Update(domainIdParam string, redirectionPolicyIdParam string, ruleIdParam string, redirectionRuleParam model.RedirectionRule) (model.RedirectionRule, error) {
	typeConverter := rIface.connector.TypeConverter()
