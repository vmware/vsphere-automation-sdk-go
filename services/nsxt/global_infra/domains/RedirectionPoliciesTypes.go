...
func redirectionPoliciesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/domains/{domainId}/redirection-policies/{redirectionPolicyId}",
		"",
		resultHeaders,
		204,
		"",
...
func redirectionPoliciesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/redirection-policies",
		"",
		resultHeaders,
		200,
		"",
...
func redirectionPoliciesList0RestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/redirection-policies",
		"",
		resultHeaders,
		200,
		"",
