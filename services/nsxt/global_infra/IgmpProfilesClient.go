...
func NewIgmpProfilesClient(connector client.Connector) *igmpProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.igmp_profiles")
...
func (iIface *igmpProfilesClient) Delete(igmpProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.igmp_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *igmpProfilesClient) Get(igmpProfileIdParam string) (model.PolicyIgmpProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.igmp_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyIgmpProfile
	if methodResult.IsSuccess() {
...
func (iIface *igmpProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyIgmpProfileListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.igmp_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyIgmpProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *igmpProfilesClient) Patch(igmpProfileIdParam string, policyIgmpProfileParam model.PolicyIgmpProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.igmp_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *igmpProfilesClient) Update(igmpProfileIdParam string, policyIgmpProfileParam model.PolicyIgmpProfile) (model.PolicyIgmpProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.igmp_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyIgmpProfile
	if methodResult.IsSuccess() {
