...
func NewFullSyncActionClient(connector client.Connector) *fullSyncActionClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.full_sync_action")
...
func (fIface *fullSyncActionClient) Create(actionParam string, syncTypeParam *string) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.full_sync_action", "create", inputDataValue, executionContext)
