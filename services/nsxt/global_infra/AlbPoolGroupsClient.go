...
func NewAlbPoolGroupsClient(connector client.Connector) *albPoolGroupsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_pool_groups")
...
func (aIface *albPoolGroupsClient) Delete(albPoolgroupIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pool_groups", "delete", inputDataValue, executionContext)
...
func (aIface *albPoolGroupsClient) Get(albPoolgroupIdParam string) (model.ALBPoolGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pool_groups", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBPoolGroup
	if methodResult.IsSuccess() {
...
func (aIface *albPoolGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBPoolGroupApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pool_groups", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBPoolGroupApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albPoolGroupsClient) Patch(albPoolgroupIdParam string, aLBPoolGroupParam model.ALBPoolGroup) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pool_groups", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPoolGroupsClient) Update(albPoolgroupIdParam string, aLBPoolGroupParam model.ALBPoolGroup) (model.ALBPoolGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pool_groups", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBPoolGroup
	if methodResult.IsSuccess() {
