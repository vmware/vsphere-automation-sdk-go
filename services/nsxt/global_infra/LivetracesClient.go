...
func NewLivetracesClient(connector client.Connector) *livetracesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.livetraces")
...
func (lIface *livetracesClient) Create(livetraceIdParam string, actionParam *string) (model.LiveTraceConfig, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "create", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceConfig
...
func (lIface *livetracesClient) Delete(livetraceIdParam string) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *livetracesClient) Get(livetraceIdParam string) (model.LiveTraceConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "get", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceConfig
	if methodResult.IsSuccess() {
...
func (lIface *livetracesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.LiveTraceConfigListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "list", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceConfigListResult
	if methodResult.IsSuccess() {
...
func (lIface *livetracesClient) Patch(livetraceIdParam string, liveTraceConfigParam model.LiveTraceConfig) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *livetracesClient) Update(livetraceIdParam string, liveTraceConfigParam model.LiveTraceConfig) (model.LiveTraceConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces", "update", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceConfig
	if methodResult.IsSuccess() {
