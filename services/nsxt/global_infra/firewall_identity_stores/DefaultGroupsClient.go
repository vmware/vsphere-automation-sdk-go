...
func NewDefaultGroupsClient(connector client.Connector) *DefaultGroupsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.firewall_identity_stores.groups"
...
func (gIface *DefaultGroupsClient) List(firewallIdentityStoreIdParam string, filterValueParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DirectoryGroupListResults, error) {
