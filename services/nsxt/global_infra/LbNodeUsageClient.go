...
func NewLbNodeUsageClient(connector client.Connector) *lbNodeUsageClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.lb_node_usage")
...
func (lIface *lbNodeUsageClient) Get(nodePathParam string) (*data.StructValue, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_node_usage", "get", inputDataValue, executionContext)
	var emptyOutput *data.StructValue
