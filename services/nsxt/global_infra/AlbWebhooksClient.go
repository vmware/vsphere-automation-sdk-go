...
func NewAlbWebhooksClient(connector client.Connector) *albWebhooksClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_webhooks")
...
func (aIface *albWebhooksClient) Delete(albWebhookIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_webhooks", "delete", inputDataValue, executionContext)
...
func (aIface *albWebhooksClient) Get(albWebhookIdParam string) (model.ALBWebhook, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_webhooks", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBWebhook
	if methodResult.IsSuccess() {
...
func (aIface *albWebhooksClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBWebhookApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_webhooks", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBWebhookApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albWebhooksClient) Patch(albWebhookIdParam string, aLBWebhookParam model.ALBWebhook) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_webhooks", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albWebhooksClient) Update(albWebhookIdParam string, aLBWebhookParam model.ALBWebhook) (model.ALBWebhook, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_webhooks", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBWebhook
	if methodResult.IsSuccess() {
