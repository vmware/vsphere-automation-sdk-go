...
type CustomTldsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, hasUnsupportedAppIdsParam *bool, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCustomTldListResult, error)
}
...
func NewCustomTldsClient(connector vapiProtocolClient_.Connector) *customTldsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.custom_tlds")
...
func (cIface *customTldsClient) Get(idParam string) (nsx_policyModel.PolicyCustomTld, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.custom_tlds", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyCustomTld
...
func (cIface *customTldsClient) List(cursorParam *string, hasUnsupportedAppIdsParam *bool, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.PolicyCustomTldListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.custom_tlds", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyCustomTldListResult
	if methodResult.IsSuccess() {
