...
func summaryListInputType() vapiBindings_.StructType {
...
func SummaryListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyEdgeClusterInterNodeBgpSummaryBindingType)
}

func summaryListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/inter-node/bgp/summary",
		"",
		resultHeaders,
		200,
		"",
