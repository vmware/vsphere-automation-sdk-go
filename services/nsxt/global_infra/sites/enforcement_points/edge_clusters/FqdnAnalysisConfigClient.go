...
func NewFqdnAnalysisConfigClient(connector client.Connector) *fqdnAnalysisConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config")
...
func (fIface *fqdnAnalysisConfigClient) Delete(siteIdParam string, enforcementPointIdParam string, edgeClusterIdParam string) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config", "delete", inputDataValue, executionContext)
...
func (fIface *fqdnAnalysisConfigClient) Get(siteIdParam string, enforcementPointIdParam string, edgeClusterIdParam string) (model.FqdnAnalysisConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config", "get", inputDataValue, executionContext)
	var emptyOutput model.FqdnAnalysisConfig
	if methodResult.IsSuccess() {
...
func (fIface *fqdnAnalysisConfigClient) Patch(siteIdParam string, enforcementPointIdParam string, edgeClusterIdParam string, fqdnAnalysisConfigParam model.FqdnAnalysisConfig) (model.FqdnAnalysisConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config", "patch", inputDataValue, executionContext)
	var emptyOutput model.FqdnAnalysisConfig
	if methodResult.IsSuccess() {
...
func (fIface *fqdnAnalysisConfigClient) Update(siteIdParam string, enforcementPointIdParam string, edgeClusterIdParam string, fqdnAnalysisConfigParam model.FqdnAnalysisConfig) (model.FqdnAnalysisConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.fqdn_analysis_config", "update", inputDataValue, executionContext)
	var emptyOutput model.FqdnAnalysisConfig
	if methodResult.IsSuccess() {
