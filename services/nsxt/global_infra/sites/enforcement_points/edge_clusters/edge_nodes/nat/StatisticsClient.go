...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.edge_nodes.nat.statistics")
...
func (sIface *statisticsClient) Get(siteIdParam string, enforcementpointIdParam string, edgeClusterIdParam string, policyEdgeNodeIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.NatStatisticsPerPolicyEdgeNode, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.edge_nodes.nat.statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.NatStatisticsPerPolicyEdgeNode
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.NatStatisticsPerPolicyEdgeNode), nil
	} else {
