...
func NewSummaryClient(connector vapiProtocolClient_.Connector) *summaryClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.edge_nodes.remote_tep_connectivity.bgp.summary")
...
func (sIface *summaryClient) Get(siteIdParam string, enforcementpointIdParam string, edgeClusterIdParam string, policyEdgeNodeIdParam string) (nsx_policyModel.PolicyEdgeClusterMemberInterSiteBgpSummary, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.edge_clusters.edge_nodes.remote_tep_connectivity.bgp.summary", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyEdgeClusterMemberInterSiteBgpSummary
