...
func NeighborsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyEdgeNodeBgpNeighborsListResultBindingType)
}
...
func neighborsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/edge-nodes/{policyEdgeNodeId}/remote-tep-connectivity/bgp/neighbors",
		"",
		resultHeaders,
		200,
		"",
