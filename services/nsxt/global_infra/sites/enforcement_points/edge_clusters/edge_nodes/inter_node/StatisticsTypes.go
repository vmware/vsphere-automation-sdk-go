...
func StatisticsGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.PolicyEdgeNodeInterNodePortStatisticsBindingType)
}
...
func statisticsGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/edge-clusters/{edgeClusterId}/edge-nodes/{policyEdgeNodeId}/inter-node/statistics",
		"",
		resultHeaders,
		200,
		"",
