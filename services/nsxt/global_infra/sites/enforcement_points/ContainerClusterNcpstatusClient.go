...
func NewContainerClusterNcpstatusClient(connector client.Connector) *containerClusterNcpstatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.container_cluster_ncpstatus")
...
func (cIface *containerClusterNcpstatusClient) Create(siteIdParam string, enforcementPointIdParam string, containerClusterStatusParam model.ContainerClusterStatus) (model.ContainerClusterStatus, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.container_cluster_ncpstatus", "create", inputDataValue, executionContext)
	var emptyOutput model.ContainerClusterStatus
...
func (cIface *containerClusterNcpstatusClient) List(siteIdParam string, enforcementPointIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ContainerClusterStatusList, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.container_cluster_ncpstatus", "list", inputDataValue, executionContext)
	var emptyOutput model.ContainerClusterStatusList
	if methodResult.IsSuccess() {
