...
func transportNodeCollectionsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/transport-node-collections/{transportNodeCollectionId}",
		"",
		resultHeaders,
		204,
		"",
...
func transportNodeCollectionsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/transport-node-collections",
		"",
		resultHeaders,
		200,
		"",
...
func transportNodeCollectionsUpdateRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"host_transport_node_collection",
		"PUT",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/transport-node-collections/{transportNodeCollectionsId}",
		"",
		resultHeaders,
		200,
		"",
