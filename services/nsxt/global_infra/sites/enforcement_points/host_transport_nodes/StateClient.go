...
func NewStateClient(connector client.Connector) *stateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.state")
...
func (sIface *stateClient) Get(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (model.TransportNodeState, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.state", "get", inputDataValue, executionContext)
	var emptyOutput model.TransportNodeState
...
func (sIface *stateClient) List(siteIdParam string, enforcementpointIdParam string, mmStateParam *string, statusParam *string, vtepIpParam *string) (model.TransportNodeStateListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.state", "list", inputDataValue, executionContext)
	var emptyOutput model.TransportNodeStateListResult
	if methodResult.IsSuccess() {
