...
func NewPnicBondStatusClient(connector client.Connector) *pnicBondStatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.pnic_bond_status")
...
func (pIface *pnicBondStatusClient) List(siteIdParam string, enforcementPointIdParam string, nodeIdParam string, statusParam *string) (model.PnicBondStatusListResult, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.pnic_bond_status", "list", inputDataValue, executionContext)
	var emptyOutput model.PnicBondStatusListResult
