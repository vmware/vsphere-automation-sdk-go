...
func NewModulesClient(connector client.Connector) *modulesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.modules")
...
func (mIface *modulesClient) Get(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (model.SoftwareModuleResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.enforcement_points.host_transport_nodes.modules", "get", inputDataValue, executionContext)
	var emptyOutput model.SoftwareModuleResult
