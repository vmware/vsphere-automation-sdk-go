...
func clusterControlPlanesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/cluster-control-planes/{clusterControlPlaneId}",
		"",
		resultHeaders,
		204,
		"",
...
func clusterControlPlanesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/cluster-control-planes",
		"",
		resultHeaders,
		200,
		"",
