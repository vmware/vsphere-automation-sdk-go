...
func NewTransportNodeProfileClient(connector client.Connector) *transportNodeProfileClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.sites.intelligence.transport_node_profile")
...
func (tIface *transportNodeProfileClient) Get(siteIdParam string) (model.IntelligenceTransportNodeProfile, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.intelligence.transport_node_profile", "get", inputDataValue, executionContext)
	var emptyOutput model.IntelligenceTransportNodeProfile
...
func (tIface *transportNodeProfileClient) Patch(siteIdParam string, intelligenceTransportNodeProfileParam model.IntelligenceTransportNodeProfile) (model.IntelligenceTransportNodeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.intelligence.transport_node_profile", "patch", inputDataValue, executionContext)
	var emptyOutput model.IntelligenceTransportNodeProfile
	if methodResult.IsSuccess() {
...
func (tIface *transportNodeProfileClient) Reset(siteIdParam string) (model.IntelligenceTransportNodeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.sites.intelligence.transport_node_profile", "reset", inputDataValue, executionContext)
	var emptyOutput model.IntelligenceTransportNodeProfile
	if methodResult.IsSuccess() {
