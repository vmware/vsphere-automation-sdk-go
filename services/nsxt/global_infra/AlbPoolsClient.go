...
func NewAlbPoolsClient(connector client.Connector) *albPoolsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_pools")
...
func (aIface *albPoolsClient) Delete(albPoolIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pools", "delete", inputDataValue, executionContext)
...
func (aIface *albPoolsClient) Get(albPoolIdParam string) (model.ALBPool, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pools", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBPool
	if methodResult.IsSuccess() {
...
func (aIface *albPoolsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBPoolApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pools", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBPoolApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albPoolsClient) Patch(albPoolIdParam string, aLBPoolParam model.ALBPool) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pools", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPoolsClient) Update(albPoolIdParam string, aLBPoolParam model.ALBPool) (model.ALBPool, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pools", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBPool
	if methodResult.IsSuccess() {
