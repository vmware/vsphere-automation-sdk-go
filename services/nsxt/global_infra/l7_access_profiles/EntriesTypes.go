...
func entriesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/l7-access-profiles/{l7AccessProfileId}/entries/{l7AccessEntryId}",
		"",
		resultHeaders,
		204,
		"",
...
func entriesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/l7-access-profiles/{l7AccessProfileId}/entries",
		"",
		resultHeaders,
		200,
		"",
