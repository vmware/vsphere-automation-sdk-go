...
func NewLbServicesClient(connector client.Connector) *lbServicesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.lb_services")
...
func (lIface *lbServicesClient) Delete(lbServiceIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_services", "delete", inputDataValue, executionContext)
...
func (lIface *lbServicesClient) Get(lbServiceIdParam string) (model.LBService, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_services", "get", inputDataValue, executionContext)
	var emptyOutput model.LBService
	if methodResult.IsSuccess() {
...
func (lIface *lbServicesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.LBServiceListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_services", "list", inputDataValue, executionContext)
	var emptyOutput model.LBServiceListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbServicesClient) Patch(lbServiceIdParam string, lbServiceParam model.LBService) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbServicesClient) Update(lbServiceIdParam string, lbServiceParam model.LBService) (model.LBService, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_services", "update", inputDataValue, executionContext)
	var emptyOutput model.LBService
	if methodResult.IsSuccess() {
