...
func NewTlsInspectionPoliciesClient(connector client.Connector) *tlsInspectionPoliciesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tls_inspection_policies")
...
func (tIface *tlsInspectionPoliciesClient) Delete(policyIdParam string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies", "delete", inputDataValue, executionContext)
...
func (tIface *tlsInspectionPoliciesClient) Get(policyIdParam string) (model.TlsPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies", "get", inputDataValue, executionContext)
	var emptyOutput model.TlsPolicy
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.TlsPolicyListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies", "list", inputDataValue, executionContext)
	var emptyOutput model.TlsPolicyListResult
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) Patch(policyIdParam string, tlsPolicyParam model.TlsPolicy) (model.TlsPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies", "patch", inputDataValue, executionContext)
	var emptyOutput model.TlsPolicy
	if methodResult.IsSuccess() {
...
func (tIface *tlsInspectionPoliciesClient) Update(policyIdParam string, tlsPolicyParam model.TlsPolicy) (model.TlsPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tls_inspection_policies", "update", inputDataValue, executionContext)
	var emptyOutput model.TlsPolicy
	if methodResult.IsSuccess() {
