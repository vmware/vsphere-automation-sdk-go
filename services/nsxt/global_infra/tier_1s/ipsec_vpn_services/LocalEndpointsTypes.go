...
func localEndpointsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/local-endpoints/{localEndpointId}",
		"",
		resultHeaders,
		200,
		"",
...
func localEndpointsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/ipsec-vpn-services/{serviceId}/local-endpoints",
		"",
		resultHeaders,
		200,
		"",
