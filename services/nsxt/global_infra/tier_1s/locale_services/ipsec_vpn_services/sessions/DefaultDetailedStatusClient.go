...
func NewDefaultDetailedStatusClient(connector client.Connector) *DefaultDetailedStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_1s.locale_services.ipsec_vpn_services.sessions.detailed_status"
...
func (dIface *DefaultDetailedStatusClient) Get(tier1IdParam string, localeServiceIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.AggregateIPSecVpnSessionStatus, error) {
