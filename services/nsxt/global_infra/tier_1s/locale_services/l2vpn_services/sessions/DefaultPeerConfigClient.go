...
func NewDefaultPeerConfigClient(connector client.Connector) *DefaultPeerConfigClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_1s.locale_services.l2vpn_services.sessions.peer_config"
...
func (pIface *DefaultPeerConfigClient) Get(tier1IdParam string, localeServiceIdParam string, serviceIdParam string, sessionIdParam string, enforcementPointPathParam *string) (model.AggregateL2VPNSessionPeerConfig, error) {
...
func (pIface *DefaultPeerConfigClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultPeerConfigClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultPeerConfigClient.get method's errors.InternalServerError error - %s",
