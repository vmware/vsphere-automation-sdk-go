...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.tier_1s.locale_services.service_instances.statistics"
...
func (sIface *DefaultStatisticsClient) Get(tier1IdParam string, localeServiceIdParam string, serviceInstanceIdParam string, enforcementPointPathParam *string) (model.PolicyServiceInstanceStatistics, error) {
