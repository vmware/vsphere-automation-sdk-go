...
func serviceInstanceEndpointsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/byod-service-instances/{serviceInstanceId}/service-instance-endpoints/{serviceInstanceEndpointId}",
		"",
		resultHeaders,
		204,
		"",
...
func serviceInstanceEndpointsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/byod-service-instances/{serviceInstanceId}/service-instance-endpoints",
		"",
		resultHeaders,
		200,
		"",
