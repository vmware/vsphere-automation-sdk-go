...
func ipsecVpnServicesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/ipsec-vpn-services/{serviceId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipsecVpnServicesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/ipsec-vpn-services",
		"",
		resultHeaders,
		200,
		"",
