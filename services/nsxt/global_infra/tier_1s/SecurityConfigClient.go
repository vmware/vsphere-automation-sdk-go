...
func NewSecurityConfigClient(connector client.Connector) *securityConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.security_config")
...
func (sIface *securityConfigClient) Delete(tier1IdParam string, cursorParam *string, featureParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.security_config", "delete", inputDataValue, executionContext)
...
func (sIface *securityConfigClient) Patch(tier1IdParam string, securityFeaturesParam model.SecurityFeatures) (model.SecurityFeatures, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.security_config", "patch", inputDataValue, executionContext)
	var emptyOutput model.SecurityFeatures
	if methodResult.IsSuccess() {
...
func (sIface *securityConfigClient) Update(tier1IdParam string, securityFeaturesParam model.SecurityFeatures) (model.SecurityFeatures, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.security_config", "update", inputDataValue, executionContext)
	var emptyOutput model.SecurityFeatures
	if methodResult.IsSuccess() {
