...
func ipfixSwitchCollectionInstancesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/ipfix-switch-collection-instances/{ipfixSwitchCollectionInstanceId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipfixSwitchCollectionInstancesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/ipfix-switch-collection-instances",
		"",
		resultHeaders,
		200,
		"",
