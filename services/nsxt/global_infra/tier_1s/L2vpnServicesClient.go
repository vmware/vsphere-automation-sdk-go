...
func NewL2vpnServicesClient(connector client.Connector) *l2vpnServicesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services")
...
func (lIface *l2vpnServicesClient) Delete(tier1IdParam string, serviceIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services", "delete", inputDataValue, executionContext)
...
func (lIface *l2vpnServicesClient) Get(tier1IdParam string, serviceIdParam string) (model.L2VPNService, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services", "get", inputDataValue, executionContext)
	var emptyOutput model.L2VPNService
	if methodResult.IsSuccess() {
...
func (lIface *l2vpnServicesClient) List(tier1IdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.L2VPNServiceListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services", "list", inputDataValue, executionContext)
	var emptyOutput model.L2VPNServiceListResult
	if methodResult.IsSuccess() {
...
func (lIface *l2vpnServicesClient) Patch(tier1IdParam string, serviceIdParam string, l2VPNServiceParam model.L2VPNService) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *l2vpnServicesClient) Update(tier1IdParam string, serviceIdParam string, l2VPNServiceParam model.L2VPNService) (model.L2VPNService, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.l2vpn_services", "update", inputDataValue, executionContext)
	var emptyOutput model.L2VPNService
	if methodResult.IsSuccess() {
