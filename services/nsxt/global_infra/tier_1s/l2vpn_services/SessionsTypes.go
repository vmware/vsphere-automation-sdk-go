...
func sessionsCreatewithpeercodeRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"l2_VPN_session_data",
		"POST",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/l2vpn-services/{serviceId}/sessions/{sessionId}",
		"",
		resultHeaders,
		204,
		"",
...
func sessionsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-1s/{tier1Id}/l2vpn-services/{serviceId}/sessions",
		"",
		resultHeaders,
		200,
		"",
