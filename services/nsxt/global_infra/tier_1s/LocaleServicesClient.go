...
func (lIface *localeServicesClient) Delete(tier1IdParam string, localeServicesIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.locale_services", "delete", inputDataValue, executionContext)
...
func (lIface *localeServicesClient) Patch(tier1IdParam string, localeServicesIdParam string, localeServicesParam model.LocaleServices) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.locale_services", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *localeServicesClient) Update(tier1IdParam string, localeServicesIdParam string, localeServicesParam model.LocaleServices) (model.LocaleServices, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.locale_services", "update", inputDataValue, executionContext)
	var emptyOutput model.LocaleServices
	if methodResult.IsSuccess() {
