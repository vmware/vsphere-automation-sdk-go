...
func NewCsrsClient(connector client.Connector) *csrsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.csrs")
...
func (cIface *csrsClient) Create(csrIdParam string, csrParam model.Csr) (model.Csr, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "create", inputDataValue, executionContext)
	var emptyOutput model.Csr
...
func (cIface *csrsClient) Delete(csrIdParam string) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *csrsClient) Get(csrIdParam string) (model.Csr, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "get", inputDataValue, executionContext)
	var emptyOutput model.Csr
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Importcsr(csrIdParam string, trustObjectDataParam model.TrustObjectData) (model.TlsCertificate, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "importcsr", inputDataValue, executionContext)
	var emptyOutput model.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.CsrList, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "list", inputDataValue, executionContext)
	var emptyOutput model.CsrList
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Selfsign(csrIdParam string, daysValidParam int64) (model.TlsCertificate, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "selfsign", inputDataValue, executionContext)
	var emptyOutput model.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Selfsign0(csrWithDaysValidParam model.CsrWithDaysValid) (model.TlsCertificate, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.csrs", "selfsign_0", inputDataValue, executionContext)
	var emptyOutput model.TlsCertificate
	if methodResult.IsSuccess() {
