...
func albApplicationPersistenceProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/alb-application-persistence-profiles/{albApplicationpersistenceprofileId}",
		"",
		resultHeaders,
		204,
		"",
...
func albApplicationPersistenceProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/alb-application-persistence-profiles",
		"",
		resultHeaders,
		200,
		"",
