...
func NewIpsecVpnDpdProfilesClient(connector client.Connector) *ipsecVpnDpdProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles")
...
func (iIface *ipsecVpnDpdProfilesClient) Delete(dpdProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnDpdProfilesClient) Get(dpdProfileIdParam string) (model.IPSecVpnDpdProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnDpdProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnDpdProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IPSecVpnDpdProfileListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnDpdProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnDpdProfilesClient) Patch(dpdProfileIdParam string, ipSecVpnDpdProfileParam model.IPSecVpnDpdProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnDpdProfilesClient) Update(dpdProfileIdParam string, ipSecVpnDpdProfileParam model.IPSecVpnDpdProfile) (model.IPSecVpnDpdProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_dpd_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnDpdProfile
	if methodResult.IsSuccess() {
