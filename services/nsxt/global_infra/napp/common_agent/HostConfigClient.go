...
func NewHostConfigClient(connector client.Connector) *hostConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.napp.common_agent.host_config")
...
func (hIface *hostConfigClient) Get() (model.CommonAgentHostConfigurationInfo, error) {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.napp.common_agent.host_config", "get", inputDataValue, executionContext)
	var emptyOutput model.CommonAgentHostConfigurationInfo
...
func (hIface *hostConfigClient) Patch(commonAgentHostConfigurationInfoParam model.CommonAgentHostConfigurationInfo) (model.CommonAgentHostConfigurationInfo, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	hIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.napp.common_agent.host_config", "patch", inputDataValue, executionContext)
	var emptyOutput model.CommonAgentHostConfigurationInfo
	if methodResult.IsSuccess() {
...
func (hIface *hostConfigClient) Reset() (model.CommonAgentHostConfigurationInfo, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	hIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.napp.common_agent.host_config", "reset", inputDataValue, executionContext)
	var emptyOutput model.CommonAgentHostConfigurationInfo
	if methodResult.IsSuccess() {
