...
func NewAlbAuthProfilesClient(connector client.Connector) *albAuthProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_auth_profiles")
...
func (aIface *albAuthProfilesClient) Delete(albAuthprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_auth_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albAuthProfilesClient) Get(albAuthprofileIdParam string) (model.ALBAuthProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_auth_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBAuthProfile
	if methodResult.IsSuccess() {
...
func (aIface *albAuthProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBAuthProfileApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_auth_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBAuthProfileApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albAuthProfilesClient) Patch(albAuthprofileIdParam string, aLBAuthProfileParam model.ALBAuthProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_auth_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albAuthProfilesClient) Update(albAuthprofileIdParam string, aLBAuthProfileParam model.ALBAuthProfile) (model.ALBAuthProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_auth_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBAuthProfile
	if methodResult.IsSuccess() {
