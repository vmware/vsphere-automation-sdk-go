...
func NewTraceflowsClient(connector client.Connector) *traceflowsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.antrea.traceflows")
...
func (tIface *traceflowsClient) Create(traceflowIdParam string, actionParam *string) (model.AntreaTraceflowConfig, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "create", inputDataValue, executionContext)
	var emptyOutput model.AntreaTraceflowConfig
...
func (tIface *traceflowsClient) Delete(traceflowIdParam string) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), tIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (tIface *traceflowsClient) Get(traceflowIdParam string) (model.AntreaTraceflowConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "get", inputDataValue, executionContext)
	var emptyOutput model.AntreaTraceflowConfig
	if methodResult.IsSuccess() {
...
func (tIface *traceflowsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.AntreaTraceflowConfigListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "list", inputDataValue, executionContext)
	var emptyOutput model.AntreaTraceflowConfigListResult
	if methodResult.IsSuccess() {
...
func (tIface *traceflowsClient) Patch(traceflowIdParam string, antreaTraceflowConfigParam model.AntreaTraceflowConfig) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), tIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (tIface *traceflowsClient) Update(traceflowIdParam string, antreaTraceflowConfigParam model.AntreaTraceflowConfig) (model.AntreaTraceflowConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.antrea.traceflows", "update", inputDataValue, executionContext)
	var emptyOutput model.AntreaTraceflowConfig
	if methodResult.IsSuccess() {
