...
func NewOffboardingStatusClient(connector client.Connector) *offboardingStatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.site.offboarding_status")
...
func (oIface *offboardingStatusClient) Get() (model.SiteOffBoardingState, error) {
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.site.offboarding_status", "get", inputDataValue, executionContext)
	var emptyOutput model.SiteOffBoardingState
