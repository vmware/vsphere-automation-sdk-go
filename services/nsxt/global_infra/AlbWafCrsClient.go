...
func NewAlbWafCrsClient(connector client.Connector) *albWafCrsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_waf_crs")
...
func (aIface *albWafCrsClient) Delete(albWafcrsIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_crs", "delete", inputDataValue, executionContext)
...
func (aIface *albWafCrsClient) Get(albWafcrsIdParam string) (model.ALBWafCRS, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_crs", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBWafCRS
	if methodResult.IsSuccess() {
...
func (aIface *albWafCrsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBWafCRSApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_crs", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBWafCRSApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albWafCrsClient) Patch(albWafcrsIdParam string, aLBWafCRSParam model.ALBWafCRS) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_crs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albWafCrsClient) Update(albWafcrsIdParam string, aLBWafCRSParam model.ALBWafCRS) (model.ALBWafCRS, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_crs", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBWafCRS
	if methodResult.IsSuccess() {
