...
func NewDefaultDetailedStatusClient(connector client.Connector) *DefaultDetailedStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.lb_services.lb_pools.detailed_status"
...
func (dIface *DefaultDetailedStatusClient) Get(lbServiceIdParam string, lbPoolIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.AggregateLBPoolStatus, error) {
