...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.lb_services.statistics"
...
func (sIface *DefaultStatisticsClient) Get(lbServiceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.AggregateLBServiceStatistics, error) {
