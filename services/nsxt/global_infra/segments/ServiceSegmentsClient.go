...
func NewServiceSegmentsClient(connector client.Connector) *serviceSegmentsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.segments.service_segments")
...
func (sIface *serviceSegmentsClient) Delete(serviceSegmentIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.service_segments", "delete", inputDataValue, executionContext)
...
func (sIface *serviceSegmentsClient) Get(serviceSegmentIdParam string) (model.ServiceSegment, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.service_segments", "get", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegment
	if methodResult.IsSuccess() {
...
func (sIface *serviceSegmentsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ServiceSegmentListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.service_segments", "list", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegmentListResult
	if methodResult.IsSuccess() {
...
func (sIface *serviceSegmentsClient) Patch(serviceSegmentIdParam string, serviceSegmentParam model.ServiceSegment) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.service_segments", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *serviceSegmentsClient) Update(serviceSegmentIdParam string, serviceSegmentParam model.ServiceSegment) (model.ServiceSegment, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.service_segments", "update", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegment
	if methodResult.IsSuccess() {
