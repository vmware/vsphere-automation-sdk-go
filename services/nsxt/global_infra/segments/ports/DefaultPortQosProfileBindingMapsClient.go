...
func NewDefaultPortQosProfileBindingMapsClient(connector client.Connector) *DefaultPortQosProfileBindingMapsClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.segments.ports.port_qos_profile_binding_maps"
...
func (pIface *DefaultPortQosProfileBindingMapsClient) Delete(segmentIdParam string, portIdParam string, portQosProfileBindingMapIdParam string) error {
...
func (pIface *DefaultPortQosProfileBindingMapsClient) Get(segmentIdParam string, portIdParam string, portQosProfileBindingMapIdParam string) (model.PortQosProfileBindingMap, error) {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *DefaultPortQosProfileBindingMapsClient) List(segmentIdParam string, portIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PortQosProfileBindingMapListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *DefaultPortQosProfileBindingMapsClient) Patch(segmentIdParam string, portIdParam string, portQosProfileBindingMapIdParam string, portQosProfileBindingMapParam model.PortQosProfileBindingMap) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *DefaultPortQosProfileBindingMapsClient) Update(segmentIdParam string, portIdParam string, portQosProfileBindingMapIdParam string, portQosProfileBindingMapParam model.PortQosProfileBindingMap) (model.PortQosProfileBindingMap, error) {
	typeConverter := pIface.connector.TypeConverter()
