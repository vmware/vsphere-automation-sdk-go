...
func NewAlbIpAddrGroupsClient(connector client.Connector) *albIpAddrGroupsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups")
...
func (aIface *albIpAddrGroupsClient) Delete(albIpaddrgroupIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups", "delete", inputDataValue, executionContext)
...
func (aIface *albIpAddrGroupsClient) Get(albIpaddrgroupIdParam string) (model.ALBIpAddrGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBIpAddrGroup
	if methodResult.IsSuccess() {
...
func (aIface *albIpAddrGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBIpAddrGroupApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBIpAddrGroupApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albIpAddrGroupsClient) Patch(albIpaddrgroupIdParam string, aLBIpAddrGroupParam model.ALBIpAddrGroup) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albIpAddrGroupsClient) Update(albIpaddrgroupIdParam string, aLBIpAddrGroupParam model.ALBIpAddrGroup) (model.ALBIpAddrGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ip_addr_groups", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBIpAddrGroup
	if methodResult.IsSuccess() {
