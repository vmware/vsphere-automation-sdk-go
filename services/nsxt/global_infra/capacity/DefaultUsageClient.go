...
func NewDefaultUsageClient(connector client.Connector) *DefaultUsageClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.capacity.usage"
...
func (uIface *DefaultUsageClient) Get(categoryParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyCapacityUsageResponse, error) {
