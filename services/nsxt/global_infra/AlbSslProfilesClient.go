...
func NewAlbSslProfilesClient(connector client.Connector) *albSslProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_ssl_profiles")
...
func (aIface *albSslProfilesClient) Delete(albSslprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ssl_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albSslProfilesClient) Get(albSslprofileIdParam string) (model.ALBSSLProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ssl_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBSSLProfile
	if methodResult.IsSuccess() {
...
func (aIface *albSslProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBSSLProfileApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ssl_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBSSLProfileApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albSslProfilesClient) Patch(albSslprofileIdParam string, aLBSSLProfileParam model.ALBSSLProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ssl_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albSslProfilesClient) Update(albSslprofileIdParam string, aLBSSLProfileParam model.ALBSSLProfile) (model.ALBSSLProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_ssl_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBSSLProfile
	if methodResult.IsSuccess() {
