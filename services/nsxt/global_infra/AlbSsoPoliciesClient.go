...
func NewAlbSsoPoliciesClient(connector client.Connector) *albSsoPoliciesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_sso_policies")
...
func (aIface *albSsoPoliciesClient) Delete(albSsopolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_sso_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albSsoPoliciesClient) Get(albSsopolicyIdParam string) (model.ALBSSOPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_sso_policies", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBSSOPolicy
	if methodResult.IsSuccess() {
...
func (aIface *albSsoPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBSSOPolicyApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_sso_policies", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBSSOPolicyApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albSsoPoliciesClient) Patch(albSsopolicyIdParam string, aLBSSOPolicyParam model.ALBSSOPolicy) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_sso_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albSsoPoliciesClient) Update(albSsopolicyIdParam string, aLBSSOPolicyParam model.ALBSSOPolicy) (model.ALBSSOPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_sso_policies", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBSSOPolicy
	if methodResult.IsSuccess() {
