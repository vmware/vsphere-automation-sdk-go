...
func NewConnectivityGlobalConfigClient(connector client.Connector) *connectivityGlobalConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.connectivity_global_config")
...
func (cIface *connectivityGlobalConfigClient) Get() (model.GlobalConfig, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.connectivity_global_config", "get", inputDataValue, executionContext)
	var emptyOutput model.GlobalConfig
...
func (cIface *connectivityGlobalConfigClient) Patch(globalConfigParam model.GlobalConfig) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.connectivity_global_config", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *connectivityGlobalConfigClient) Update(globalConfigParam model.GlobalConfig) (model.GlobalConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.connectivity_global_config", "update", inputDataValue, executionContext)
	var emptyOutput model.GlobalConfig
	if methodResult.IsSuccess() {
