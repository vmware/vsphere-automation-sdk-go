...
func NewLbPoolsClient(connector client.Connector) *lbPoolsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.lb_pools")
...
func (lIface *lbPoolsClient) Delete(lbPoolIdParam string, forceParam *bool) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_pools", "delete", inputDataValue, executionContext)
...
func (lIface *lbPoolsClient) Get(lbPoolIdParam string) (model.LBPool, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_pools", "get", inputDataValue, executionContext)
	var emptyOutput model.LBPool
	if methodResult.IsSuccess() {
...
func (lIface *lbPoolsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.LBPoolListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_pools", "list", inputDataValue, executionContext)
	var emptyOutput model.LBPoolListResult
	if methodResult.IsSuccess() {
...
func (lIface *lbPoolsClient) Patch(lbPoolIdParam string, lbPoolParam model.LBPool) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_pools", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), lIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (lIface *lbPoolsClient) Update(lbPoolIdParam string, lbPoolParam model.LBPool) (model.LBPool, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	lIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_pools", "update", inputDataValue, executionContext)
	var emptyOutput model.LBPool
	if methodResult.IsSuccess() {
