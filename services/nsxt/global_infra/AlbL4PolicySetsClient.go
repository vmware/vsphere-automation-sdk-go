...
func NewAlbL4PolicySetsClient(connector client.Connector) *albL4PolicySetsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets")
...
func (aIface *albL4PolicySetsClient) Delete(albL4policysetIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets", "delete", inputDataValue, executionContext)
...
func (aIface *albL4PolicySetsClient) Get(albL4policysetIdParam string) (model.ALBL4PolicySet, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBL4PolicySet
	if methodResult.IsSuccess() {
...
func (aIface *albL4PolicySetsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBL4PolicySetApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBL4PolicySetApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albL4PolicySetsClient) Patch(albL4policysetIdParam string, aLBL4PolicySetParam model.ALBL4PolicySet) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albL4PolicySetsClient) Update(albL4policysetIdParam string, aLBL4PolicySetParam model.ALBL4PolicySet) (model.ALBL4PolicySet, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_l4_policy_sets", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBL4PolicySet
	if methodResult.IsSuccess() {
