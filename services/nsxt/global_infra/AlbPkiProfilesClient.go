...
func NewAlbPkiProfilesClient(connector client.Connector) *albPkiProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_pki_profiles")
...
func (aIface *albPkiProfilesClient) Delete(albPkiprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pki_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albPkiProfilesClient) Get(albPkiprofileIdParam string) (model.ALBPKIProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pki_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBPKIProfile
	if methodResult.IsSuccess() {
...
func (aIface *albPkiProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBPKIProfileApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pki_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBPKIProfileApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albPkiProfilesClient) Patch(albPkiprofileIdParam string, aLBPKIProfileParam model.ALBPKIProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pki_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albPkiProfilesClient) Update(albPkiprofileIdParam string, aLBPKIProfileParam model.ALBPKIProfile) (model.ALBPKIProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_pki_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBPKIProfile
	if methodResult.IsSuccess() {
