...
type PluginProfilesClient interface {
	...
	//
	// @param appliedToGroupPathParam The path of the Policy group. (optional)
	...
	// @param pluginPathParam The Policy path of the Sha plugin. (optional)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(appliedToGroupPathParam *string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, pluginPathParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ShaPluginProfileListResult, error)
}
...
func (pIface *pluginProfilesClient) List(appliedToGroupPathParam *string, cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, pluginPathParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.ShaPluginProfileListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
