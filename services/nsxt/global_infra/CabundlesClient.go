...
func NewCabundlesClient(connector client.Connector) *cabundlesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.cabundles")
...
func (cIface *cabundlesClient) Delete(cabundleIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.cabundles", "delete", inputDataValue, executionContext)
...
func (cIface *cabundlesClient) Get(cabundleIdParam string) (model.CaBundle, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.cabundles", "get", inputDataValue, executionContext)
	var emptyOutput model.CaBundle
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (model.CaBundleListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.cabundles", "list", inputDataValue, executionContext)
	var emptyOutput model.CaBundleListResult
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) Patch(cabundleIdParam string, caBundlePemDataParam model.CaBundlePemData) (model.CaBundle, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.cabundles", "patch", inputDataValue, executionContext)
	var emptyOutput model.CaBundle
	if methodResult.IsSuccess() {
...
func (cIface *cabundlesClient) Update(cabundleIdParam string, caBundlePemDataParam model.CaBundlePemData) (model.CaBundle, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.cabundles", "update", inputDataValue, executionContext)
	var emptyOutput model.CaBundle
	if methodResult.IsSuccess() {
