...
func NewStatusesClient(connector client.Connector) *statusesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.livetraces.statuses")
...
func (sIface *statusesClient) List(enforcementPointPathParam *string) (model.LiveTraceListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces.statuses", "list", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceListResult
