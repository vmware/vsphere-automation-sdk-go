...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.livetraces.status")
...
func (sIface *statusClient) Get(livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces.status", "get", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceStatus
