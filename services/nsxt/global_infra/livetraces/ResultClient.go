...
func NewResultClient(connector client.Connector) *resultClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.livetraces.result")
...
func (rIface *resultClient) Get(livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.livetraces.result", "get", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceResult
