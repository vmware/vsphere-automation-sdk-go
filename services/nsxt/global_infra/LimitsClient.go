...
type LimitsClient interface {
	...
	Delete(limitIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(limitIdParam string) (nsx_policyModel.Limit, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LimitListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(limitIdParam string, limitParam nsx_policyModel.Limit) (nsx_policyModel.Limit, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(limitIdParam string, limitParam nsx_policyModel.Limit) (nsx_policyModel.Limit, error)
}
...
func NewLimitsClient(connector vapiProtocolClient_.Connector) *limitsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.limits")
...
func (lIface *limitsClient) Delete(limitIdParam string) error {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.limits", "delete", inputDataValue, executionContext)
...
func (lIface *limitsClient) Get(limitIdParam string) (nsx_policyModel.Limit, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.limits", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Limit
	if methodResult.IsSuccess() {
...
func (lIface *limitsClient) List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.LimitListResult, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.limits", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.LimitListResult
	if methodResult.IsSuccess() {
...
func (lIface *limitsClient) Patch(limitIdParam string, limitParam nsx_policyModel.Limit) (nsx_policyModel.Limit, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.limits", "patch", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Limit
	if methodResult.IsSuccess() {
...
func (lIface *limitsClient) Update(limitIdParam string, limitParam nsx_policyModel.Limit) (nsx_policyModel.Limit, error) {
	typeConverter := lIface.connector.TypeConverter()
	executionContext := lIface.connector.NewExecutionContext()
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.limits", "update", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.Limit
	if methodResult.IsSuccess() {
