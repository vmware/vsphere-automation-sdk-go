...
func NewAlbVsVipsClient(connector client.Connector) *albVsVipsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_vs_vips")
...
func (aIface *albVsVipsClient) Delete(albVsvipIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_vs_vips", "delete", inputDataValue, executionContext)
...
func (aIface *albVsVipsClient) Get(albVsvipIdParam string) (model.ALBVsVip, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_vs_vips", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBVsVip
	if methodResult.IsSuccess() {
...
func (aIface *albVsVipsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBVsVipApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_vs_vips", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBVsVipApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albVsVipsClient) Patch(albVsvipIdParam string, aLBVsVipParam model.ALBVsVip) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_vs_vips", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albVsVipsClient) Update(albVsvipIdParam string, aLBVsVipParam model.ALBVsVip) (model.ALBVsVip, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_vs_vips", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBVsVip
	if methodResult.IsSuccess() {
