...
func NewLbServiceUsageSummaryClient(connector client.Connector) *lbServiceUsageSummaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.lb_service_usage_summary")
...
func (lIface *lbServiceUsageSummaryClient) Get(includeUsagesParam *bool) (model.LBServiceUsageSummary, error) {
	...
	methodResult := lIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.lb_service_usage_summary", "get", inputDataValue, executionContext)
	var emptyOutput model.LBServiceUsageSummary
