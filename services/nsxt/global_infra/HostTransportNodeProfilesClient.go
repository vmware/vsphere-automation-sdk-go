...
func NewHostTransportNodeProfilesClient(connector client.Connector) *hostTransportNodeProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.host_transport_node_profiles")
...
func (hIface *hostTransportNodeProfilesClient) Delete(transportNodeProfileIdParam string) error {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.host_transport_node_profiles", "delete", inputDataValue, executionContext)
...
func (hIface *hostTransportNodeProfilesClient) Get(hostTransportNodeProfileIdParam string) (model.PolicyHostTransportNodeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	hIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.host_transport_node_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyHostTransportNodeProfile
	if methodResult.IsSuccess() {
...
func (hIface *hostTransportNodeProfilesClient) List(cursorParam *string, includeSystemOwnedParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyHostTransportNodeProfileListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	hIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.host_transport_node_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyHostTransportNodeProfileListResult
	if methodResult.IsSuccess() {
...
func (hIface *hostTransportNodeProfilesClient) Update(transportNodeProfileIdParam string, policyHostTransportNodeProfileParam model.PolicyHostTransportNodeProfile) (model.PolicyHostTransportNodeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	hIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.host_transport_node_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyHostTransportNodeProfile
	if methodResult.IsSuccess() {
