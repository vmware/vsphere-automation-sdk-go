...
func NewAlbDnsPoliciesClient(connector client.Connector) *albDnsPoliciesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_dns_policies")
...
func (aIface *albDnsPoliciesClient) Delete(albDnspolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_dns_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albDnsPoliciesClient) Get(albDnspolicyIdParam string) (model.ALBDnsPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_dns_policies", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBDnsPolicy
	if methodResult.IsSuccess() {
...
func (aIface *albDnsPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBDnsPolicyApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_dns_policies", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBDnsPolicyApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albDnsPoliciesClient) Patch(albDnspolicyIdParam string, aLBDnsPolicyParam model.ALBDnsPolicy) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_dns_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albDnsPoliciesClient) Update(albDnspolicyIdParam string, aLBDnsPolicyParam model.ALBDnsPolicy) (model.ALBDnsPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_dns_policies", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBDnsPolicy
	if methodResult.IsSuccess() {
