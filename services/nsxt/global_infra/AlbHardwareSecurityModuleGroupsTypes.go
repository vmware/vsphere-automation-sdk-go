...
func albHardwareSecurityModuleGroupsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/alb-hardware-security-module-groups/{albHardwaresecuritymodulegroupId}",
		"",
		resultHeaders,
		204,
		"",
...
func albHardwareSecurityModuleGroupsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/alb-hardware-security-module-groups",
		"",
		resultHeaders,
		200,
		"",
