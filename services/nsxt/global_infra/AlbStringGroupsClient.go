...
func NewAlbStringGroupsClient(connector client.Connector) *albStringGroupsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_string_groups")
...
func (aIface *albStringGroupsClient) Delete(albStringgroupIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_string_groups", "delete", inputDataValue, executionContext)
...
func (aIface *albStringGroupsClient) Get(albStringgroupIdParam string) (model.ALBStringGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_string_groups", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBStringGroup
	if methodResult.IsSuccess() {
...
func (aIface *albStringGroupsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBStringGroupApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_string_groups", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBStringGroupApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albStringGroupsClient) Patch(albStringgroupIdParam string, aLBStringGroupParam model.ALBStringGroup) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_string_groups", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albStringGroupsClient) Update(albStringgroupIdParam string, aLBStringGroupParam model.ALBStringGroup) (model.ALBStringGroup, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_string_groups", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBStringGroup
	if methodResult.IsSuccess() {
