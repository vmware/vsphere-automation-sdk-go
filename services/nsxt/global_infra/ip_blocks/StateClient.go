...
type StateClient interface {
	...
	Get(intentPathParam string) (nsx_policyModel.IpAddressBlockState, error)
}
...
func NewStateClient(connector vapiProtocolClient_.Connector) *stateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.ip_blocks.state")
...
func (sIface *stateClient) Get(intentPathParam string) (nsx_policyModel.IpAddressBlockState, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ip_blocks.state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockState
