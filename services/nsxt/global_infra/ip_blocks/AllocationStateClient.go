...
func NewAllocationStateClient(connector vapiProtocolClient_.Connector) *allocationStateClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.ip_blocks.allocation_state")
...
func (aIface *allocationStateClient) Get(ipBlockIdParam string, cidrParam *string, includeWorkloadDetailsParam *bool) (nsx_policyModel.IpAddressBlockAllocationState, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ip_blocks.allocation_state", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockAllocationState
...
func (aIface *allocationStateClient) List(cidrParam *string, cursorParam *string, includeWorkloadDetailsParam *bool, includedFieldsParam *string, ipAddressBlockPathParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IpAddressBlockAllocationStateList, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ip_blocks.allocation_state", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IpAddressBlockAllocationStateList
	if methodResult.IsSuccess() {
