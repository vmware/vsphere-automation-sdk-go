...
func NewAlbWafProfilesClient(connector client.Connector) *albWafProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_waf_profiles")
...
func (aIface *albWafProfilesClient) Delete(albWafprofileIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_profiles", "delete", inputDataValue, executionContext)
...
func (aIface *albWafProfilesClient) Get(albWafprofileIdParam string) (model.ALBWafProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBWafProfile
	if methodResult.IsSuccess() {
...
func (aIface *albWafProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBWafProfileApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBWafProfileApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albWafProfilesClient) Patch(albWafprofileIdParam string, aLBWafProfileParam model.ALBWafProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albWafProfilesClient) Update(albWafprofileIdParam string, aLBWafProfileParam model.ALBWafProfile) (model.ALBWafProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBWafProfile
	if methodResult.IsSuccess() {
