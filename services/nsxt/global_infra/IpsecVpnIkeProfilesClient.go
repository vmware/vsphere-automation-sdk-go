...
func NewIpsecVpnIkeProfilesClient(connector client.Connector) *ipsecVpnIkeProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles")
...
func (iIface *ipsecVpnIkeProfilesClient) Delete(ikeProfileIdParam string) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipsecVpnIkeProfilesClient) Get(ikeProfileIdParam string) (model.IPSecVpnIkeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnIkeProfile
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnIkeProfilesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IPSecVpnIkeProfileListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnIkeProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipsecVpnIkeProfilesClient) Patch(ikeProfileIdParam string, ipSecVpnIkeProfileParam model.IPSecVpnIkeProfile) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipsecVpnIkeProfilesClient) Update(ikeProfileIdParam string, ipSecVpnIkeProfileParam model.IPSecVpnIkeProfile) (model.IPSecVpnIkeProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.ipsec_vpn_ike_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.IPSecVpnIkeProfile
	if methodResult.IsSuccess() {
