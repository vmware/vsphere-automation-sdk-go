...
type ThresholdConfigsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsThresholdConfigListResult, error)
}
...
func NewThresholdConfigsClient(connector vapiProtocolClient_.Connector) *thresholdConfigsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures.threshold_configs")
...
func (tIface *thresholdConfigsClient) Get(signatureIdParam string) (nsx_policyModel.IdsThresholdConfig, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures.threshold_configs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsThresholdConfig
...
func (tIface *thresholdConfigsClient) List(cursorParam *string, includeConflictsParam *bool, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.IdsThresholdConfigListResult, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures.threshold_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.IdsThresholdConfigListResult
	if methodResult.IsSuccess() {
