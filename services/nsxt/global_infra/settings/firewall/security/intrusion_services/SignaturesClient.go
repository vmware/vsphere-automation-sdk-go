...
func NewSignaturesClient(connector client.Connector) *signaturesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.signatures")
...
func (sIface *signaturesClient) Updatesignatures() error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.signatures", "updatesignatures", inputDataValue, executionContext)
