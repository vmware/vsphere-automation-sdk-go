...
func customSignaturesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/custom-signature-versions/{versionId}/custom-signatures/{sigId}",
		"",
		resultHeaders,
		200,
		"",
...
func customSignaturesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/custom-signature-versions/{versionId}/custom-signatures",
		"",
		resultHeaders,
		200,
		"",
