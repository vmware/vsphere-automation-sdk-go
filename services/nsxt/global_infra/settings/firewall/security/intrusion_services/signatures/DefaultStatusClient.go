...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.signatures.status"
...
func (sIface *DefaultStatusClient) Get() (model.IdsSignatureStatus, error) {
