...
func (mIface *membersCountClient) Get() (nsx_policyModel.FirewallExcludeListMembersCountListResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.exclude_list.members_count", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.FirewallExcludeListMembersCountListResult
