...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.settings.firewall.idfw.compute_collections.transport_nodes.status"
...
func (sIface *DefaultStatusClient) List(computeCollectionIdParam string, enforcementPointPathParam *string) (model.IdfwTransportNodeStatusListResult, error) {
