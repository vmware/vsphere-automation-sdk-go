...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/idfw/compute-collections/{computeCollectionId}/status",
		"",
		resultHeaders,
		200,
		"",
...
func statusListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/idfw/compute-collections/status",
		"",
		resultHeaders,
		200,
		"",
