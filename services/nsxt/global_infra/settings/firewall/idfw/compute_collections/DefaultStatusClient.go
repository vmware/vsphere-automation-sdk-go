...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.settings.firewall.idfw.compute_collections.status"
...
func (sIface *DefaultStatusClient) Get(computeCollectionIdParam string, enforcementPointPathParam *string) (model.IdfwComputeCollectionStatus, error) {
...
func (sIface *DefaultStatusClient) List(enforcementPointPathParam *string) (model.IdfwComputeCollectionListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
