...
func NewClusterClient(connector client.Connector) *clusterClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster")
...
func (cIface *clusterClient) Delete(clusterIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster", "delete", inputDataValue, executionContext)
...
func (cIface *clusterClient) Get(clusterIdParam string) (model.ComputeClusterIdfwConfiguration, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster", "get", inputDataValue, executionContext)
	var emptyOutput model.ComputeClusterIdfwConfiguration
	if methodResult.IsSuccess() {
...
func (cIface *clusterClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ComputeClusterIdfwConfigurationListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster", "list", inputDataValue, executionContext)
	var emptyOutput model.ComputeClusterIdfwConfigurationListResult
	if methodResult.IsSuccess() {
...
func (cIface *clusterClient) Patch(clusterIdParam string, computeClusterIdfwConfigurationParam model.ComputeClusterIdfwConfiguration) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *clusterClient) Update(clusterIdParam string, computeClusterIdfwConfigurationParam model.ComputeClusterIdfwConfiguration) (model.ComputeClusterIdfwConfiguration, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.idfw.cluster", "update", inputDataValue, executionContext)
	var emptyOutput model.ComputeClusterIdfwConfiguration
	if methodResult.IsSuccess() {
