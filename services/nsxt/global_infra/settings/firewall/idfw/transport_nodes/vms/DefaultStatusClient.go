...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_policy.global_infra.settings.firewall.idfw.transport_nodes.vms.status"
...
func (sIface *DefaultStatusClient) List(transportNodeIdParam string, enforcementPointPathParam *string) (model.IdfwVirtualMachineStatusListResult, error) {
