...
func NewAlbWafPoliciesClient(connector client.Connector) *albWafPoliciesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.alb_waf_policies")
...
func (aIface *albWafPoliciesClient) Delete(albWafpolicyIdParam string, forceParam *bool) error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_policies", "delete", inputDataValue, executionContext)
...
func (aIface *albWafPoliciesClient) Get(albWafpolicyIdParam string) (model.ALBWafPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_policies", "get", inputDataValue, executionContext)
	var emptyOutput model.ALBWafPolicy
	if methodResult.IsSuccess() {
...
func (aIface *albWafPoliciesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ALBWafPolicyApiResponse, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_policies", "list", inputDataValue, executionContext)
	var emptyOutput model.ALBWafPolicyApiResponse
	if methodResult.IsSuccess() {
...
func (aIface *albWafPoliciesClient) Patch(albWafpolicyIdParam string, aLBWafPolicyParam model.ALBWafPolicy) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), aIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (aIface *albWafPoliciesClient) Update(albWafpolicyIdParam string, aLBWafPolicyParam model.ALBWafPolicy) (model.ALBWafPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.alb_waf_policies", "update", inputDataValue, executionContext)
	var emptyOutput model.ALBWafPolicy
	if methodResult.IsSuccess() {
