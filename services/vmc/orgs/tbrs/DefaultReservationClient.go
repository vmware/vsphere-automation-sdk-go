...
func (rIface *DefaultReservationClient) Post(orgParam string, sddcStateParam *model.SddcStateRequest) ([]model.ReservationWindow, error) {
	...
	if inputError != nil {
		var emptyOutput []model.ReservationWindow
	...
	if methodResult.IsSuccess() {
		...
		return output.([]model.ReservationWindow), nil
	} else {
