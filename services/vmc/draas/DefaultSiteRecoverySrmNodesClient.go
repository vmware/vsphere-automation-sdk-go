...
/*
 * Client stubs for service: SiteRecoverySrmNodes
 * Functions that implement the generated SiteRecoverySrmNodesClient interface
 */
...
type DefaultSiteRecoverySrmNodesClient struct {
...
func NewDefaultSiteRecoverySrmNodesClient(connector client.Connector) *DefaultSiteRecoverySrmNodesClient {
	interfaceName := "com.vmware.vmc.draas.site_recovery_srm_nodes"
	...
	sIface := DefaultSiteRecoverySrmNodesClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
...
func (sIface *DefaultSiteRecoverySrmNodesClient) Delete(orgParam string, sddcParam string, srmNodeParam string) (model.Task, error) {
...
func (sIface *DefaultSiteRecoverySrmNodesClient) Post(orgParam string, sddcParam string, provisionSrmConfigParam *model.ProvisionSrmConfig) (model.Task, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *DefaultSiteRecoverySrmNodesClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := sIface.connector.GetApiProvider().Invoke(sIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (sIface *DefaultSiteRecoverySrmNodesClient) deleteMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(sIface.interfaceName)
	typeConverter := sIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(siteRecoverySrmNodesDeleteInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(siteRecoverySrmNodesDeleteOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's errors.Unauthenticated error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's errors.InvalidRequest error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's errors.Unauthorized error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.delete method's errors.NotFound error - %s",
...
func (sIface *DefaultSiteRecoverySrmNodesClient) postMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(sIface.interfaceName)
	typeConverter := sIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(siteRecoverySrmNodesPostInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(siteRecoverySrmNodesPostOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's output - %s",
			bindings.VAPIerrorsToError(outputError).Error())
		return nil
	}
	...
	errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.UnauthenticatedBindingType())
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's errors.Unauthenticated error - %s",
			bindings.VAPIerrorsToError(errError1).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	...
	errDef2, errError2 := typeConverter.ConvertToDataDefinition(errors.InvalidRequestBindingType())
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's errors.InvalidRequest error - %s",
			bindings.VAPIerrorsToError(errError2).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	...
	errDef3, errError3 := typeConverter.ConvertToDataDefinition(errors.UnauthorizedBindingType())
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's errors.Unauthorized error - %s",
			bindings.VAPIerrorsToError(errError3).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	...
	errDef4, errError4 := typeConverter.ConvertToDataDefinition(errors.NotFoundBindingType())
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultSiteRecoverySrmNodesClient.post method's errors.NotFound error - %s",
			bindings.VAPIerrorsToError(errError4).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
