...
/*
 * Data type definitions file for service: Stop.
...
func stopPostInputType() bindings.StructType {
...
func stopPostOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TaskBindingType)
}

func stopPostRestMetadata() protocol.OperationRestMetadata {
