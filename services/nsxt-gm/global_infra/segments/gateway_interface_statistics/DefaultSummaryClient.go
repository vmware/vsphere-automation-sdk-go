...
func NewDefaultSummaryClient(connector client.Connector) *DefaultSummaryClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.gateway_interface_statistics.summary"
...
func (sIface *DefaultSummaryClient) Get(segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyInterfaceStatisticsSummary, error) {
