...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.dhcp_static_bindings.state"
...
func (sIface *DefaultStateClient) Get(segmentIdParam string, bindingIdParam string) (model.DhcpStaticBindingState, error) {
