...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.ports.state"
...
func (sIface *DefaultStateClient) Get(segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.SegmentPortState, error) {
