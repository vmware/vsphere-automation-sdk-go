...
func NewDefaultMirrorStackStatusClient(connector client.Connector) *DefaultMirrorStackStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.ports.port_monitoring_profile_binding_maps.mirror_stack_status"
...
func (mIface *DefaultMirrorStackStatusClient) List(infraSegmentIdParam string, infraPortIdParam string, portMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.MirrorStackStatusListResult, error) {
