...
func NewDefaultMacTableClient(connector client.Connector) *DefaultMacTableClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.ports.mac_table"
...
func (mIface *DefaultMacTableClient) List(segmentIdParam string, portIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.SegmentPortMacAddressListResult, error) {
