...
func NewDefaultSiteSpanInfoClient(connector client.Connector) *DefaultSiteSpanInfoClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.segments.inter_site_forwarder.site_span_info"
...
func (sIface *DefaultSiteSpanInfoClient) Get(segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SegmentL2ForwarderSiteSpanInfo, error) {
