...
func NewDefaultNslookupClient(connector client.Connector) *DefaultNslookupClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder.nslookup"
...
func (nIface *DefaultNslookupClient) Get(tier1IdParam string, addressParam *string, enforcementPointPathParam *string) (model.AggregatePolicyDnsAnswer, error) {
