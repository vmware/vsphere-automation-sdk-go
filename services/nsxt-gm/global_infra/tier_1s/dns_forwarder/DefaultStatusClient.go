...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.dns_forwarder.status"
...
func (sIface *DefaultStatusClient) Get(tier1IdParam string, enforcementPointPathParam *string) (model.AggregateDNSForwarderStatus, error) {
