...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.segments.ports.statistics"
...
func (sIface *DefaultStatisticsClient) Get(tier1IdParam string, segmentsIdParam string, portIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SegmentPortStatistics, error) {
