...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.segments.ports.state"
...
func (sIface *DefaultStateClient) Get(tier1IdParam string, segmentIdParam string, portIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.SegmentPortState, error) {
