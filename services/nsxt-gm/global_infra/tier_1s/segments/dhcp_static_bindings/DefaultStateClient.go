...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_1s.segments.dhcp_static_bindings.state"
...
func (sIface *DefaultStateClient) Get(tier1IdParam string, segmentIdParam string, bindingIdParam string) (model.DhcpStaticBindingState, error) {
