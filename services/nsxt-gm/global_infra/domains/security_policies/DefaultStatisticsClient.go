...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.security_policies.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, securityPolicyIdParam string, enforcementPointPathParam *string) (model.SecurityPolicyStatisticsListResult, error) {
