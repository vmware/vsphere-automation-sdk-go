...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.security_policies.rules.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, securityPolicyIdParam string, ruleIdParam string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error) {
