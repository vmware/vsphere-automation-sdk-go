...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.gateway_policies.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, gatewayPolicyIdParam string, enforcementPointPathParam *string) (model.SecurityPolicyStatisticsListResult, error) {
