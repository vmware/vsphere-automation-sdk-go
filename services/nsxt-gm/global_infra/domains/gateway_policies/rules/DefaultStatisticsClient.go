...
func NewDefaultStatisticsClient(connector client.Connector) *DefaultStatisticsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.gateway_policies.rules.statistics"
...
func (sIface *DefaultStatisticsClient) List(domainIdParam string, gatewayPolicyIdParam string, ruleIdParam string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error) {
