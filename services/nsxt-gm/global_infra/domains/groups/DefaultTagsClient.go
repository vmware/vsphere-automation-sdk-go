...
func NewDefaultTagsClient(connector client.Connector) *DefaultTagsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.tags"
...
func (tIface *DefaultTagsClient) Get(domainIdParam string, groupIdParam string) (model.GroupTagsList, error) {
...
func (tIface *DefaultTagsClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultTagsClient.get method's errors.InvalidRequest error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultTagsClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultTagsClient.get method's errors.InternalServerError error - %s",
