...
func NewDefaultMirrorStackStatusClient(connector client.Connector) *DefaultMirrorStackStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.group_monitoring_profile_binding_maps.mirror_stack_status"
