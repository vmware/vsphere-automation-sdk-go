...
func NewDefaultVifsClient(connector client.Connector) *DefaultVifsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.members.vifs"
...
func (vIface *DefaultVifsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.VirtualNetworkInterfaceListResult, error) {
