...
func NewDefaultVirtualMachinesClient(connector client.Connector) *DefaultVirtualMachinesClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.members.virtual_machines"
...
func (vIface *DefaultVirtualMachinesClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RealizedVirtualMachineListResult, error) {
