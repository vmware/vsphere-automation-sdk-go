...
/*
 * Client stubs for service: ConsolidatedEffectiveIpAddresses
 * Functions that implement the generated ConsolidatedEffectiveIpAddressesClient interface
 */
...
type DefaultConsolidatedEffectiveIpAddressesClient struct {
...
func NewDefaultConsolidatedEffectiveIpAddressesClient(connector client.Connector) *DefaultConsolidatedEffectiveIpAddressesClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.members.consolidated_effective_ip_addresses"
	...
	cIface := DefaultConsolidatedEffectiveIpAddressesClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
	cIface.methodNameToDefMap = make(map[string]*core.MethodDefinition)
	cIface.methodNameToDefMap["list"] = cIface.listMethodDefinition()
	return &cIface
}

func (cIface *DefaultConsolidatedEffectiveIpAddressesClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, ipFilterParam *string, pageSizeParam *int64, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (model.ConsolidatedEffectiveIPAddressMemberListResult, error) {
...
func (cIface *DefaultConsolidatedEffectiveIpAddressesClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := cIface.connector.GetApiProvider().Invoke(cIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (cIface *DefaultConsolidatedEffectiveIpAddressesClient) listMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(cIface.interfaceName)
	typeConverter := cIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(consolidatedEffectiveIpAddressesListInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(consolidatedEffectiveIpAddressesListOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConsolidatedEffectiveIpAddressesClient.list method's errors.NotFound error - %s",
