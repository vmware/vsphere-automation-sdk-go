...
func NewDefaultSegmentsClient(connector client.Connector) *DefaultSegmentsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.domains.groups.members.segments"
...
func (sIface *DefaultSegmentsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyGroupMembersListResult, error) {
