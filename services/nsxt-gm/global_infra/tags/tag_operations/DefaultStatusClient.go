...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tags.tag_operations.status"
...
func (sIface *DefaultStatusClient) Get(operationIdParam string) (model.TagBulkOperationStatus, error) {
