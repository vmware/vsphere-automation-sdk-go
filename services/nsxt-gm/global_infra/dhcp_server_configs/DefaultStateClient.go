...
func NewDefaultStateClient(connector client.Connector) *DefaultStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.dhcp_server_configs.state"
...
func (sIface *DefaultStateClient) Get(configIdParam string, connectivityPathParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DhcpServerState, error) {
