...
func NewDefaultBindingsClient(connector client.Connector) *DefaultBindingsClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.session_timer_profiles.bindings"
...
func (bIface *DefaultBindingsClient) List(sessionTimerProfileIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SessionTimerProfileBindingListResult, error) {
