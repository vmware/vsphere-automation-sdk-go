...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.sites.onboarding.status"
...
func (sIface *DefaultStatusClient) Get(siteIdParam string) (model.ConfigOnboardingStatus, error) {
