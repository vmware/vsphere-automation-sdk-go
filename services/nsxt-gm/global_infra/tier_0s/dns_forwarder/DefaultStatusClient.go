...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.dns_forwarder.status"
...
func (sIface *DefaultStatusClient) Get(tier0IdParam string, enforcementPointPathParam *string) (model.AggregateDNSForwarderStatus, error) {
