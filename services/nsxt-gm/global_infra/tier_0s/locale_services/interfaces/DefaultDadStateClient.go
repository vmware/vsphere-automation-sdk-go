...
func NewDefaultDadStateClient(connector client.Connector) *DefaultDadStateClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.interfaces.dad_state"
...
func (dIface *DefaultDadStateClient) Get(tier0IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string) (model.InterfaceDADState, error) {
