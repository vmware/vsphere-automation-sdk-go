...
func NewDefaultArpProxyClient(connector client.Connector) *DefaultArpProxyClient {
	interfaceName := "com.vmware.nsx_global_policy.global_infra.tier_0s.locale_services.interfaces.arp_proxy"
...
func (aIface *DefaultArpProxyClient) List(tier0IdParam string, localeServiceIdParam string, interfaceIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.PolicyArpProxyTableListResult, error) {
