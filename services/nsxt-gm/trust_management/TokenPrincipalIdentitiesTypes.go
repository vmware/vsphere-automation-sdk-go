...
func tokenPrincipalIdentitiesCreateRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"POST",
		"/global-manager/api/v1/trust-management/token-principal-identities",
		"",
		resultHeaders,
		201,
		"",
...
func tokenPrincipalIdentitiesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/trust-management/token-principal-identities/{principalIdentityId}",
		"",
		resultHeaders,
		204,
		"",
