...
func NewCrlsClient(connector client.Connector) *crlsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.trust_management.crls")
...
func (cIface *crlsClient) Delete(crlIdParam string) error {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.crls", "delete", inputDataValue, executionContext)
...
func (cIface *crlsClient) Get(crlIdParam string, detailsParam *bool) (model.Crl, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.crls", "get", inputDataValue, executionContext)
	var emptyOutput model.Crl
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) Importcrl(crlObjectDataParam model.CrlObjectData) (model.CrlList, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.crls", "importcrl", inputDataValue, executionContext)
	var emptyOutput model.CrlList
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) List(cursorParam *string, detailsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (model.CrlList, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.crls", "list", inputDataValue, executionContext)
	var emptyOutput model.CrlList
	if methodResult.IsSuccess() {
...
func (cIface *crlsClient) Update(crlIdParam string, crlParam model.Crl) (model.Crl, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.crls", "update", inputDataValue, executionContext)
	var emptyOutput model.Crl
	if methodResult.IsSuccess() {
