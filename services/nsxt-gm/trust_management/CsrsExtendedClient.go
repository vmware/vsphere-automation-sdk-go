...
func NewCsrsExtendedClient(connector client.Connector) *csrsExtendedClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.trust_management.csrs_extended")
...
func (cIface *csrsExtendedClient) Create(csrExtParam model.CsrExt) (model.Csr, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.trust_management.csrs_extended", "create", inputDataValue, executionContext)
	var emptyOutput model.Csr
