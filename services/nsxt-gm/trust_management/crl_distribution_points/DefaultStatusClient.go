...
func NewDefaultStatusClient(connector client.Connector) *DefaultStatusClient {
	interfaceName := "com.vmware.nsx_global_policy.trust_management.crl_distribution_points.status"
...
func (sIface *DefaultStatusClient) Get(crlDistributionPointIdParam string) (model.CrlDistributionPointStatus, error) {
