...
type ObjectPermissionsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, inheritanceDisabledParam *bool, pageSizeParam *int64, pathPrefixParam *string, roleNameParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ObjectRolePermissionGroupListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(objectRolePermissionGroupParam nsx_global_policyModel.ObjectRolePermissionGroup) error
}
...
func NewObjectPermissionsClient(connector vapiProtocolClient_.Connector) *objectPermissionsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_global_policy.aaa.object_permissions")
...
func (oIface *objectPermissionsClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, inheritanceDisabledParam *bool, pageSizeParam *int64, pathPrefixParam *string, roleNameParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_global_policyModel.ObjectRolePermissionGroupListResult, error) {
	typeConverter := oIface.connector.TypeConverter()
	executionContext := oIface.connector.NewExecutionContext()
	...
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput nsx_global_policyModel.ObjectRolePermissionGroupListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(nsx_global_policyModel.ObjectRolePermissionGroupListResult), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), oIface.GetErrorBindingType(methodResult.Error().Name()))
		if errorInError != nil {
...
func (oIface *objectPermissionsClient) Patch(objectRolePermissionGroupParam nsx_global_policyModel.ObjectRolePermissionGroup) error {
	typeConverter := oIface.connector.TypeConverter()
	executionContext := oIface.connector.NewExecutionContext()
