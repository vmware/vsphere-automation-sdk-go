...
func NewDefaultGroupsClient(connector client.Connector) *DefaultGroupsClient {
	interfaceName := "com.vmware.nsx_global_policy.aaa.vidm.groups"
...
func (gIface *DefaultGroupsClient) List(searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.VidmInfoListResult, error) {
