...
/*
 * Client stubs for service: RolesWithFeaturePermissions
 * Functions that implement the generated RolesWithFeaturePermissionsClient interface
 */
...
type DefaultRolesWithFeaturePermissionsClient struct {
...
func NewDefaultRolesWithFeaturePermissionsClient(connector client.Connector) *DefaultRolesWithFeaturePermissionsClient {
	interfaceName := "com.vmware.nsx_global_policy.aaa.roles_with_feature_permissions"
	...
	rIface := DefaultRolesWithFeaturePermissionsClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
...
func (rIface *DefaultRolesWithFeaturePermissionsClient) List(cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RoleWithFeaturesListResult, error) {
...
func (rIface *DefaultRolesWithFeaturePermissionsClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := rIface.connector.GetApiProvider().Invoke(rIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (rIface *DefaultRolesWithFeaturePermissionsClient) listMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(rIface.interfaceName)
	typeConverter := rIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(rolesWithFeaturePermissionsListInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(rolesWithFeaturePermissionsListOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultRolesWithFeaturePermissionsClient.list method's errors.NotFound error - %s",
