...
/*
 * Client stubs for service: FeaturesWithProperties
 * Functions that implement the generated FeaturesWithPropertiesClient interface
 */
...
type DefaultFeaturesWithPropertiesClient struct {
...
func NewDefaultFeaturesWithPropertiesClient(connector client.Connector) *DefaultFeaturesWithPropertiesClient {
	interfaceName := "com.vmware.nsx_global_policy.aaa.features_with_properties"
	...
	fIface := DefaultFeaturesWithPropertiesClient{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
...
func (fIface *DefaultFeaturesWithPropertiesClient) List() (model.FeaturePermissionListResult, error) {
...
func (fIface *DefaultFeaturesWithPropertiesClient) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := fIface.connector.GetApiProvider().Invoke(fIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (fIface *DefaultFeaturesWithPropertiesClient) listMethodDefinition() *core.MethodDefinition {
	interfaceIdentifier := core.NewInterfaceIdentifier(fIface.interfaceName)
	typeConverter := fIface.connector.TypeConverter()

	input, inputError := typeConverter.ConvertToDataDefinition(featuresWithPropertiesListInputType())
	output, outputError := typeConverter.ConvertToDataDefinition(featuresWithPropertiesListOutputType())
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's errors.InvalidRequest error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's errors.Unauthorized error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's errors.InternalServerError error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultFeaturesWithPropertiesClient.list method's errors.NotFound error - %s",
