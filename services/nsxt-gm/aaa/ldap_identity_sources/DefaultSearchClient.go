...
func NewDefaultSearchClient(connector client.Connector) *DefaultSearchClient {
	interfaceName := "com.vmware.nsx_global_policy.aaa.ldap_identity_sources.search"
...
func (sIface *DefaultSearchClient) Create(ldapIdentitySourceIdParam string, filterValueParam *string) (model.LdapIdentitySourceSearchResultList, error) {
