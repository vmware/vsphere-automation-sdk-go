...
func NewDefaultHistoryClient(connector client.Connector) *DefaultHistoryClient {
	interfaceName := "com.vmware.nsx_global_policy.cluster.backups.history"
...
func (hIface *DefaultHistoryClient) Get() (model.BackupOperationHistory, error) {
...
func (hIface *DefaultHistoryClient) getMethodDefinition() *core.MethodDefinition {
	...
	hIface.errorBindingMap[errors.InvalidRequest{}.Error()] = errors.InvalidRequestBindingType()
	errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.InvalidRequestBindingType())
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultHistoryClient.get method's errors.InvalidRequest error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultHistoryClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultHistoryClient.get method's errors.InternalServerError error - %s",
