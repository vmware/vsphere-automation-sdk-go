...
func NewDefaultConfigClient(connector client.Connector) *DefaultConfigClient {
	interfaceName := "com.vmware.nsx_global_policy.cluster.backups.config"
...
func (cIface *DefaultConfigClient) Get() (model.BackupConfiguration, error) {
...
func (cIface *DefaultConfigClient) Update(backupConfigurationParam model.BackupConfiguration, frameTypeParam *string, siteIdParam *string) (model.BackupConfiguration, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *DefaultConfigClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConfigClient.get method's errors.ServiceUnavailable error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConfigClient.get method's errors.InternalServerError error - %s",
...
func (cIface *DefaultConfigClient) updateMethodDefinition() *core.MethodDefinition {
	...
	errDef3, errError3 := typeConverter.ConvertToDataDefinition(errors.ServiceUnavailableBindingType())
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConfigClient.update method's errors.ServiceUnavailable error - %s",
			bindings.VAPIerrorsToError(errError3).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	...
	errDef4, errError4 := typeConverter.ConvertToDataDefinition(errors.InternalServerErrorBindingType())
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultConfigClient.update method's errors.InternalServerError error - %s",
			bindings.VAPIerrorsToError(errError4).Error())
		return nil
	}
	errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
