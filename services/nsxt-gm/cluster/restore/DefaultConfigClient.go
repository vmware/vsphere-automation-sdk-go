...
func NewDefaultConfigClient(connector client.Connector) *DefaultConfigClient {
	interfaceName := "com.vmware.nsx_global_policy.cluster.restore.config"
...
func (cIface *DefaultConfigClient) Get() (model.RestoreConfiguration, error) {
...
func (cIface *DefaultConfigClient) Update(restoreConfigurationParam model.RestoreConfiguration) (model.RestoreConfiguration, error) {
	typeConverter := cIface.connector.TypeConverter()
