...
type oAuthRefreshTokenDetails struct {
	cspURL       string
	refreshToken string
}

func (oad oAuthRefreshTokenDetails) CSPURL() string {
	return oad.cspURL
}

func (oad oAuthRefreshTokenDetails) RefreshToken() string {
	return oad.refreshToken
}

func (oad oAuthRefreshTokenDetails) GetAuthScheme() scheme.Scheme {
	return scheme.OAuthRefreshToken
}

func (oad oAuthRefreshTokenDetails) GetAuthInterface() interface{} {
	return Auth(oad)
}

func (oad oAuthRefreshTokenDetails) GetSecurityContext() (core.SecurityContext, error) {
