...
func (rIface *RetentionPlansClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(rIface.interfaceName)
}

func (rIface *RetentionPlansClientImpl) Definition() core.InterfaceDefinition {
    return rIface.interfaceDefinition
}

func (rIface *RetentionPlansClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (rIface *RetentionPlansClientImpl) GetDefault() (Info, error) {
