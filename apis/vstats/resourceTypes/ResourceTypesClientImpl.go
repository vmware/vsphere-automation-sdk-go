...
func (rIface *ResourceTypesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(rIface.interfaceName)
}

func (rIface *ResourceTypesClientImpl) Definition() core.InterfaceDefinition {
    return rIface.interfaceDefinition
}

func (rIface *ResourceTypesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (rIface *ResourceTypesClientImpl) List() ([]Summary, error) {
