...
func (eIface *EndorsementKeysClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(eIface.interfaceName)
}

func (eIface *EndorsementKeysClientImpl) Definition() core.InterfaceDefinition {
    return eIface.interfaceDefinition
}

func (eIface *EndorsementKeysClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (eIface *EndorsementKeysClientImpl) List() ([]Summary, error) {
...
func (eIface *EndorsementKeysClientImpl) Create(specParam CreateSpec) error {
	typeConverter := eIface.connector.TypeConverter()
...
func (eIface *EndorsementKeysClientImpl) Get(nameParam string) (Info, error) {
	typeConverter := eIface.connector.TypeConverter()
