...
func InfoBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.kms.providers.client_certificate.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func GetSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.kms.providers.client_certificate.get_spec",fields, reflect.TypeOf(GetSpec{}), fieldNameMap, validators)
}
...
func SetSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["private_key"] = "PrivateKey"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.kms.providers.client_certificate.set_spec",fields, reflect.TypeOf(SetSpec{}), fieldNameMap, validators)
}
