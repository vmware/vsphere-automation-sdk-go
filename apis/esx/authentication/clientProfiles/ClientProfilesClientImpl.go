...
func (cIface *ClientProfilesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ClientProfilesClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ClientProfilesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ClientProfilesClientImpl) List(filterParam *FilterSpec, projectionParam *SummaryType) ([]Summary, error) {
...
func (cIface *ClientProfilesClientImpl) Create(specParam CreateSpec) (string, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ClientProfilesClientImpl) Get(profileParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ClientProfilesClientImpl) Update(profileParam string, specParam UpdateSpec) error {
	typeConverter := cIface.connector.TypeConverter()
