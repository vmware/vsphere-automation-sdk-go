 ...
 *
 * Data type definitions file for service: Tagging.
...
// Defines a key/value pair that can be associated with a library item
 type Info struct {
    Key string
    Value *string
}
...
func getOutputType() bindings.BindingType {
    return bindings.NewOptionalType(bindings.NewStringType())
}
...
func InfoBindingType() bindings.BindingType {
    ...
    fieldNameMap["value"] = "Value"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.content.library.item.tagging.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
