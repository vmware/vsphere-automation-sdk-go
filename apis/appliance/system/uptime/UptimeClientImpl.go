...
func (uIface *UptimeClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(uIface.interfaceName)
}

func (uIface *UptimeClientImpl) Definition() core.InterfaceDefinition {
    return uIface.interfaceDefinition
}

func (uIface *UptimeClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
