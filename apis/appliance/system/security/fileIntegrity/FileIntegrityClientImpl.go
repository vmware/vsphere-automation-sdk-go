...
func (fIface *FileIntegrityClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(fIface.interfaceName)
}

func (fIface *FileIntegrityClientImpl) Definition() core.InterfaceDefinition {
    return fIface.interfaceDefinition
}

func (fIface *FileIntegrityClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (fIface *FileIntegrityClientImpl) Baseline() error {
	...
	sv := bindings.NewStructValueBuilder(baselineInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		return bindings.VAPIerrorsToError(inputError)
	}
	operationRestMetaData := baselineRestMetadata()
...
func (fIface *FileIntegrityClientImpl) baselineMethodDefinition() *core.MethodDefinition {
      ...
      input, inputError := typeConverter.ConvertToDataDefinition(baselineInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(baselineOutputType())
      if(inputError != nil) {
