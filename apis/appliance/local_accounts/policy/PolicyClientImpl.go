...
func (pIface *PolicyClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(pIface.interfaceName)
}

func (pIface *PolicyClientImpl) Definition() core.InterfaceDefinition {
    return pIface.interfaceDefinition
}

func (pIface *PolicyClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (pIface *PolicyClientImpl) Get() (Info, error) {
...
func (pIface *PolicyClientImpl) Set(policyParam Info) error {
	typeConverter := pIface.connector.TypeConverter()
