...
func (nIface *NtpClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(nIface.interfaceName)
}

func (nIface *NtpClientImpl) Definition() core.InterfaceDefinition {
    return nIface.interfaceDefinition
}

func (nIface *NtpClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (nIface *NtpClientImpl) Test(serversParam []string) ([]TestRunStatus, error) {
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.([]TestRunStatus), nil
	} else {
