...
func listDetailsOutputType() bindings.BindingType {
    return bindings.NewMapType(bindings.NewIdType([]string {"com.vmware.appliance.vmon.Service"}, ""), bindings.NewReferenceType(InfoBindingType),reflect.TypeOf(map[string]Info{}))
}
...
func InfoBindingType() bindings.BindingType {
    ...
    fields["startup_type"] = bindings.NewEnumType("com.vmware.appliance.vmon.service.startup_type", reflect.TypeOf(StartupType(StartupType_MANUAL)))
    fieldNameMap["startup_type"] = "StartupType"
    fields["state"] = bindings.NewEnumType("com.vmware.appliance.vmon.service.state", reflect.TypeOf(State(State_STARTING)))
    fieldNameMap["state"] = "State"
    fields["health"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.appliance.vmon.service.health", reflect.TypeOf(Health(Health_DEGRADED))))
    ...
    return bindings.NewStructType("com.vmware.appliance.vmon.service.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}

func UpdateSpecBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["startup_type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.appliance.vmon.service.startup_type", reflect.TypeOf(StartupType(StartupType_MANUAL))))
    fieldNameMap["startup_type"] = "StartupType"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.appliance.vmon.service.update_spec",fields, reflect.TypeOf(UpdateSpec{}), fieldNameMap, validators)
}
