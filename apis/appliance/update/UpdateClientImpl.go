...
func (uIface *UpdateClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(uIface.interfaceName)
}

func (uIface *UpdateClientImpl) Definition() core.InterfaceDefinition {
    return uIface.interfaceDefinition
}

func (uIface *UpdateClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (uIface *UpdateClientImpl) Get() (Info, error) {
