...
func (iIface *Ipv4ClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(iIface.interfaceName)
}

func (iIface *Ipv4ClientImpl) Definition() core.InterfaceDefinition {
    return iIface.interfaceDefinition
}

func (iIface *Ipv4ClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (iIface *Ipv4ClientImpl) Set(interfaceNameParam string, configParam Config) error {
...
func (iIface *Ipv4ClientImpl) Get(interfaceNameParam string) (Info, error) {
	typeConverter := iIface.connector.TypeConverter()
