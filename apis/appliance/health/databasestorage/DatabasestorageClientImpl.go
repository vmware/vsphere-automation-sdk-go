...
func (dIface *DatabasestorageClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(dIface.interfaceName)
}

func (dIface *DatabasestorageClientImpl) Definition() core.InterfaceDefinition {
    return dIface.interfaceDefinition
}

func (dIface *DatabasestorageClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (dIface *DatabasestorageClientImpl) Get() (HealthLevel, error) {
