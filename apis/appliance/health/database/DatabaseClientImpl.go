...
func (dIface *DatabaseClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(dIface.interfaceName)
}

func (dIface *DatabaseClientImpl) Definition() core.InterfaceDefinition {
    return dIface.interfaceDefinition
}

func (dIface *DatabaseClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (dIface *DatabaseClientImpl) Get() (Info, error) {
