...
func (aIface *ApplmgmtClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *ApplmgmtClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *ApplmgmtClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
