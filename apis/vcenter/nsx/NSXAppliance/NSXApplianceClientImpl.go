...
func (nIface *NSXApplianceClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(nIface.interfaceName)
}

func (nIface *NSXApplianceClientImpl) Definition() core.InterfaceDefinition {
    return nIface.interfaceDefinition
}

func (nIface *NSXApplianceClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (nIface *NSXApplianceClientImpl) Get() (Info, error) {
...
func (nIface *NSXApplianceClientImpl) Create(specParam InstallSpec) error {
	typeConverter := nIface.connector.TypeConverter()
