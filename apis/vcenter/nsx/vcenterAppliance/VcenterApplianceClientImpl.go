...
func (vIface *VcenterApplianceClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(vIface.interfaceName)
}

func (vIface *VcenterApplianceClientImpl) Definition() core.InterfaceDefinition {
    return vIface.interfaceDefinition
}

func (vIface *VcenterApplianceClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (vIface *VcenterApplianceClientImpl) Get(managementVcenterParam *nsx.Connection) (ApplianceInfo, error) {
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.(ApplianceInfo), nil
	} else {
