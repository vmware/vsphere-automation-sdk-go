...
func (aIface *AssociationsClientImpl) Add(tagParam string, vmsParam map[string]bool) (Status, error) {
...
func (aIface *AssociationsClientImpl) Remove(tagParam string, vmsParam map[string]bool) (Status, error) {
	typeConverter := aIface.connector.TypeConverter()
