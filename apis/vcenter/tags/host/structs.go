...
func FilterSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tags.host.filter_spec",fields, reflect.TypeOf(FilterSpec{}), fieldNameMap, validators)
}
...
func SummaryBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tags.host.summary",fields, reflect.TypeOf(Summary{}), fieldNameMap, validators)
}
...
func ListResultBindingType() bindings.BindingType {
    ...
    fieldNameMap["tags"] = "Tags"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tags.host.list_result",fields, reflect.TypeOf(ListResult{}), fieldNameMap, validators)
}
