...
func (tIface *TagsClientImpl) Add(hostParam string, tagsParam map[string]bool) (Status, error) {
...
func (tIface *TagsClientImpl) Remove(hostParam string, tagsParam map[string]bool) (Status, error) {
	typeConverter := tIface.connector.TypeConverter()
