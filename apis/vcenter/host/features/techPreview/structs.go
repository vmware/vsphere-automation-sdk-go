...
func getOutputType() bindings.BindingType {
    return bindings.NewMapType(bindings.NewStringType(), bindings.NewEnumType("com.vmware.vcenter.host.features.tech_preview.status", reflect.TypeOf(Status(Status_DISABLED))),reflect.TypeOf(map[string]Status{}))
}
...
func updateInputType() bindings.StructType {
    ...
    fieldNameMap := make(map[string]string)
    fields["host"] = bindings.NewIdType([]string {"HostSystem"}, "")
    fields["feature_status"] = bindings.NewMapType(bindings.NewStringType(), bindings.NewEnumType("com.vmware.vcenter.host.features.tech_preview.status", reflect.TypeOf(Status(Status_DISABLED))),reflect.TypeOf(map[string]Status{}))
    fieldNameMap["host"] = "Host"
