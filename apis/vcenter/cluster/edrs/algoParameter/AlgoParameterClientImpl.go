...
func (aIface *AlgoParameterClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AlgoParameterClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AlgoParameterClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *AlgoParameterClientImpl) Set(clusterParam string, paramsParam Param) error {
...
func (aIface *AlgoParameterClientImpl) Get(clusterParam string) (Param, error) {
	typeConverter := aIface.connector.TypeConverter()
