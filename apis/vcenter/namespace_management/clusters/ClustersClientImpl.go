...
func (cIface *ClustersClientImpl) Enable(clusterParam string, specParam EnableSpec) error {
...
func (cIface *ClustersClientImpl) Set(clusterParam string, specParam SetSpec) error {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ClustersClientImpl) Update(clusterParam string, specParam UpdateSpec) error {
	typeConverter := cIface.connector.TypeConverter()
