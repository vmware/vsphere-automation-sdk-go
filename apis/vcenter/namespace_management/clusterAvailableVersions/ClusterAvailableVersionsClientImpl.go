...
func (cIface *ClusterAvailableVersionsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ClusterAvailableVersionsClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ClusterAvailableVersionsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ClusterAvailableVersionsClientImpl) List() ([]Summary, error) {
