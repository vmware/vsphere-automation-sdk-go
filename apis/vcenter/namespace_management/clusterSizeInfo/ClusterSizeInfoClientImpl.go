...
func (cIface *ClusterSizeInfoClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ClusterSizeInfoClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ClusterSizeInfoClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ClusterSizeInfoClientImpl) Get() (map[namespace_management.SizingHint]Info, error) {
	...
	if inputError != nil {
        var emptyOutput map[namespace_management.SizingHint]Info
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.(map[namespace_management.SizingHint]Info), nil
	} else {
