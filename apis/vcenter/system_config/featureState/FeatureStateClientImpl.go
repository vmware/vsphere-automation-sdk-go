...
func (fIface *FeatureStateClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(fIface.interfaceName)
}

func (fIface *FeatureStateClientImpl) Definition() core.InterfaceDefinition {
    return fIface.interfaceDefinition
}

func (fIface *FeatureStateClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (fIface *FeatureStateClientImpl) Get(featuresParam []string) (map[string]Status, error) {
