...
func CheckSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.vcha.cluster.passive.check_spec",fields, reflect.TypeOf(CheckSpec{}), fieldNameMap, validators)
}
...
func CheckResultBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.vcha.cluster.passive.check_result",fields, reflect.TypeOf(CheckResult{}), fieldNameMap, validators)
}
...
func RedeploySpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.vcha.cluster.passive.redeploy_spec",fields, reflect.TypeOf(RedeploySpec{}), fieldNameMap, validators)
}
