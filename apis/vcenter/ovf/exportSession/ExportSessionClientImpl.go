...
func (eIface *ExportSessionClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(eIface.interfaceName)
}

func (eIface *ExportSessionClientImpl) Definition() core.InterfaceDefinition {
    return eIface.interfaceDefinition
}

func (eIface *ExportSessionClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (eIface *ExportSessionClientImpl) Create(clientTokenParam *string, sourceParam SourceInfo, createSpecParam *data.StructValue) (string, error) {
...
func (eIface *ExportSessionClientImpl) Get(idParam string) (Info, error) {
	typeConverter := eIface.connector.TypeConverter()
...
func (eIface *ExportSessionClientImpl) Preview(sourceParam SourceInfo, previewSpecParam *data.StructValue) (Preview, error) {
	typeConverter := eIface.connector.TypeConverter()
