...
func (aIface *AnnouncementsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AnnouncementsClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AnnouncementsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *AnnouncementsClientImpl) List() (map[string]Info, error) {
...
func (aIface *AnnouncementsClientImpl) Get(announcementParam string) (Info, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AnnouncementsClientImpl) Create(specParam Spec) (string, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AnnouncementsClientImpl) Set(announcementParam string, specParam Spec) error {
	typeConverter := aIface.connector.TypeConverter()
