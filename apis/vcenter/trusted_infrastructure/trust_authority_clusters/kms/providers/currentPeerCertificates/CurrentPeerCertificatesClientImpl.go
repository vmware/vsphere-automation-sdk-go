...
func (cIface *CurrentPeerCertificatesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *CurrentPeerCertificatesClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *CurrentPeerCertificatesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *CurrentPeerCertificatesClientImpl) List(clusterParam string, providerParam string, specParam *FilterSpec) ([]Summary, error) {
