...
func (cIface *CsrClientImpl) Create(clusterParam string, providerParam string) (Info, error) {
...
func (cIface *CsrClientImpl) Get(clusterParam string, providerParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
