...
func (cIface *CaCertificatesClientImpl) List(clusterParam string) ([]Summary, error) {
...
func (cIface *CaCertificatesClientImpl) Create(clusterParam string, specParam CreateSpec) error {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *CaCertificatesClientImpl) Get(clusterParam string, nameParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
