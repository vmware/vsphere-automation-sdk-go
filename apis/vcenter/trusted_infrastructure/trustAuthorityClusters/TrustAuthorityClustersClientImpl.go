...
func (tIface *TrustAuthorityClustersClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TrustAuthorityClustersClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TrustAuthorityClustersClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (tIface *TrustAuthorityClustersClientImpl) Update(clusterParam string, specParam UpdateSpec) error {
...
func (tIface *TrustAuthorityClustersClientImpl) Get(clusterParam string) (Info, error) {
	typeConverter := tIface.connector.TypeConverter()
...
func (tIface *TrustAuthorityClustersClientImpl) List(specParam *FilterSpec) ([]Summary, error) {
	typeConverter := tIface.connector.TypeConverter()
