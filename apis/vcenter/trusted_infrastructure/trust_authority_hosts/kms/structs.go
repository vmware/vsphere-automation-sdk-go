...
func listInputType() bindings.StructType {
    ...
    fields["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.summary_type", reflect.TypeOf(SummaryType(SummaryType_FULL))))
...
func listRestMetadata() protocol.OperationRestMetadata {
    ...
    queryParams := map[string]string{}
    headerParams := map[string]string{}
    paramsTypeMap["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.summary_type", reflect.TypeOf(SummaryType(SummaryType_FULL))))
...
func SummaryBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["summary_type"] = bindings.NewEnumType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.summary_type", reflect.TypeOf(SummaryType(SummaryType_FULL)))
    ...
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.summary",fields, reflect.TypeOf(Summary{}), fieldNameMap, validators)
}
...
func InfoBindingType() bindings.BindingType {
    ...
    fieldNameMap["trusted_CA"] = "TrustedCA"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func FilterSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.kms.filter_spec",fields, reflect.TypeOf(FilterSpec{}), fieldNameMap, validators)
}
