...
func (sIface *ServicesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *ServicesClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *ServicesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (sIface *ServicesClientImpl) List(clusterParam string, specParam *FilterSpec) ([]Summary, error) {
...
func (sIface *ServicesClientImpl) Get(clusterParam string, serviceParam string) (Info, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *ServicesClientImpl) Create(clusterParam string, specParam CreateSpec) (string, error) {
	typeConverter := sIface.connector.TypeConverter()
