...
func (eIface *EnvironmentClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(eIface.interfaceName)
}

func (eIface *EnvironmentClientImpl) Definition() core.InterfaceDefinition {
    return eIface.interfaceDefinition
}

func (eIface *EnvironmentClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (eIface *EnvironmentClientImpl) Get(vmParam string, credentialsParam guest.Credentials, nameParam string) (string, error) {
...
func (eIface *EnvironmentClientImpl) List(vmParam string, credentialsParam guest.Credentials, namesParam map[string]bool) (map[string]string, error) {
	typeConverter := eIface.connector.TypeConverter()
