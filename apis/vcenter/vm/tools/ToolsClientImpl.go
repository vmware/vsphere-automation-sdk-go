...
func (tIface *ToolsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *ToolsClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *ToolsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (tIface *ToolsClientImpl) Get(vmParam string) (Info, error) {
...
func (tIface *ToolsClientImpl) Update(vmParam string, specParam UpdateSpec) error {
	typeConverter := tIface.connector.TypeConverter()
