...
func (tIface *TagsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TagsClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TagsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (tIface *TagsClientImpl) Add(vmParam string, tagsParam map[string]bool) (Status, error) {
...
func (tIface *TagsClientImpl) Remove(vmParam string, tagsParam map[string]bool) (Status, error) {
	typeConverter := tIface.connector.TypeConverter()
