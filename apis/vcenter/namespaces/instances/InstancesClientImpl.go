...
func (iIface *InstancesClientImpl) Create(specParam CreateSpec) error {
...
func (iIface *InstancesClientImpl) Get(namespaceParam string) (Info, error) {
	typeConverter := iIface.connector.TypeConverter()
...
func (iIface *InstancesClientImpl) Set(namespaceParam string, specParam SetSpec) error {
	typeConverter := iIface.connector.TypeConverter()
...
func (iIface *InstancesClientImpl) Update(namespaceParam string, specParam UpdateSpec) error {
	typeConverter := iIface.connector.TypeConverter()
