...
func (sIface *SupervisorServicesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *SupervisorServicesClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *SupervisorServicesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (sIface *SupervisorServicesClientImpl) Set(clusterParam string, serviceIDParam string, specParam SetSpec) error {
