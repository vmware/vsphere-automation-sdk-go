...
func (cIface *CapabilitiesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *CapabilitiesClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *CapabilitiesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *CapabilitiesClientImpl) List() ([]Summary, error) {
...
func (cIface *CapabilitiesClientImpl) Get(capabilityParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
