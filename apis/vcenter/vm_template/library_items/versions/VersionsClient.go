...
type VersionsClient interface {
    ...
    Get(templateLibraryItemParam string, versionParam string) (Info, error) 
    ...
    // * The resource ``com.vmware.content.library.item.Version`` referenced by the parameter ``version`` requires ``System.Read``.
    Rollback(templateLibraryItemParam string, versionParam string, specParam *RollbackSpec) (string, error) 
