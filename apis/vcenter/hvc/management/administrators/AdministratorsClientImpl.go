...
func (aIface *AdministratorsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AdministratorsClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AdministratorsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
