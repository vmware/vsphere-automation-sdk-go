...
func (pIface *ProvidersClientImpl) List(linkParam string) ([]Summary, error) {
...
func (pIface *ProvidersClientImpl) Get(linkParam string, providerParam string) (Info, error) {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *ProvidersClientImpl) Start(linkParam string, providerParam string, credentialsParam *Credentials) error {
	typeConverter := pIface.connector.TypeConverter()
