...
func (rIface *ReplicationStatusClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(rIface.interfaceName)
}

func (rIface *ReplicationStatusClientImpl) Definition() core.InterfaceDefinition {
    return rIface.interfaceDefinition
}

func (rIface *ReplicationStatusClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (rIface *ReplicationStatusClientImpl) List(filterParam *FilterSpec) ([]Summary, error) {
