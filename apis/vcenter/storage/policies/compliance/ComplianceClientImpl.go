...
func (cIface *ComplianceClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ComplianceClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ComplianceClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
