...
package compatibleSubnetsAsync
import (
...
func (cIface *CompatibleSubnetsAsyncClientImpl) Get(orgParam string, linkedAccountIdParam *string, regionParam *string, sddcParam *string, instanceTypeParam *string, sddcTypeParam *string, numOfHostsParam *int64) (model.Task, error) {
