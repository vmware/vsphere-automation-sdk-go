...
func (cIface *CompatibilityReleasesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *CompatibilityReleasesClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *CompatibilityReleasesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *CompatibilityReleasesClientImpl) List(hostParam string) (EsxiCompatibilityReleases, error) {
	...
	if inputError != nil {
        var emptyOutput EsxiCompatibilityReleases
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.(EsxiCompatibilityReleases), nil
	} else {
