...
func (pIface *ProvidersClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(pIface.interfaceName)
}

func (pIface *ProvidersClientImpl) Definition() core.InterfaceDefinition {
    return pIface.interfaceDefinition
}

func (pIface *ProvidersClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (pIface *ProvidersClientImpl) List() ([]Summary, error) {
...
func (pIface *ProvidersClientImpl) Create(specParam CreateSpec) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *ProvidersClientImpl) Update(providerParam string, specParam UpdateSpec) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *ProvidersClientImpl) Get(providerParam string) (Info, error) {
	typeConverter := pIface.connector.TypeConverter()
