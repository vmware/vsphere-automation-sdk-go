...
func (cIface *ClientCertificateClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ClientCertificateClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ClientCertificateClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ClientCertificateClientImpl) Get(providerParam string, specParam *GetSpec) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ClientCertificateClientImpl) Set(providerParam string, specParam SetSpec) error {
	typeConverter := cIface.connector.TypeConverter()
