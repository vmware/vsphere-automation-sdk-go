...
func InfoBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["health"] = bindings.NewEnumType("com.vmware.esx.kms.status.info.health", reflect.TypeOf(Info_Health(Info_Health_NONE)))
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.kms.status.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
