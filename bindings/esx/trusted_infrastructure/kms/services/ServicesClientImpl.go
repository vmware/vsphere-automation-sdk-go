...
func (sIface *ServicesClientImpl) List(filterParam *FilterSpec) ([]Summary, error) {
...
func (sIface *ServicesClientImpl) Get(serviceParam string) (Info, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *ServicesClientImpl) Create(specParam CreateSpec) (string, error) {
	typeConverter := sIface.connector.TypeConverter()
