...
func InfoBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.attestation.certificate.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func SetSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["certificate"] = "Certificate"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.attestation.certificate.set_spec",fields, reflect.TypeOf(SetSpec{}), fieldNameMap, validators)
}
