...
func getInputType() bindings.StructType {
    ...
    fields["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.attestation.raw_config.info_type", reflect.TypeOf(InfoType(InfoType_FULL))))
...
func getRestMetadata() protocol.OperationRestMetadata {
    ...
    paramsTypeMap["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.attestation.raw_config.info_type", reflect.TypeOf(InfoType(InfoType_FULL))))
...
func InfoBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.attestation.raw_config.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func SetSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["configuration"] = "Configuration"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.attestation.raw_config.set_spec",fields, reflect.TypeOf(SetSpec{}), fieldNameMap, validators)
}
