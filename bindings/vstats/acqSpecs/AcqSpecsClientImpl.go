...
func (aIface *AcqSpecsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AcqSpecsClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AcqSpecsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *AcqSpecsClientImpl) Create(acqSpecParam CreateSpec) (string, error) {
...
func (aIface *AcqSpecsClientImpl) List(filterParam *FilterSpec) (ListResult, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AcqSpecsClientImpl) Get(idParam string) (Info, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AcqSpecsClientImpl) Update(idParam string, acqSpecParam UpdateSpec) error {
	typeConverter := aIface.connector.TypeConverter()
