...
func (mIface *MetricsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(mIface.interfaceName)
}

func (mIface *MetricsClientImpl) Definition() core.InterfaceDefinition {
    return mIface.interfaceDefinition
}

func (mIface *MetricsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (mIface *MetricsClientImpl) List() ([]Summary, error) {
