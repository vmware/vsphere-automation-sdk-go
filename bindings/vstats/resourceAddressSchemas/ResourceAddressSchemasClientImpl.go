...
func (rIface *ResourceAddressSchemasClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(rIface.interfaceName)
}

func (rIface *ResourceAddressSchemasClientImpl) Definition() core.InterfaceDefinition {
    return rIface.interfaceDefinition
}

func (rIface *ResourceAddressSchemasClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (rIface *ResourceAddressSchemasClientImpl) Get(idParam string) (Info, error) {
