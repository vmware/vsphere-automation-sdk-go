...
func (lIface *LoadClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(lIface.interfaceName)
}

func (lIface *LoadClientImpl) Definition() core.InterfaceDefinition {
    return lIface.interfaceDefinition
}

func (lIface *LoadClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (lIface *LoadClientImpl) Get() (HealthLevel, error) {
