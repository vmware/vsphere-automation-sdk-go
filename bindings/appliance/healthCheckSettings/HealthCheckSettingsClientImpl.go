...
func (hIface *HealthCheckSettingsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(hIface.interfaceName)
}

func (hIface *HealthCheckSettingsClientImpl) Definition() core.InterfaceDefinition {
    return hIface.interfaceDefinition
}

func (hIface *HealthCheckSettingsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (hIface *HealthCheckSettingsClientImpl) Get() (SettingSpec, error) {
...
func (hIface *HealthCheckSettingsClientImpl) Update(healthSettingsParam UpdateSpec) error {
	typeConverter := hIface.connector.TypeConverter()
