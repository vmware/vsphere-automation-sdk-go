...
func (lIface *LocalAccountsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(lIface.interfaceName)
}

func (lIface *LocalAccountsClientImpl) Definition() core.InterfaceDefinition {
    return lIface.interfaceDefinition
}

func (lIface *LocalAccountsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (lIface *LocalAccountsClientImpl) Get(usernameParam string) (Info, error) {
...
func (lIface *LocalAccountsClientImpl) Create(usernameParam string, configParam Config) error {
	typeConverter := lIface.connector.TypeConverter()
...
func (lIface *LocalAccountsClientImpl) Set(usernameParam string, configParam Config) error {
	typeConverter := lIface.connector.TypeConverter()
...
func (lIface *LocalAccountsClientImpl) Update(usernameParam string, configParam UpdateConfig) error {
	typeConverter := lIface.connector.TypeConverter()
