...
package archive
import (
    "gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/bindings/appliance/recovery/backup"
...
func (aIface *ArchiveClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *ArchiveClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *ArchiveClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *ArchiveClientImpl) Get(specParam backup.LocationSpec, systemNameParam string, archiveParam string) (Info, error) {
...
func (aIface *ArchiveClientImpl) List(locSpecParam backup.LocationSpec, systemNameParam string, filterSpecParam FilterSpec) ([]Summary, error) {
	typeConverter := aIface.connector.TypeConverter()
