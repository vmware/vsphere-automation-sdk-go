...
func (dIface *DcuiClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(dIface.interfaceName)
}

func (dIface *DcuiClientImpl) Definition() core.InterfaceDefinition {
    return dIface.interfaceDefinition
}

func (dIface *DcuiClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
