...
func (sIface *SshClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *SshClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *SshClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
