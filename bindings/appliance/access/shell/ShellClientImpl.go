...
func (sIface *ShellClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *ShellClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *ShellClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (sIface *ShellClientImpl) Set(configParam ShellConfig) error {
...
func (sIface *ShellClientImpl) Get() (ShellConfig, error) {
	typeConverter := sIface.connector.TypeConverter()
