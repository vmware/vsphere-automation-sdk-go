...
func (tIface *TimeClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TimeClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TimeClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (tIface *TimeClientImpl) Get() (SystemTimeStruct, error) {
	...
	if inputError != nil {
        var emptyOutput SystemTimeStruct
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.(SystemTimeStruct), nil
	} else {
