...
func (tIface *TimezoneClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TimezoneClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TimezoneClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
