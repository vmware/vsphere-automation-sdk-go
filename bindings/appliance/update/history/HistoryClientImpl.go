...
func (hIface *HistoryClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(hIface.interfaceName)
}

func (hIface *HistoryClientImpl) Definition() core.InterfaceDefinition {
    return hIface.interfaceDefinition
}

func (hIface *HistoryClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (hIface *HistoryClientImpl) List() ([]Summary, error) {
...
func (hIface *HistoryClientImpl) Get(versionParam string) (Info, error) {
	typeConverter := hIface.connector.TypeConverter()
