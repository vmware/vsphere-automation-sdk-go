...
func (rIface *ReplicatedClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(rIface.interfaceName)
}

func (rIface *ReplicatedClientImpl) Definition() core.InterfaceDefinition {
    return rIface.interfaceDefinition
}

func (rIface *ReplicatedClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
