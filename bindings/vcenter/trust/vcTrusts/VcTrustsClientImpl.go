...
func (vIface *VcTrustsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(vIface.interfaceName)
}

func (vIface *VcTrustsClientImpl) Definition() core.InterfaceDefinition {
    return vIface.interfaceDefinition
}

func (vIface *VcTrustsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (vIface *VcTrustsClientImpl) List() ([]Summary, error) {
...
func (vIface *VcTrustsClientImpl) Create(specParam CreateSpec) error {
	typeConverter := vIface.connector.TypeConverter()
...
func (vIface *VcTrustsClientImpl) Get(domainParam string) (Info, error) {
	typeConverter := vIface.connector.TypeConverter()
...
func (vIface *VcTrustsClientImpl) Update(domainParam string, specParam UpdateSpec) error {
	typeConverter := vIface.connector.TypeConverter()
