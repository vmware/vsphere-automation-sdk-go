...
func (bIface *BootClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(bIface.interfaceName)
}

func (bIface *BootClientImpl) Definition() core.InterfaceDefinition {
    return bIface.interfaceDefinition
}

func (bIface *BootClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
