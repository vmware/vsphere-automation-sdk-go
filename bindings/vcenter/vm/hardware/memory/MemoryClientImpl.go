...
func (mIface *MemoryClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(mIface.interfaceName)
}

func (mIface *MemoryClientImpl) Definition() core.InterfaceDefinition {
    return mIface.interfaceDefinition
}

func (mIface *MemoryClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
