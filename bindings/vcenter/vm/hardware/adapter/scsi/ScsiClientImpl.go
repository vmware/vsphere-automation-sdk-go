...
func (sIface *ScsiClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *ScsiClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *ScsiClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
