...
func (iIface *InstallerClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(iIface.interfaceName)
}

func (iIface *InstallerClientImpl) Definition() core.InterfaceDefinition {
    return iIface.interfaceDefinition
}

func (iIface *InstallerClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (iIface *InstallerClientImpl) Get(vmParam string) (Info, error) {
