...
func (iIface *IpPoolsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(iIface.interfaceName)
}

func (iIface *IpPoolsClientImpl) Definition() core.InterfaceDefinition {
    return iIface.interfaceDefinition
}

func (iIface *IpPoolsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (iIface *IpPoolsClientImpl) List() ([]Summary, error) {
...
func (iIface *IpPoolsClientImpl) Get(ipPoolParam string) (Info, error) {
	typeConverter := iIface.connector.TypeConverter()
