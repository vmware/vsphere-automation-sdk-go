...
func (dIface *DistributedSwitchesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(dIface.interfaceName)
}

func (dIface *DistributedSwitchesClientImpl) Definition() core.InterfaceDefinition {
    return dIface.interfaceDefinition
}

func (dIface *DistributedSwitchesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (dIface *DistributedSwitchesClientImpl) List(filterParam *FilterSpec) ([]Summary, error) {
