...
func (cIface *CheckOutsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *CheckOutsClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *CheckOutsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *CheckOutsClientImpl) CheckOut(templateLibraryItemParam string, specParam *CheckOutSpec) (string, error) {
	typeConverter := cIface.connector.TypeConverter()
	methodIdentifier := core.NewMethodIdentifier(cIface.interfaceIdentifier, "check_out")
	sv := bindings.NewStructValueBuilder(checkOutInputType(), typeConverter)
	...
	operationRestMetaData := checkOutRestMetadata()
	connectionMetadata := map[string]interface{}{lib.REST_METADATA: operationRestMetaData}
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult:= cIface.Invoke(cIface.connector.NewExecutionContext(), methodIdentifier, inputDataValue)
	var emptyOutput string
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), checkOutOutputType())
...
func (cIface *CheckOutsClientImpl) CheckIn(templateLibraryItemParam string, vmParam string, specParam *CheckInSpec) (string, error) {
	typeConverter := cIface.connector.TypeConverter()
	methodIdentifier := core.NewMethodIdentifier(cIface.interfaceIdentifier, "check_in")
	sv := bindings.NewStructValueBuilder(checkInInputType(), typeConverter)
	sv.AddStructField("TemplateLibraryItem", templateLibraryItemParam)
	...
	operationRestMetaData := checkInRestMetadata()
	connectionMetadata := map[string]interface{}{lib.REST_METADATA: operationRestMetaData}
	cIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult:= cIface.Invoke(cIface.connector.NewExecutionContext(), methodIdentifier, inputDataValue)
	var emptyOutput string
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), checkInOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(string), nil
...
func (cIface *CheckOutsClientImpl) List(templateLibraryItemParam string) ([]Summary, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *CheckOutsClientImpl) Get(templateLibraryItemParam string, vmParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *CheckOutsClientImpl) checkOutMethodDefinition() *core.MethodDefinition {
      ...
      input, inputError := typeConverter.ConvertToDataDefinition(checkOutInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(checkOutOutputType())
      if(inputError != nil) {
...
func (cIface *CheckOutsClientImpl) checkInMethodDefinition() *core.MethodDefinition {
      ...
      input, inputError := typeConverter.ConvertToDataDefinition(checkInInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(checkInOutputType())
      if(inputError != nil) {
