...
type CheckOutsClient interface {
    ...
    // @throws AlreadyExists  if a virtual machine with the name specified by CheckOutSpec#name already exists in the folder specified by PlacementSpec#folder.
    ...
    // * The resource ``Folder`` referenced by the property PlacementSpec#folder requires ``System.Read``.
    // * The resource ``ResourcePool`` referenced by the property PlacementSpec#resourcePool requires ``System.Read``.
    // * The resource ``HostSystem`` referenced by the property PlacementSpec#host requires ``System.Read``.
    // * The resource ``ClusterComputeResource`` referenced by the property PlacementSpec#cluster requires ``System.Read``.
    CheckOut(templateLibraryItemParam string, specParam *CheckOutSpec) (string, error) 
    ...
    CheckIn(templateLibraryItemParam string, vmParam string, specParam *CheckInSpec) (string, error) 
    ...
    List(templateLibraryItemParam string) ([]Summary, error) 
    ...
    // * The resource ``com.vmware.content.library.Item`` referenced by the parameter ``template_library_item`` requires ``System.Read``.
    // * The resource ``VirtualMachine`` referenced by the parameter ``vm`` requires ``System.Read``.
    Get(templateLibraryItemParam string, vmParam string) (Info, error) 
