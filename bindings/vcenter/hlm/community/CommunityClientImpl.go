...
func (cIface *CommunityClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *CommunityClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *CommunityClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *CommunityClientImpl) Get() (Info, error) {
...
func (cIface *CommunityClientImpl) Add(specParam AddSpec) error {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *CommunityClientImpl) Check(specParam *AddCheckSpec) ([]CheckInfo, error) {
	typeConverter := cIface.connector.TypeConverter()
