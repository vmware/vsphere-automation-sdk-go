...
func (mIface *ModulesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(mIface.interfaceName)
}

func (mIface *ModulesClientImpl) Definition() core.InterfaceDefinition {
    return mIface.interfaceDefinition
}

func (mIface *ModulesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (mIface *ModulesClientImpl) Create(specParam CreateSpec) (string, error) {
...
func (mIface *ModulesClientImpl) List() (ListResult, error) {
	typeConverter := mIface.connector.TypeConverter()
