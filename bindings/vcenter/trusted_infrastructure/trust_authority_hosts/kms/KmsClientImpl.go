...
func (kIface *KmsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(kIface.interfaceName)
}

func (kIface *KmsClientImpl) Definition() core.InterfaceDefinition {
    return kIface.interfaceDefinition
}

func (kIface *KmsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (kIface *KmsClientImpl) Get(hostParam string) (Info, error) {
...
func (kIface *KmsClientImpl) List(specParam *FilterSpec, projectionParam *SummaryType) ([]Summary, error) {
	typeConverter := kIface.connector.TypeConverter()
