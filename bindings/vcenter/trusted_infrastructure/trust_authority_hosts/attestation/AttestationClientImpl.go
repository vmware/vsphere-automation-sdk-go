...
func (aIface *AttestationClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AttestationClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AttestationClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *AttestationClientImpl) Get(hostParam string) (Info, error) {
...
func (aIface *AttestationClientImpl) List(specParam *FilterSpec, projectionParam *SummaryType) ([]Summary, error) {
	typeConverter := aIface.connector.TypeConverter()
