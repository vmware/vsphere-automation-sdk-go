...
func SummaryBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.attestation.services.summary",fields, reflect.TypeOf(Summary{}), fieldNameMap, validators)
}
...
func InfoBindingType() bindings.BindingType {
    ...
    fieldNameMap["trust_authority_cluster"] = "TrustAuthorityCluster"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.attestation.services.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func CreateSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["trust_authority_cluster"] = "TrustAuthorityCluster"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.attestation.services.create_spec",fields, reflect.TypeOf(CreateSpec{}), fieldNameMap, validators)
}
...
func FilterSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["trust_authority_cluster"] = "TrustAuthorityCluster"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.attestation.services.filter_spec",fields, reflect.TypeOf(FilterSpec{}), fieldNameMap, validators)
}
