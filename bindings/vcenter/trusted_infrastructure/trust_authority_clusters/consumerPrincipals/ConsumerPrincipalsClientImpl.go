...
func (cIface *ConsumerPrincipalsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ConsumerPrincipalsClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ConsumerPrincipalsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ConsumerPrincipalsClientImpl) Create(clusterParam string, specParam CreateSpec) (string, error) {
...
func (cIface *ConsumerPrincipalsClientImpl) Get(clusterParam string, profileParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ConsumerPrincipalsClientImpl) List(clusterParam string, specParam *FilterSpec) ([]Summary, error) {
	typeConverter := cIface.connector.TypeConverter()
