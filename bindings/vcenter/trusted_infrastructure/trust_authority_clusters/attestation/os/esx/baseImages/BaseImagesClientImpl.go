...
func (bIface *BaseImagesClientImpl) List(clusterParam string, specParam *FilterSpec) ([]Summary, error) {
	typeConverter := bIface.connector.TypeConverter()
...
func (bIface *BaseImagesClientImpl) Get(clusterParam string, versionParam string) (Info, error) {
	typeConverter := bIface.connector.TypeConverter()
