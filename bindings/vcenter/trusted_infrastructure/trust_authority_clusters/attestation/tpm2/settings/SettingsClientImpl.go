...
func (sIface *SettingsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *SettingsClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *SettingsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (sIface *SettingsClientImpl) Get(clusterParam string) (Info, error) {
...
func (sIface *SettingsClientImpl) Update(clusterParam string, specParam UpdateSpec) error {
	typeConverter := sIface.connector.TypeConverter()
