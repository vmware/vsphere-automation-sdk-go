...
func (eIface *EndorsementKeysClientImpl) List(clusterParam string) ([]Summary, error) {
...
func (eIface *EndorsementKeysClientImpl) Create(clusterParam string, specParam CreateSpec) error {
	typeConverter := eIface.connector.TypeConverter()
...
func (eIface *EndorsementKeysClientImpl) Get(clusterParam string, nameParam string) (Info, error) {
	typeConverter := eIface.connector.TypeConverter()
