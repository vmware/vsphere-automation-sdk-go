...
func (tIface *TrustedPeerCertificatesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(tIface.interfaceName)
}

func (tIface *TrustedPeerCertificatesClientImpl) Definition() core.InterfaceDefinition {
    return tIface.interfaceDefinition
}

func (tIface *TrustedPeerCertificatesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (tIface *TrustedPeerCertificatesClientImpl) Update(clusterParam string, providerParam string, specParam UpdateSpec) error {
...
func (tIface *TrustedPeerCertificatesClientImpl) Get(clusterParam string, providerParam string) (Info, error) {
	typeConverter := tIface.connector.TypeConverter()
