...
func (cIface *ClientCertificateClientImpl) Get(clusterParam string, providerParam string) (Info, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ClientCertificateClientImpl) Update(clusterParam string, providerParam string, specParam UpdateSpec) error {
	typeConverter := cIface.connector.TypeConverter()
