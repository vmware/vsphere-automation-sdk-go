...
func (pIface *ProvidersClientImpl) List(clusterParam string) ([]Summary, error) {
...
func (pIface *ProvidersClientImpl) Create(clusterParam string, specParam CreateSpec) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *ProvidersClientImpl) Update(clusterParam string, providerParam string, specParam UpdateSpec) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *ProvidersClientImpl) Get(clusterParam string, providerParam string) (Info, error) {
	typeConverter := pIface.connector.TypeConverter()
