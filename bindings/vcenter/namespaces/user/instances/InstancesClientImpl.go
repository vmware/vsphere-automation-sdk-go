...
func (iIface *InstancesClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(iIface.interfaceName)
}

func (iIface *InstancesClientImpl) Definition() core.InterfaceDefinition {
    return iIface.interfaceDefinition
}

func (iIface *InstancesClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (iIface *InstancesClientImpl) List() ([]Summary, error) {
