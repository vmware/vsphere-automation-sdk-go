...
import (
    ...
    "gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/bindings/vcenter/lcm/discovery"
...
func (aIface *AssociatedProductsClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(aIface.interfaceName)
}

func (aIface *AssociatedProductsClientImpl) Definition() core.InterfaceDefinition {
    return aIface.interfaceDefinition
}

func (aIface *AssociatedProductsClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (aIface *AssociatedProductsClientImpl) List() ([]discovery.Product, error) {
	...
	if inputError != nil {
        var emptyOutput []discovery.Product
    ...
    if methodResult.IsSuccess() {
	    ...
	    return output.([]discovery.Product), nil
	} else {
...
func (aIface *AssociatedProductsClientImpl) Create(specParam CreateSpec) (string, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AssociatedProductsClientImpl) Get(productParam string) (discovery.Product, error) {
	typeConverter := aIface.connector.TypeConverter()
...
func (aIface *AssociatedProductsClientImpl) Update(productParam string, specParam UpdateSpec) error {
	typeConverter := aIface.connector.TypeConverter()
