...
func (hIface *HistoricalClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(hIface.interfaceName)
}

func (hIface *HistoricalClientImpl) Definition() core.InterfaceDefinition {
    return hIface.interfaceDefinition
}

func (hIface *HistoricalClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (hIface *HistoricalClientImpl) List() ([]tasks.Info, error) {
