...
func (sIface *StatusManagerClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(sIface.interfaceName)
}

func (sIface *StatusManagerClientImpl) Definition() core.InterfaceDefinition {
    return sIface.interfaceDefinition
}

func (sIface *StatusManagerClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
