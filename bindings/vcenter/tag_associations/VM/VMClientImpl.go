...
func (vIface *VMClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(vIface.interfaceName)
}

func (vIface *VMClientImpl) Definition() core.InterfaceDefinition {
    return vIface.interfaceDefinition
}

func (vIface *VMClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (vIface *VMClientImpl) List(iterationParam *IterationSpec, filterParam *FilterSpec) (ListResult, error) {
