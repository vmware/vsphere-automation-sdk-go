...
func listInputType() bindings.StructType {
    ...
    fields["iteration"] = bindings.NewOptionalType(bindings.NewReferenceType(IterationSpecBindingType))
...
func IterationSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tag_associations.VM.iteration_spec",fields, reflect.TypeOf(IterationSpec{}), fieldNameMap, validators)
}
...
func FilterSpecBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tag_associations.VM.filter_spec",fields, reflect.TypeOf(FilterSpec{}), fieldNameMap, validators)
}
...
func SummaryBindingType() bindings.BindingType {
    ...
    fieldNameMap["vm"] = "Vm"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tag_associations.VM.summary",fields, reflect.TypeOf(Summary{}), fieldNameMap, validators)
}
...
func ListResultBindingType() bindings.BindingType {
    ...
    fields["marker"] = bindings.NewOptionalType(bindings.NewIdType([]string {"com.vmware.vcenter.tag_associations.Marker"}, ""))
    fieldNameMap["marker"] = "Marker"
    fields["status"] = bindings.NewEnumType("com.vmware.vcenter.tag_associations.VM.last_iteration_status", reflect.TypeOf(LastIterationStatus(LastIterationStatus_READY)))
    fieldNameMap["status"] = "Status"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.tag_associations.VM.list_result",fields, reflect.TypeOf(ListResult{}), fieldNameMap, validators)
}
