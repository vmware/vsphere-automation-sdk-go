...
func (fIface *FolderClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(fIface.interfaceName)
}

func (fIface *FolderClientImpl) Definition() core.InterfaceDefinition {
    return fIface.interfaceDefinition
}

func (fIface *FolderClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
