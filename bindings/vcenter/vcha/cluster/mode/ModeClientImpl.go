...
func (mIface *ModeClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(mIface.interfaceName)
}

func (mIface *ModeClientImpl) Definition() core.InterfaceDefinition {
    return mIface.interfaceDefinition
}

func (mIface *ModeClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (mIface *ModeClientImpl) Get() (Info, error) {
...
func (mIface *ModeClientImpl) Set(modeParam ClusterMode) error {
	typeConverter := mIface.connector.TypeConverter()
