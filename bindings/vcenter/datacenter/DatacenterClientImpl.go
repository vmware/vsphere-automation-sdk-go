...
func (dIface *DatacenterClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(dIface.interfaceName)
}

func (dIface *DatacenterClientImpl) Definition() core.InterfaceDefinition {
    return dIface.interfaceDefinition
}

func (dIface *DatacenterClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
