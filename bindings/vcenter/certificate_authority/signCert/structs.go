...
func signCertFromCSRInputType() bindings.StructType {
...
func signCertFromCSROutputType() bindings.BindingType {
    return bindings.NewStringType()
}

func signCertFromCSRRestMetadata() protocol.OperationRestMetadata {
