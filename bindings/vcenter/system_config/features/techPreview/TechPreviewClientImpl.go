...
func (tIface *TechPreviewClientImpl) Get(featuresParam map[string]bool) (map[string]Status, error) {
...
func (tIface *TechPreviewClientImpl) Update(featureStatusParam map[string]Status) error {
	typeConverter := tIface.connector.TypeConverter()
