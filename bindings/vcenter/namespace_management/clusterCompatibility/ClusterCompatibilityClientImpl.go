...
func (cIface *ClusterCompatibilityClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(cIface.interfaceName)
}

func (cIface *ClusterCompatibilityClientImpl) Definition() core.InterfaceDefinition {
    return cIface.interfaceDefinition
}

func (cIface *ClusterCompatibilityClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (cIface *ClusterCompatibilityClientImpl) List(filterParam *FilterSpec) ([]Summary, error) {
