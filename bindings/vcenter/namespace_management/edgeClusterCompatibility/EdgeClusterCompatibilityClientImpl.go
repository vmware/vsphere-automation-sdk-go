...
func (eIface *EdgeClusterCompatibilityClientImpl) Identifier() core.InterfaceIdentifier {
      return core.NewInterfaceIdentifier(eIface.interfaceName)
}

func (eIface *EdgeClusterCompatibilityClientImpl) Definition() core.InterfaceDefinition {
    return eIface.interfaceDefinition
}

func (eIface *EdgeClusterCompatibilityClientImpl) MethodDefinition(mi core.MethodIdentifier) *core.MethodDefinition {
...
func (eIface *EdgeClusterCompatibilityClientImpl) List(clusterParam string, distributedSwitchParam string, filterParam *FilterSpec) ([]Summary, error) {
