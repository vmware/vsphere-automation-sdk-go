...
func (fIface *FileClientImpl) Get(libraryItemIdParam string, nameParam string) (Info, error) {
...
func (fIface *FileClientImpl) List(libraryItemIdParam string) ([]Info, error) {
	typeConverter := fIface.connector.TypeConverter()
